...
json2AstEncodings =
  lit: (json)-> L_lit(lz  json.value Nil)
  ref: (json)-> L_ref(lz json.varName Nil)
  lambda: (json)-> L_lambda(lz json.varName)(lz json2Ast json.body Nil)
  let: (json)-> L_let(lz json.varName)(lz json2Ast(json.value))(lz json2Ast(json.body) Nil)
