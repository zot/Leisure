...
;
//playMove = AST(\p b m . bind (js ([ moveNextPiece() ])) \foo . append (take m b) (append ([ p ]) (drop (++ m) b)))
root.defs._playMove = _playMove = define('playMove', function(_p){return function(_b){return function(_m){return _bind()((function(){var $m; return function(){return $m || ($m = (_js()((function(){var $m; return function(){return $m || ($m = (_$r()((function(){return "moveNextPiece()"}))(_$s)))}})())))}})())((function(){var $m; return function(){return $m || ($m = (function(_foo){return _append()((function(){var $m; return function(){return $m || ($m = (_take()(_m)(_b)))}})())((function(){var $m; return function(){return $m || ($m = (_append()((function(){var $m; return function(){return $m || ($m = (_$r()(_p)(_$s)))}})())((function(){var $m; return function(){return $m || ($m = (_drop()((function(){var $m; return function(){return $m || ($m = (_$o$o()(_m)))}})())(_b)))}})())))}})())}))}})())}}});
;
