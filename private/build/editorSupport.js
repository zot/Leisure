...
(function() {
  var DataStore, DataStoreEditingOptions, FancyEditing, LeisureEditCore, Lodash, OrgData, OrgEditing, PlainEditing, actualSelectionUpdate, blockAttrs, blockLabel, blockText, configureMenu, contentSpan, copy, createLocalData, escapeAttr, escapeHtml, findEditor, getId, greduce, installSelectionMenu, isContentEditable, last, linkAllSiblings, monitorSelectionChange, numSpan, orgDoc, parseOrgMode, plainEditDiv, posFor, ref, root, selectionActive, selectionMenu, setHtml, throttledUpdateSelection, updateSelection,
  ...
  orgDoc = Leisure.orgDoc, parseOrgMode = Leisure.parseOrgMode;
  ...
  OrgEditing = (function(superClass) {
    ...
    OrgEditing.prototype.lineInfo = function(block, offset) {
      var col, docLine, holder, line, p, ref1, startBlock;
      if (block) {
        ref1 = this.blockLine(block, offset), line = ref1.line, col = ref1.col;
        startBlock = block;
        docLine = line;
        while (block.prev) {
    ...
    OrgEditing.prototype.setEditor = function(editor1) {
      ...
      return this.editor.on('moved', (function(_this) {
        return function() {
          var block, blockLine, col, left, line, offset, ref1, ref2, top;
          ref1 = _this.editor.getSelectedBlockRange(), block = ref1.block, offset = ref1.offset;
          if (block) {
            ref2 = _this.lineInfo(block, offset), line = ref2.line, col = ref2.col, blockLine = ref2.blockLine, top = ref2.top, left = ref2.left;
            if (line) {
