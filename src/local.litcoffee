Code for local-mode.  This will not be loaded under meteor.
    ...
    require ['jquery'], ->
      require ['jqueryui', 'cs!./editorSupport.litcoffee', 'cs!./diag.litcoffee', 'cs!./p2p.litcoffee', 'cs!./tests.litcoffee', 'cs!./lib/webrtc.litcoffee', 'text!../src/defaults.org', 'cs!./ui.litcoffee', 'cs!./export.litcoffee', 'cs!./search.litcoffee'], init
