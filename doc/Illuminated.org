...
: 16
* Inline Views
#+BEGIN_SRC coffee :results yaml dynamic view(fullName) :exports results
firstName: 'Bob'
lastName: 'Jones'
#+END_SRC
#+RESULTS:
...
#+BEGIN_SRC html :defview fullName
<div style='border: solid black 2px; font-weight: bold; Xdisplay: inline-block; padding: 2px'>First name: {{firstName}}, Last name: {{lastName}}</div>
#+END_SRC
* Test Cases
