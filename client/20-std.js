module.exports = L_runMonads([
 ...
 function(){return resolve(L_advise)("bind")("option")(2)(lazy(function(L_opt){return $F(arguments, function(L_cont){return resolve(L_or)(function(){return resolve(L_hasType)(L_opt)(L_some)}, function(){return resolve(L_hasType)(L_opt)(L_none)})(function(){return resolve(L_some)(function(){return resolve(L_opt)(lazy(function(L_value){return resolve(L_cont)(L_value)}))(L_none)})})(L_none)})}))},
 function(){return resolve(L_advise)("bind")("either")(2)(lazy(function(L_either){return $F(arguments, function(L_cont){return resolve(L_or)(function(){return resolve(L_hasType)(L_either)(L_left)}, function(){return resolve(L_hasType)(L_either)(L_right)})(function(){return resolve(L_some)(function(){return resolve(L_either)(lazy(function(L__){return resolve(L_either)}))(lazy(function(L_value){return resolve(L_cont)(L_value)}))})})(L_none)})}))},
