module.exports = L_runMonads([
  function(){return resolve(L_newDefine)("makeNode")(5)("makeNode svg width height rootX rootY = \\f . f svg width height rootX rootY")(lazy(setDataType((function(L_svg, L_width, L_height, L_rootX, L_rootY, more) {
  return (Leisure_shouldDispatch(L_rootY, more))
 ...
 function(){return resolve(L_newDefine)("nodeTranslate")(3)("nodeTranslate st x y = st \\svg width height rootX rootY . makeNode\n  translate svg x y\n  width\n  height\n  rootX + x\n  rootY + y")(lazy((function(L_st, L_x, L_y, more) {
  return (Leisure_shouldDispatch(L_y, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_st)(lazy(function(L_svg){return $F(arguments, function(L_width){return $F(arguments, function(L_height){return $F(arguments, function(L_rootX){return $F(arguments, function(L_rootY){return resolve(L_makeNode)(function(){return resolve(L_translate)(L_svg, L_x, L_y)}, L_width, L_height, function(){return resolve(L_$o)(L_rootX)(L_x)}, function(){return resolve(L_$o)(L_rootY)(L_y)})})})})})}));
 })))},
 function(){return resolve(L_newDefine)("nodeLine")(2)("nodeLine n1 n2 = n1 \\s1 w1 h1 x1 y1 . n2 \\s2 w2 h2 x2 y2 .\n  line [['x1'|x1] ['y1'|y1] ['x2'|x2] ['y2'|y2] ['stroke-width'|3] | defaultLineMap]")(lazy((function(L_n1, L_n2, more) {
  return (Leisure_shouldDispatch(L_n2, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_n1)(lazy(function(L_s1){return $F(arguments, function(L_w1){return $F(arguments, function(L_h1){return $F(arguments, function(L_x1){return $F(arguments, function(L_y1){return resolve(L_n2)(lazy(function(L_s2){return $F(arguments, function(L_w2){return $F(arguments, function(L_h2){return $F(arguments, function(L_x2){return $F(arguments, function(L_y2){return resolve(L_line)(function(){return resolve(L_cons)(function(){return resolve(L_cons)("x1", L_x1)}, function(){return resolve(L_cons)(function(){return resolve(L_cons)("y1", L_y1)}, function(){return resolve(L_cons)(function(){return resolve(L_cons)("x2", L_x2)}, function(){return resolve(L_cons)(function(){return resolve(L_cons)("y2", L_y2)}, function(){return resolve(L_cons)(function(){return resolve(L_cons)("stroke-width", 3)}, L_defaultLineMap)})})})})})})})})})}))})})})})}));
 })))},
 function(){return resolve(L_newDefine)("rangeContainsRange")(4)("rangeContainsRange start end innerStart innerEnd = and (lte start innerStart) (lte innerEnd end)")(lazy((function(L_start, L_end, L_innerStart, L_innerEnd, more) {
  return (Leisure_shouldDispatch(L_innerEnd, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("treeForWith")(2)("treeForWith ast mapFunc = nodeSvg (nodeFor ast mapFunc)")(lazy((function(L_ast, L_mapFunc, more) {
  return (Leisure_shouldDispatch(L_mapFunc, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("createRefNode")(3)("createRefNode ast ref mapFunc = textNode (mapFunc ast redStyle) ref")(lazy((function(L_ast, L_ref, L_mapFunc, more) {
  return (Leisure_shouldDispatch(L_mapFunc, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_textNode)(function(){return resolve(L_mapFunc)(L_ast)(L_redStyle)}, L_ref);
 })))},
 function(){return resolve(L_newDefine)("createLitNode")(3)("createLitNode ast lit mapFunc = textNode (mapFunc ast greenStyle) lit")(lazy((function(L_ast, L_lit, L_mapFunc, more) {
  return (Leisure_shouldDispatch(L_mapFunc, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_textNode)(function(){return resolve(L_mapFunc)(L_ast)(L_greenStyle)}, L_lit);
 })))},
 function(){return resolve(L_newDefine)("textNode")(2)("textNode map txt = (svgMeasureText txt '') \\w h . do\n  nodeW = w + 24\n  nodeH = h + 14\n  makeNode\n    (svgConcat [(rect [['x'|2] ['y'|2] ['width'|nodeW] ['height'|nodeH] | map]) (text txt [['pointer-events' | 'none'] ['text-anchor'|\"middle\"] ['dominant-baseline'|\"mathematical\"] ['x'| 14 + w / 2] ['y'| border + h / 2] ['font-weight'|'bold']])])\n    nodeW\n    nodeH\n    nodeW / 2\n    nodeH / 2")(lazy((function(L_map, L_txt, more) {
  return (Leisure_shouldDispatch(L_txt, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_svgMeasureText)(L_txt)("")(lazy(function(L_w){return $F(arguments, function(L_h){return (function(){
