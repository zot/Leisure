...
var markLeisureErrors = Leisure.markLeisureErrors;processResult(//AST((λx . bind (defInfixToken "*" "before" nil) λ_ . bind (defInfixToken "/" "at" "*") λ_ . bind (defInfixToken "+" "at" nil) λ_ . bind (defInfixToken "-" "at" "+") λ_ . bind (defInfixToken "<" "at" nil) λ_ . bind (defInfixToken ">" "at" nil) λ_ . (λx . addParseFilter mainParseInfix) (log "filter" 2)) (log "infix" 1))
