...
Leisure.createMethod('nil', 'evens', "\\l      . nil", function(_l) {return _nil();});
  ...
  _merge = Parse.define('merge', (function() {var f; return function _merge(){return f || (f = (function(_a){return function(_b){return _submerge()(_b)(_a);};}));}})(), 2, "\\a b . submerge b a");;
  _merge = Leisure.makeDispatchFunction('merge', '_merge', '_b', ['_merge', '_a', '_b']);
Leisure.createMethod('nil', 'merge', "\\a b      . a", function(_a, _b) {return _a();});
  _submerge = Parse.define('submerge', (function() {var f; return function _submerge(){return f || (f = (function(_a){return function(_b){return _lte()((function(){var $m; return (function(){return $m || ($m = (_head()(_a)))})})())((function(){var $m; return (function(){return $m || ($m = (_head()(_b)))})})())((function(){var $m; return (function(){return $m || ($m = (_cons()((function(){var $m; return (function(){return $m || ($m = (_head()(_a)))})})())((function(){var $m; return (function(){return $m || ($m = (_merge()((function(){var $m; return (function(){return $m || ($m = (_tail()(_a)))})})())(_b)))})})())))})})())((function(){var $m; return (function(){return $m || ($m = (_cons()((function(){var $m; return (function(){return $m || ($m = (_head()(_b)))})})())((function(){var $m; return (function(){return $m || ($m = (_merge()(_a)((function(){var $m; return (function(){return $m || ($m = (_tail()(_b)))})})())))})})())))})})());};}));}})(), 2, "\\a b . lte (head a) (head b)\n  [(head a) | (merge (tail a) b)]\n  [(head b) | (merge a (tail b))]");;
  _submerge = Leisure.makeDispatchFunction('submerge', '_submerge', '_b', ['_submerge', '_a', '_b']);
Leisure.createMethod('nil', 'submerge', "\\a b      . a", function(_a, _b) {return _a();});
  _mergeSort = Parse.define('mergeSort', (function() {var f; return function _mergeSort(){return f || (f = (function(_l){return _eq()((function(){var $m; return (function(){return $m || ($m = (_tail()(_l)))})})())(_nil)(_l)((function(){var $m; return (function(){return $m || ($m = (function(_cl){return function(_e){return function(_o){return _merge()((function(){var $m; return (function(){return $m || ($m = (_mergeSort()(_e)))})})())((function(){var $m; return (function(){return $m || ($m = (_mergeSort()(_o)))})})());}((function(){var $m; return (function(){return $m || ($m = (_tail()(_cl)))})})());}((function(){var $m; return (function(){return $m || ($m = (_head()(_cl)))})})());}((function(){var $m; return (function(){return $m || ($m = (_cleave()(_l)))})})())))})})());}));}})(), 1, "\\l . eq (tail l) nil\n  l\n  do\n    cl = cleave l\n    e = head cl\n    o = tail cl\n    merge (mergeSort e) (mergeSort o)");;
  _mergeSort = Leisure.makeDispatchFunction('mergeSort', '_mergeSort', '_l', ['_mergeSort', '_l']);
Leisure.createMethod('nil', 'mergeSort', "\\l      . nil", function(_l) {return _nil();});
  _sort = Parse.define('sort', (function() {var f; return function _sort(){return f || (f = (function(_l){return _mergeSort()(_l);}));}})(), 1, "\\l . mergeSort l");;
