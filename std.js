...
var define = Parse.define;
var _id, _flip, _true, _false, _and, _or, _not, _neq, _left, _right, _some, _some2, _none, _null$e, _append, _compose, _iszero, _positive, _length, _$_$_, _$o$o, _even$e, _odd$e, _max, _min, _lexAsCons, _reverse, _subreverse, _addstr, _if, _at, _take, _takeWhile, _drop, _dropWhile, _series, _from, _fromBy, _fromTo, _fromToBy, _any, _all, _index_combine, _indexof, _position, _find, _findIf, _findIfOpt, _count, _countIf, _countIfNot, _remove, _removeIf, _removeIfNot, _filter, _map, _reduce, _$r, _$s, _$q, _$b, _nextListItem, _dlempty, _dl, _dlAppend, _identMacro, _macroCons, _do, _doClause, _doExtractVar, _dev, _html;
...
;
//dev = AST(λlist tokName . "and" ("is" "list" "cons") ("and" ("is" ("tail" "list") "cons") ("and" ("is" ("head" ("tail" "list")) "token") ("eq" "tokName" ("tokenName" ("head" ("tail" "list")))))) ("some" ("head" "list")) "none")
root.defs._dev = _dev = Parse.define('dev', (function() {var f = (function(_list){return function(_tokName){return _and()((function(){var $m; return (function(){return $m || ($m = (_is()(_list)(_cons)))})})())((function(){var $m; return (function(){return $m || ($m = (_and()((function(){var $m; return (function(){return $m || ($m = (_is()((function(){var $m; return (function(){return $m || ($m = (_tail()(_list)))})})())(_cons)))})})())((function(){var $m; return (function(){return $m || ($m = (_and()((function(){var $m; return (function(){return $m || ($m = (_is()((function(){var $m; return (function(){return $m || ($m = (_head()((function(){var $m; return (function(){return $m || ($m = (_tail()(_list)))})})())))})})())(_token)))})})())((function(){var $m; return (function(){return $m || ($m = (_eq()(_tokName)((function(){var $m; return (function(){return $m || ($m = (_tokenName()((function(){var $m; return (function(){return $m || ($m = (_head()((function(){var $m; return (function(){return $m || ($m = (_tail()(_list)))})})())))})})())))})})())))})})())))})})())))})})())((function(){var $m; return (function(){return $m || ($m = (_some()((function(){var $m; return (function(){return $m || ($m = (_head()(_list)))})})())))})})())(_none);};}); return function _dev(){return f;}})(), 2, "\\list. \\tokName. and\n  is list cons\n  and\n    is (tail list) cons\n    and\n      is (head (tail list)) token\n      eq tokName (tokenName (head (tail list)))\n  some (head list)\n  none");
;
//html = AST(λx f . "f" "x")
