...
(function() {
  var LeisureObject, Leisure_unit, Map, Monad, Monad2, Nil, SimpyCons, _, _false, _identity, _true, _unit, actors, ast2Json, asyncMonad, basicCall, bind2, booleanFor, call, callBind, callMonad, cons, consFrom, continueMonads, curry, defaultEnv, define, dump, ensureLeisureClass, escapePresentationHtml, funcInfo, functionInfo, gensymCounter, getDataType, getMonadSyncMode, getType, getValue, hamt, head, identity, isMonad, jsonConvert, lacons, lazy, lc, left, lz, makeHamt, makeMonad, makeSyncMonad, mkProto, monadModeSync, nakedDefine, nameSub, newRunMonad, newbind, nextHamtPair, nextMonad, none, nsLog, parensContent, parensEnd, parensStart, posString, presentationReplacements, presentationToHtmlReplacements, readDir, readFile, ref, ref1, ref2, ref3, replaceErr, requireFiles, resolve, right, root, runMonad, runMonad2, rz, safeLoad, setDataType, setType, setValue, setWarnAsync, simpyCons, some, statFile, strCoord, strFromList, strToList, subcurry, tail, tokenPos, tokenString, trampCurry, unescapePresentationHtml, values, warnAsync, withSyncModeDo, writeFile, yaml,
    slice = [].slice,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty,
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  ref = root = (typeof module !== "undefined" && module !== null ? module : {}).exports = require('15-base'), readFile = ref.readFile, statFile = ref.statFile, readDir = ref.readDir, writeFile = ref.writeFile, defaultEnv = ref.defaultEnv, SimpyCons = ref.SimpyCons, simpyCons = ref.simpyCons, resolve = ref.resolve, lazy = ref.lazy, nsLog = ref.nsLog, funcInfo = ref.funcInfo;

  ref1 = require('16-ast'), define = ref1.define, nakedDefine = ref1.nakedDefine, cons = ref1.cons, Nil = ref1.Nil, head = ref1.head, tail = ref1.tail, getType = ref1.getType, getDataType = ref1.getDataType, ast2Json = ref1.ast2Json, ensureLeisureClass = ref1.ensureLeisureClass, LeisureObject = ref1.LeisureObject, mkProto = ref1.mkProto, setType = ref1.setType, setDataType = ref1.setDataType, functionInfo = ref1.functionInfo, nameSub = ref1.nameSub;

  _ = ((ref2 = Leisure.require) != null ? ref2 : require)('lodash.min');

  Map = (typeof Immutable !== "undefined" && Immutable !== null ? Immutable : require('05-immutable')).Map;

  yaml = require('yaml');

  ref3 = Leisure.yaml, safeLoad = ref3.safeLoad, dump = ref3.dump;
  ...
  define('_show', function(data) {
    var ref4;
    if ((ref4 = typeof rz(data)) === 'string' || ref4 === 'number' || ref4 === 'boolean') {
  ...
  define('getProperties', function(func) {
    var ref4;
    if ((ref4 = rz(func)) != null ? ref4.properties : void 0) {
    ...
    return function(name) {
      return function(value) {
        return makeSyncMonad(function(env, cont) {
          var f, ref4;
          f = rz(func);
          f.properties = rz(L_aconsf)(name)(value)(lz((ref4 = f.properties) != null ? ref4 : rz(L_nil)));
  ...
  defaultEnv.err = function(err) {
    var ref4;
    return this.write("ENV Error: " + ((ref4 = err.stack) != null ? ref4 : err));
  };
  ...
  withSyncModeDo = function(newMode, block) {
    ...
    try {
      ...
      err = _error;
      return console.log("ERR: " + ((ref4 = err.stack) != null ? ref4 : err));
    } finally {
  ...
  newRunMonad = function(monad, env, cont, contStack) {
    ...
    try {
      ...
      console.log((ref4 = err.stack) != null ? ref4 : err);
  ...
  define('protect', function(value) {
    return makeMonad(function(env, cont) {
      ...
      hnd = function(err) {
        var ref4, ref5;
        console.log("PROTECTED ERROR: " + ((ref4 = err.stack) != null ? ref4 : err));
        return cont(left((ref5 = err.stack) != null ? ref5 : err));
      };
  ...
  define('getValueOr', function(name) {
    return function(defaultValue) {
      return makeSyncMonad(function(env, cont) {
        var ref4;
        return cont((ref4 = values[rz(name)]) != null ? ref4 : rz(defaultValue));
      });
    };
  });
  ...
  define('envGetOr', function(name) {
    return function(defaultValue) {
      return makeSyncMonad(function(env, cont) {
        var ref4;
        return cont((ref4 = env.values[rz(name)]) != null ? ref4 : rz(defaultValue));
      });
    };
  });
  ...
  define('readFile', function(name) {
    return makeMonad(function(env, cont) {
      return env.readFile(rz(name), function(err, contents) {
        var ref4;
        return cont((err ? left((ref4 = err.stack) != null ? ref4 : err) : right(contents)));
      });
    });
  });
  ...
  define('readDir', function(dir) {
    return makeMonad(function(env, cont) {
      return env.readDir(rz(dir), function(err, files) {
        var ref4;
        return cont((err ? left((ref4 = err.stack) != null ? ref4 : err) : right(files)));
      });
    });
  });
  ...
  define('statFile', function(file) {
    return makeMonad(function(env, cont) {
      return env.statFile(rz(file), function(err, stats) {
        var ref4;
        return cont((err ? left((ref4 = err.stack) != null ? ref4 : err) : right(stats)));
      });
    });
  });
  ...
  define('setNameSpaceInfo', function(info) {
    return makeSyncMonad(function(env, cont) {
      var ref4;
      ref4 = rz(info), root.nameSpacePath = ref4[0], root.currentNameSpace = ref4[1];
