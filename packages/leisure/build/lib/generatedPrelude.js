module.exports = L_runMonads([
 ...
 function(){return resolve(L_newDefine)("and")(2)("and a b = a b false")(lazy((function(L_a, L_b, more) {
  return (Leisure_shouldDispatch(L_b, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_a)(L_b)(L_false);
 })))},
 function(){return resolve(L_newDefine)("or")(2)("or a b = a true b")(lazy((function(L_a, L_b, more) {
  return (Leisure_shouldDispatch(L_b, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("some2")(2)("some2 a b = \\someCase noneCase . someCase a b")(lazy(setDataType((function(L_a, L_b, more) {
  return (Leisure_shouldDispatch(L_b, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("neq")(2)("neq a b = not (eq a b)")(lazy((function(L_a, L_b, more) {
  return (Leisure_shouldDispatch(L_b, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_not)(function(){return resolve(L_eq)(L_a)(L_b)});
 })))},
 ...
 function(){return resolve(L_newDefine)("strAt")(2)("strAt string index = _strAt\r\n  assertType 'strAt string' '*string' string\r\n  assertType 'strAt index' '*number' index")(lazy((function(L_string, L_index, more) {
  return (Leisure_shouldDispatch(L_index, more))
    ? Leisure_dispatch(arguments)
    : resolve(L__strAt)(function(){return resolve(L_assertType)("strAt string", "*string", L_string)})(function(){return resolve(L_assertType)("strAt index", "*number", L_index)});
 })))},
 function(){return resolve(L_newDefine)("strStartsWith")(2)("strStartsWith string prefix = _strStartsWith\r\n  assertType 'strStartsWith string' '*string' string\r\n  assertType 'strStartsWith prefix' '*string' prefix")(lazy((function(L_string, L_prefix, more) {
  return (Leisure_shouldDispatch(L_prefix, more))
    ? Leisure_dispatch(arguments)
    : resolve(L__strStartsWith)(function(){return resolve(L_assertType)("strStartsWith string", "*string", L_string)})(function(){return resolve(L_assertType)("strStartsWith prefix", "*string", L_prefix)});
 })))},
 ...
 function(){return resolve(L_newDefine)("strReplace")(3)("strReplace string pat repl = _strReplace\r\n  assertType 'strReplace string' '*string' string\r\n  assert (or (hasType pat '*string') (hasType pat '*RegExp')) (strCat (cons 'strStartsWith pat should be type string or RegExp but it is type ' (cons (getType pat) (cons ': ' (cons (show pat) nil))))) pat\r\n  assertType 'strReplace repl' '*string' repl")(lazy((function(L_string, L_pat, L_repl, more) {
  return (Leisure_shouldDispatch(L_repl, more))
    ? Leisure_dispatch(arguments)
    : resolve(L__strReplace)(function(){return resolve(L_assertType)("strReplace string", "*string", L_string)})(function(){return resolve(L_assert)(function(){return resolve(L_or)(function(){return resolve(L_hasType)(L_pat)("*string")}, function(){return resolve(L_hasType)(L_pat)("*RegExp")})})(function(){return resolve(L_strCat)(function(){return resolve(L_cons)("strStartsWith pat should be type string or RegExp but it is type ", function(){return resolve(L_cons)(function(){return resolve(L_getType)(L_pat)}, function(){return resolve(L_cons)(": ", function(){return resolve(L_cons)(function(){return resolve(L_show)(L_pat)}, L_nil)})})})})})(L_pat)})(function(){return resolve(L_assertType)("strReplace repl", "*string", L_repl)});
 })))},
 function(){return resolve(L_newDefine)("strSubstring")(3)("strSubstring str start end = _strSubstring\r\n  assertType 'strSubstring str' '*string' str\r\n  assertType 'strSubstring start' '*number' start\r\n  assertType 'strSubstring end' '*number' end")(lazy((function(L_str, L_start, L_end, more) {
  return (Leisure_shouldDispatch(L_end, more))
    ? Leisure_dispatch(arguments)
    : resolve(L__strSubstring)(function(){return resolve(L_assertType)("strSubstring str", "*string", L_str)})(function(){return resolve(L_assertType)("strSubstring start", "*number", L_start)})(function(){return resolve(L_assertType)("strSubstring end", "*number", L_end)});
 })))},
 function(){return resolve(L_newDefine)("strSplit")(2)("strSplit str pat = _strSplit\r\n  assertType 'strSplit str' '*string' str\r\n  assert (or (hasType pat '*string') (hasType pat '*RegExp')) (strCat (cons 'strSplit pat should be type string or RegExp but it is type ' (cons (getType pat) (cons ': ' (cons (show pat) nil))))) pat")(lazy((function(L_str, L_pat, more) {
  return (Leisure_shouldDispatch(L_pat, more))
    ? Leisure_dispatch(arguments)
    : resolve(L__strSplit)(function(){return resolve(L_assertType)("strSplit str", "*string", L_str)})(function(){return resolve(L_assert)(function(){return resolve(L_or)(function(){return resolve(L_hasType)(L_pat)("*string")}, function(){return resolve(L_hasType)(L_pat)("*RegExp")})})(function(){return resolve(L_strCat)(function(){return resolve(L_cons)("strSplit pat should be type string or RegExp but it is type ", function(){return resolve(L_cons)(function(){return resolve(L_getType)(L_pat)}, function(){return resolve(L_cons)(": ", function(){return resolve(L_cons)(function(){return resolve(L_show)(L_pat)}, L_nil)})})})})})(L_pat)});
 })))},
 ...
 function(){return resolve(L_newDefine)("strAdd")(2)("strAdd str1 str2 = _strAdd (assertType 'strAdd str1' '*string' str1) (assertType 'strAdd str2' '*string' str2)")(lazy((function(L_str1, L_str2, more) {
  return (Leisure_shouldDispatch(L_str2, more))
    ? Leisure_dispatch(arguments)
    : resolve(L__strAdd)(function(){return resolve(L_assertType)("strAdd str1", "*string", L_str1)})(function(){return resolve(L_assertType)("strAdd str2", "*string", L_str2)});
 })))},
 function(){return resolve(L_newDefine)("strMatch")(2)("strMatch str pat = _strMatch\r\n  assertType 'strMatch str' '*string' str\r\n  assert (or (hasType pat '*string') (hasType pat '*RegExp')) (strCat (cons 'strMatch pat should be type string or RegExp but it is type ' (cons (getType pat) (cons ': ' (cons (show pat) nil))))) pat")(lazy((function(L_str, L_pat, more) {
  return (Leisure_shouldDispatch(L_pat, more))
    ? Leisure_dispatch(arguments)
    : resolve(L__strMatch)(function(){return resolve(L_assertType)("strMatch str", "*string", L_str)})(function(){return resolve(L_assert)(function(){return resolve(L_or)(function(){return resolve(L_hasType)(L_pat)("*string")}, function(){return resolve(L_hasType)(L_pat)("*RegExp")})})(function(){return resolve(L_strCat)(function(){return resolve(L_cons)("strMatch pat should be type string or RegExp but it is type ", function(){return resolve(L_cons)(function(){return resolve(L_getType)(L_pat)}, function(){return resolve(L_cons)(": ", function(){return resolve(L_cons)(function(){return resolve(L_show)(L_pat)}, L_nil)})})})})})(L_pat)});
 })))},
 ...
 function(){return resolve(L_newDefine)("regexpFlags")(2)("regexpFlags str flags = _regexpFlags\r\n  assertType 'regexp str' '*string' str\r\n  assertType 'regexp flags' '*string' flags")(lazy((function(L_str, L_flags, more) {
  return (Leisure_shouldDispatch(L_flags, more))
    ? Leisure_dispatch(arguments)
    : resolve(L__regexpFlags)(function(){return resolve(L_assertType)("regexp str", "*string", L_str)})(function(){return resolve(L_assertType)("regexp flags", "*string", L_flags)});
 })))},
 function(){return resolve(L_newDefine)("jsonParse")(3)("jsonParse str failure success = _jsonParse\r\n  assertType 'jsonParse str' '*string' str\r\n  failure\r\n  success")(lazy((function(L_str, L_failure, L_success, more) {
  return (Leisure_shouldDispatch(L_success, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("compose")(2)("compose f g = \\x . f (g x)")(lazy(setDataType((function(L_f, L_g, more) {
  return (Leisure_shouldDispatch(L_g, more))
    ? Leisure_dispatch(arguments)
    : setType(function(L_x){return resolve(L_f)(function(){return resolve(L_g)(L_x)})}, 'compose');
 }), 'compose')))},
 ...
 function(){return resolve(L_newDefine)("withCons")(3)("withCons l nilCase cont = isCons l (l (\\h t D . cont h t) nilCase) nilCase")(lazy((function(L_l, L_nilCase, L_cont, more) {
  return (Leisure_shouldDispatch(L_cont, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isCons)(L_l)(function(){return resolve(L_l)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_cont)(L_h)(L_t)}}}))(L_nilCase)})(L_nilCase);
 })))},
 function(){return resolve(L_newDefine)("cons")(2)("cons a b = \\f . f a b")(lazy(setDataType((function(L_a, L_b, more) {
  return (Leisure_shouldDispatch(L_b, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("assertType")(3)("assertType msg type value = assert (hasType value type) (strCat (cons msg (cons ' should be type ' (cons (getDataType type) (cons ', but its type is ' (cons (getType value) (cons ': ' (cons (show value) nil)))))))) value")(lazy((function(L_msg, L_type, L_value, more) {
  return (Leisure_shouldDispatch(L_value, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_assert)(function(){return resolve(L_hasType)(L_value)(L_type)})(function(){return resolve(L_strCat)(function(){return resolve(L_cons)(L_msg, function(){return resolve(L_cons)(" should be type ", function(){return resolve(L_cons)(function(){return resolve(L_getDataType)(L_type)}, function(){return resolve(L_cons)(", but its type is ", function(){return resolve(L_cons)(function(){return resolve(L_getType)(L_value)}, function(){return resolve(L_cons)(": ", function(){return resolve(L_cons)(function(){return resolve(L_show)(L_value)}, L_nil)})})})})})})})})(L_value);
 })))},
 ...
 function(){return resolve(L_newDefine)("append")(2)("append a b = isNil a\r\n  b\r\n  cons (head a) (append (tail a) b)")(lazy((function(L_a, L_b, more) {
  return (Leisure_shouldDispatch(L_b, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_a)(L_b)(function(){return resolve(L_cons)(function(){return resolve(L_head)(L_a)}, function(){return resolve(L_append)(function(){return resolve(L_tail)(L_a)}, L_b)})});
 })))},
 ...
 function(){return resolve(L_newDefine)("subflatten")(2)("subflatten list result = isNil list\r\n  result\r\n  isCons list\r\n    subflatten (head list) (subflatten (tail list) result)\r\n    cons list result")(lazy((function(L_list, L_result, more) {
  return (Leisure_shouldDispatch(L_result, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_list)(L_result)(function(){return resolve(L_isCons)(L_list)(function(){return resolve(L_subflatten)(function(){return resolve(L_head)(L_list)}, function(){return resolve(L_subflatten)(function(){return resolve(L_tail)(L_list)}, L_result)})})(function(){return resolve(L_cons)(L_list, L_result)})});
 })))},
 function(){return resolve(L_newDefine)("reverse")(1)("reverse l = rev l nil")(lazy(function(L_l){return resolve(L_rev)(L_l, L_nil)}))},
 function(){return resolve(L_newDefine)("rev")(2)("rev l result = isNil l\r\n  result\r\n  rev (tail l) (cons (head l) result)")(lazy((function(L_l, L_result, more) {
  return (Leisure_shouldDispatch(L_result, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_l)(L_result)(function(){return resolve(L_rev)(function(){return resolve(L_tail)(L_l)}, function(){return resolve(L_cons)(function(){return resolve(L_head)(L_l)}, L_result)})});
 })))},
 function(){return resolve(L_newDefine)("filter")(2)("filter func list = isNil list\r\n  nil\r\n  func (head list) (cons (head list)) id (filter func (tail list))")(lazy((function(L_func, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_list)(L_nil)(function(){return resolve(L_func)(function(){return resolve(L_head)(L_list)})(function(){return resolve(L_cons)(function(){return resolve(L_head)(L_list)})})(L_id)(function(){return resolve(L_filter)(L_func, function(){return resolve(L_tail)(L_list)})})});
 })))},
 function(){return resolve(L_newDefine)("find")(2)("find predicate list = isNil list\r\n  none\r\n  predicate (head list) (some (head list)) (find predicate (tail list))")(lazy((function(L_predicate, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_list)(L_none)(function(){return resolve(L_predicate)(function(){return resolve(L_head)(L_list)})(function(){return resolve(L_some)(function(){return resolve(L_head)(L_list)})})(function(){return resolve(L_find)(L_predicate, function(){return resolve(L_tail)(L_list)})})});
 })))},
 function(){return resolve(L_newDefine)("contains")(2)("contains list item = find (\\el . eq el item) list (\\x . true) false")(lazy((function(L_list, L_item, more) {
 ...
 function(){return resolve(L_newDefine)("map")(2)("map func l = isNil l\r\n  nil\r\n  cons (func (head l)) (map func (tail l))")(lazy((function(L_func, L_l, more) {
  return (Leisure_shouldDispatch(L_l, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_l)(L_nil)(function(){return resolve(L_cons)(function(){return resolve(L_func)(function(){return resolve(L_head)(L_l)})}, function(){return resolve(L_map)(L_func, function(){return resolve(L_tail)(L_l)})})});
 })))},
 function(){return resolve(L_newDefine)("mapSave")(2)("mapSave func l = isNil l\r\n  nil\r\n  \\\\\r\n    newH = func (head l)\r\n    newT = mapSave func (tail l)\r\n    .\r\n    and (eq newH (head l)) (eq newT (tail l))\r\n      l\r\n      cons newH newT")(lazy((function(L_func, L_l, more) {
  return (Leisure_shouldDispatch(L_l, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_l)(L_nil)(function(){return(function(){
 ...
 function(){return resolve(L_newDefine)("foldl")(3)("foldl func initialValue l = l (\\h t D . foldl func (func initialValue h) t) initialValue")(lazy((function(L_func, L_initialValue, L_l, more) {
  return (Leisure_shouldDispatch(L_l, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_l)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_foldl)(L_func, function(){return resolve(L_func)(L_initialValue)(L_h)}, L_t)}}}))(L_initialValue);
 })))},
 function(){return resolve(L_newDefine)("foldl1")(2)("foldl1 func l = l \\h t . foldl func h t")(lazy((function(L_func, L_l, more) {
  return (Leisure_shouldDispatch(L_l, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_l)(lazy(function(L_h){return function(L_t){return resolve(L_foldl)(L_func, L_h, L_t)}}));
 })))},
 function(){return resolve(L_newDefine)("foldr")(3)("foldr func initialValue list = list\r\n  \\h t D . func h (foldr func initialValue t)\r\n  initialValue")(lazy((function(L_func, L_initialValue, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_func)(L_h)(function(){return resolve(L_foldr)(L_func, L_initialValue, L_t)})}}}))(L_initialValue);
 })))},
 function(){return resolve(L_newDefine)("foldr1")(2)("foldr1 func list = list \\h t . isNil t\r\n  h\r\n  func h (foldr1 func t)")(lazy((function(L_func, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return resolve(L_isNil)(L_t)(L_h)(function(){return resolve(L_func)(L_h)(function(){return resolve(L_foldr1)(L_func, L_t)})})}}));
 })))},
 function(){return resolve(L_newDefine)("intersperse")(2)("intersperse list element = list (\\h t D .\r\n  isNil t\r\n    list\r\n    cons h (cons element (intersperse t element))) nil")(lazy((function(L_list, L_element, more) {
  return (Leisure_shouldDispatch(L_element, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isNil)(L_t)(L_list)(function(){return resolve(L_cons)(L_h, function(){return resolve(L_cons)(L_element, function(){return resolve(L_intersperse)(L_t, L_element)})})})}}}))(L_nil);
 })))},
 function(){return resolve(L_newDefine)("join")(2)("join list el = strCat (intersperse list el)")(lazy((function(L_list, L_el, more) {
  return (Leisure_shouldDispatch(L_el, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_strCat)(function(){return resolve(L_intersperse)(L_list, L_el)});
 })))},
 function(){return resolve(L_newDefine)("findIndex")(2)("findIndex func list = idx list func 0")(lazy((function(L_func, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_idx)(L_list, L_func, 0);
 })))},
 function(){return resolve(L_newDefine)("idx")(3)("idx list func pos = list\r\n  \\h t D . func h\r\n    pos\r\n    idx t func (+ 1 pos)\r\n  -1")(lazy((function(L_list, L_func, L_pos, more) {
  return (Leisure_shouldDispatch(L_pos, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_func)(L_h)(L_pos)(function(){return resolve(L_idx)(L_t, L_func, function(){return resolve(L_$o)(1)(L_pos)})})}}}))(-1);
 })))},
 function(){return resolve(L_newDefine)("index")(2)("index list el = find (\\item . == el item) list")(lazy((function(L_list, L_el, more) {
  return (Leisure_shouldDispatch(L_el, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("zip")(2)("zip a b = isNil a\r\n  nil\r\n  isNil b\r\n    nil\r\n    cons (cons (head a) (head b)) (zip (tail a) (tail b))")(lazy((function(L_a, L_b, more) {
  return (Leisure_shouldDispatch(L_b, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_a)(L_nil)(function(){return resolve(L_isNil)(L_b)(L_nil)(function(){return resolve(L_cons)(function(){return resolve(L_cons)(function(){return resolve(L_head)(L_a)}, function(){return resolve(L_head)(L_b)})}, function(){return resolve(L_zip)(function(){return resolve(L_tail)(L_a)}, function(){return resolve(L_tail)(L_b)})})})});
 })))},
 function(){return resolve(L_newDefine)("assertAlist")(3)("assertAlist msg value result = assert (isAlist value) (strCat (cons msg (cons ' should be a association list, but it is not; its type is ' (cons (getType value) (cons ': ' (cons (show value) nil)))))) result")(lazy((function(L_msg, L_value, L_result, more) {
  return (Leisure_shouldDispatch(L_result, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_assert)(function(){return resolve(L_isAlist)(L_value)})(function(){return resolve(L_strCat)(function(){return resolve(L_cons)(L_msg, function(){return resolve(L_cons)(" should be a association list, but it is not; its type is ", function(){return resolve(L_cons)(function(){return resolve(L_getType)(L_value)}, function(){return resolve(L_cons)(": ", function(){return resolve(L_cons)(function(){return resolve(L_show)(L_value)}, L_nil)})})})})})})(L_result);
 })))},
 function(){return resolve(L_newDefine)("acons")(3)("acons k v alist = assertAlist \"acons alist\" alist (\\@ type cons . \\f . \\@ assoc true . f (cons k v) alist)")(lazy((function(L_k, L_v, L_alist, more) {
  return (Leisure_shouldDispatch(L_alist, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_assertAlist)("acons alist", L_alist, lazy(setType(setLambdaProperties(function(L_f){return resolve(L_f)(function(){return resolve(L_cons)(L_k, L_v)})(L_alist)}, {"assoc":"true"}), 'cons')));
 })))},
 function(){return resolve(L_newDefine)("assoc")(2)("assoc k alist  = find (\\el . eq k (head el)) alist (\\cell . cell \\head tail . some tail) none")(lazy((function(L_k, L_alist, more) {
  return (Leisure_shouldDispatch(L_alist, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_find)(lazy(function(L_el){return resolve(L_eq)(L_k)(function(){return resolve(L_head)(L_el)})}), L_alist)(lazy(function(L_cell){return resolve(L_cell)(lazy(function(L_head){return function(L_tail){return resolve(L_some)(L_tail)}}))}))(L_none);
 })))},
 function(){return resolve(L_newDefine)("rassoc")(2)("rassoc v alist = find (\\el . eq v (tail el)) alist (\\cell . cell \\head tail . some head) none")(lazy((function(L_v, L_alist, more) {
  return (Leisure_shouldDispatch(L_alist, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_find)(lazy(function(L_el){return resolve(L_eq)(L_v)(function(){return resolve(L_tail)(L_el)})}), L_alist)(lazy(function(L_cell){return resolve(L_cell)(lazy(function(L_head){return function(L_tail){return resolve(L_some)(L_head)}}))}))(L_none);
 })))},
 ...
 function(){return resolve(L_newDefine)("aconsPair")(2)("aconsPair keyValue list = \\@ type cons . \\f . \\@ assoc true . f keyValue list")(lazy((function(L_keyValue, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : setType(setLambdaProperties(function(L_f){return resolve(L_f)(L_keyValue)(L_list)}, {"assoc":"true"}), 'cons');
 })))},
 function(){return resolve(L_newDefine)("appendAlist")(2)("appendAlist a b = isNil a\r\n  b\r\n  aconsPair (head a) (appendAlist (tail a) b)")(lazy((function(L_a, L_b, more) {
  return (Leisure_shouldDispatch(L_b, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_a)(L_b)(function(){return resolve(L_aconsPair)(function(){return resolve(L_head)(L_a)}, function(){return resolve(L_appendAlist)(function(){return resolve(L_tail)(L_a)}, L_b)})});
 })))},
 ...
 function(){return resolve(L_newDefine)("getProperty")(2)("getProperty func prop = assoc prop (getProperties func)")(lazy((function(L_func, L_prop, more) {
  return (Leisure_shouldDispatch(L_prop, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_assoc)(L_prop, function(){return resolve(L_getProperties)(L_func)});
 })))},
 function(){return resolve(L_newDefine)("hasProperty")(2)("hasProperty func prop = getProperty func prop\r\n  \\_ . true\r\n  false")(lazy((function(L_func, L_prop, more) {
  return (Leisure_shouldDispatch(L_prop, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("cleave")(1)("cleave l = cons (evens l) (odds l)")(lazy(function(L_l){return resolve(L_cons)(function(){return resolve(L_evens)(L_l)}, function(){return resolve(L_odds)(L_l)})}))},
 function(){return resolve(L_newDefine)("merge")(3)("merge cmp a b = a\r\n  \\ah at D . b\r\n    \\bh bt D . cmp ah bh\r\n      cons ah (merge cmp at b)\r\n      cons bh (merge cmp a bt)\r\n    a\r\n  b")(lazy((function(L_cmp, L_a, L_b, more) {
  return (Leisure_shouldDispatch(L_b, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("mergeSort")(2)("mergeSort cmp l = l\r\n  \\h t D . eq (tail l) nil\r\n    l\r\n    \\\\\r\n      cl = cleave l\r\n      e = head cl\r\n      o = tail cl\r\n      .\r\n      merge cmp (mergeSort cmp e) (mergeSort cmp o)\r\n  nil")(lazy((function(L_cmp, L_l, more) {
  return (Leisure_shouldDispatch(L_l, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_l)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_eq)(function(){return resolve(L_tail)(L_l)})(L_nil)(L_l)(function(){return(function(){
 ...
 function(){return resolve(L_newDefine)("slowsort")(2)("slowsort less list = (qs less list) nil")(lazy((function(L_less, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_qs)(L_less, L_list)(L_nil);
 })))},
 function(){return resolve(L_newDefine)("qs")(2)("qs sortedFunc list = list\r\n  \\h t D . \\\\\r\n    greater = filter (sortedFunc h) t\r\n    lesser = filter (compose not (sortedFunc h)) t\r\n    .\r\n    \\rest . (qs sortedFunc lesser) (cons h ((qs sortedFunc greater) rest))\r\n  id")(lazy((function(L_sortedFunc, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return (function(){
 ...
 function(){return resolve(L_newDefine)("insertSorted")(3)("insertSorted sortFunc item list = list\r\n  \\h t D . sortFunc item h (cons item list) (cons h (insertSorted sortFunc item t))\r\n  cons item nil")(lazy((function(L_sortFunc, L_item, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_sortFunc)(L_item)(L_h)(function(){return resolve(L_cons)(L_item, L_list)})(function(){return resolve(L_cons)(L_h, function(){return resolve(L_insertSorted)(L_sortFunc, L_item, L_t)})})}}}))(function(){return resolve(L_cons)(L_item, L_nil)});
 })))},
 ...
 function(){return resolve(L_newDefine)("ifNotErr")(2)("ifNotErr thing cont = (isErr thing) thing (cont thing)")(lazy((function(L_thing, L_cont, more) {
  return (Leisure_shouldDispatch(L_cont, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isErr)(L_thing)(L_thing)(function(){return resolve(L_cont)(L_thing)});
 })))},
 function(){return resolve(L_setNameSpace)("parser")},
 function(){return resolve(L_newDefine)("token")(2)("token txt pos = \\f . f txt pos")(lazy(setDataType((function(L_txt, L_pos, more) {
  return (Leisure_shouldDispatch(L_pos, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("filepos")(3)("filepos file line offset = \\f . f file line offset")(lazy(setDataType((function(L_file, L_line, L_offset, more) {
  return (Leisure_shouldDispatch(L_offset, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("addFilepos")(2)("addFilepos pos change = isFilepos pos pos emptyFilePos\r\n  \\file line offset . filepos file line (+ offset change)")(lazy((function(L_pos, L_change, more) {
  return (Leisure_shouldDispatch(L_change, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isFilepos)(L_pos)(L_pos)(L_emptyFilePos)(lazy(function(L_file){return function(L_line){return function(L_offset){return resolve(L_filepos)(L_file, L_line, function(){return resolve(L_$o)(L_offset)(L_change)})}}}));
 })))},
 ...
 function(){return resolve(L_newDefine)("filePosFor")(2)("filePosFor lineStarts offset = countFilePos (head (tail lineStarts)) 0 (tail (tail lineStarts)) offset\r\n  \\line offset . filepos (head lineStarts) line offset")(lazy((function(L_lineStarts, L_offset, more) {
  return (Leisure_shouldDispatch(L_offset, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_countFilePos)(function(){return resolve(L_head)(function(){return resolve(L_tail)(L_lineStarts)})}, 0, function(){return resolve(L_tail)(function(){return resolve(L_tail)(L_lineStarts)})}, L_offset)(lazy(function(L_line){return function(L_offset){return resolve(L_filepos)(function(){return resolve(L_head)(L_lineStarts)}, L_line, L_offset)}}));
 })))},
 function(){return resolve(L_newDefine)("countFilePos")(4)("countFilePos line lineOffset starts offset = or (isNil starts) (> (head starts) offset)\r\n  \\f . f line (- offset lineOffset)\r\n  countFilePos (+ line 1) (head starts) (tail starts) offset")(lazy((function(L_line, L_lineOffset, L_starts, L_offset, more) {
  return (Leisure_shouldDispatch(L_offset, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_or)(function(){return resolve(L_isNil)(L_starts)}, function(){return resolve(L_$z)(function(){return resolve(L_head)(L_starts)})(L_offset)})(lazy(function(L_f){return resolve(L_f)(L_line)(function(){return resolve(L_$_)(L_offset)(L_lineOffset)})}))(function(){return resolve(L_countFilePos)(function(){return resolve(L_$o)(L_line)(1)}, function(){return resolve(L_head)(L_starts)}, function(){return resolve(L_tail)(L_starts)}, L_offset)});
 })))},
 function(){return resolve(L_newDefine)("fileposList")(1)("fileposList pos = pos \\file line offset . cons line (cons offset nil)")(lazy(function(L_pos){return resolve(L_pos)(lazy(function(L_file){return function(L_line){return function(L_offset){return resolve(L_cons)(L_line, function(){return resolve(L_cons)(L_offset, L_nil)})}}}))}))},
 function(){return resolve(L_newDefine)("parens")(3)("parens start end content = \\f . f start end content")(lazy(setDataType((function(L_start, L_end, L_content, more) {
  return (Leisure_shouldDispatch(L_content, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("makeParens")(3)("makeParens start end content =\r\n  and (isCons content) (isNil (tail content))\r\n    makeParens start end (head content)\r\n    or (isToken content) (isParens content)\r\n      content\r\n      parens start end content")(lazy((function(L_start, L_end, L_content, more) {
  return (Leisure_shouldDispatch(L_content, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_and)(function(){return resolve(L_isCons)(L_content)}, function(){return resolve(L_isNil)(function(){return resolve(L_tail)(L_content)})})(function(){return resolve(L_makeParens)(L_start, L_end, function(){return resolve(L_head)(L_content)})})(function(){return resolve(L_or)(function(){return resolve(L_isToken)(L_content)}, function(){return resolve(L_isParens)(L_content)})(L_content)(function(){return resolve(L_parens)(L_start, L_end, L_content)})});
 })))},
 function(){return resolve(L_newDefine)("parensFromToks")(3)("parensFromToks left right content = \\\\\r\n  start = tokenFilepos left\r\n  end = addFilepos (tokenFilepos right) (strLen (tokenString right))\r\n  .\r\n  parens start end content")(lazy((function(L_left, L_right, L_content, more) {
  return (Leisure_shouldDispatch(L_content, more))
    ? Leisure_dispatch(arguments)
    : (function(){
 ...
 function(){return resolve(L_newDefine)("parseErr")(2)("parseErr msg1 msg2 = err (strCat (cons msg1 (cons msg2 nil)))")(lazy((function(L_msg1, L_msg2, more) {
  return (Leisure_shouldDispatch(L_msg2, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_err)(function(){return resolve(L_strCat)(function(){return resolve(L_cons)(L_msg1, function(){return resolve(L_cons)(L_msg2, L_nil)})})});
 })))},
 ...
 function(){return resolve(L_newDefine)("makeTokens")(3)("makeTokens lineStarts strings start = strings (\\h t D . makeMoreTokens lineStarts h t start) nil")(lazy((function(L_lineStarts, L_strings, L_start, more) {
  return (Leisure_shouldDispatch(L_start, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("makeTokenAt")(3)("makeTokenAt lineStarts txt offset = token txt (filePosFor lineStarts offset)")(lazy((function(L_lineStarts, L_txt, L_offset, more) {
  return (Leisure_shouldDispatch(L_offset, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_token)(L_txt, function(){return resolve(L_filePosFor)(L_lineStarts, L_offset)});
 })))},
 ...
 function(){return resolve(L_newDefine)("splitTokens")(2)("splitTokens str pat = filter (\\s . not (eq s '')) (basicSplitTokens str pat true)")(lazy((function(L_str, L_pat, more) {
  return (Leisure_shouldDispatch(L_pat, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_filter)(lazy(function(L_s){return resolve(L_not)(function(){return resolve(L_eq)(L_s)("")})}), function(){return resolve(L_basicSplitTokens)(L_str, L_pat, L_true)});
 })))},
 ...
 function(){return resolve(L_newDefine)("matchOffset")(2)("matchOffset str match = isNil match\r\n  strLen str\r\n  head (tail (tail match))")(lazy((function(L_str, L_match, more) {
  return (Leisure_shouldDispatch(L_match, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_match)(function(){return resolve(L_strLen)(L_str)})(function(){return resolve(L_head)(function(){return resolve(L_tail)(function(){return resolve(L_tail)(L_match)})})});
 })))},
 function(){return resolve(L_newDefine)("basicSplitTokens")(3)("basicSplitTokens str pat prevIsDel = == str ''\r\n  nil\r\n  \\\\\r\n    num = strMatch str numberPat\r\n    del = strMatch str pat\r\n    numOffset = matchOffset str num\r\n    delOffset = matchOffset str del\r\n    select = and (== numOffset 0) prevIsDel\r\n      \\del num first . num\r\n      == delOffset 0\r\n        \\del num first . del\r\n        \\del num first . first\r\n    first = select (head del) (head num) (strSubstring str 0 delOffset)\r\n    .\r\n    cons\r\n      first\r\n      basicSplitTokens\r\n        strSubstring str (strLen first) 0\r\n        pat\r\n        select true false false")(lazy((function(L_str, L_pat, L_prevIsDel, more) {
  return (Leisure_shouldDispatch(L_prevIsDel, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_$p$p)(L_str)("")(L_nil)(function(){return(function(){
  ...
  L_select_4 = function(){return resolve(L_and)(function(){return resolve(L_$p$p)(L_numOffset_2)(0)}, L_prevIsDel)(lazy(function(L_del_4){return function(L_num_5){return function(L_first_6){return resolve(L_num_5)}}}))(function(){return resolve(L_$p$p)(L_delOffset_3)(0)(lazy(function(L_del_4){return function(L_num_5){return function(L_first_6){return resolve(L_del_4)}}}))(lazy(function(L_del_4){return function(L_num_5){return function(L_first_6){return resolve(L_first_6)}}}))})};
 ...
 function(){return resolve(L_newDefine)("tokens")(2)("tokens str pat = countedTokens emptyLineStarts str pat")(lazy((function(L_str, L_pat, more) {
  return (Leisure_shouldDispatch(L_pat, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_countedTokens)(L_emptyLineStarts, L_str, L_pat);
 })))},
 function(){return resolve(L_newDefine)("countedTokens")(3)("countedTokens lineStarts str pat = makeTokens lineStarts (splitTokens str pat) 0")(lazy((function(L_lineStarts, L_str, L_pat, more) {
  return (Leisure_shouldDispatch(L_pat, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_makeTokens)(L_lineStarts, function(){return resolve(L_splitTokens)(L_str, L_pat)}, 0);
 })))},
 function(){return resolve(L_newDefine)("isTokenString")(2)("isTokenString tok str = or\r\n  and (isToken tok) (eq (tokenString tok) str)\r\n  and (isString tok) (eq tok str)")(lazy((function(L_tok, L_str, more) {
  return (Leisure_shouldDispatch(L_str, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_or)(function(){return resolve(L_and)(function(){return resolve(L_isToken)(L_tok)}, function(){return resolve(L_eq)(function(){return resolve(L_tokenString)(L_tok)})(L_str)})}, function(){return resolve(L_and)(function(){return resolve(L_isString)(L_tok)}, function(){return resolve(L_eq)(L_tok)(L_str)})});
 })))},
 function(){return resolve(L_newDefine)("isTokenStart")(2)("isTokenStart tok str = or\r\n  and (isToken tok) (strStartsWith (tokenString tok) str)\r\n  and (isString tok) (strStartsWith tok str)")(lazy((function(L_tok, L_str, more) {
  return (Leisure_shouldDispatch(L_str, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_or)(function(){return resolve(L_and)(function(){return resolve(L_isToken)(L_tok)}, function(){return resolve(L_strStartsWith)(function(){return resolve(L_tokenString)(L_tok)}, L_str)})}, function(){return resolve(L_and)(function(){return resolve(L_isString)(L_tok)}, function(){return resolve(L_strStartsWith)(L_tok, L_str)})});
 })))},
 ...
 function(){return resolve(L_newDefine)("lit")(2)("lit value range = \\f . f value range")(lazy(setDataType((function(L_value, L_range, more) {
  return (Leisure_shouldDispatch(L_range, more))
    ? Leisure_dispatch(arguments)
    : setType(function(L_f){return resolve(L_f)(L_value)(L_range)}, 'lit');
 }), 'lit')))},
 function(){return resolve(L_newDefine)("ref")(2)("ref name range = \\f . f name range")(lazy(setDataType((function(L_name, L_range, more) {
  return (Leisure_shouldDispatch(L_range, more))
    ? Leisure_dispatch(arguments)
    : setType(function(L_f){return resolve(L_f)(L_name)(L_range)}, 'ref');
 }), 'ref')))},
 function(){return resolve(L_newDefine)("lambda")(3)("lambda name body range = \\f . f name body range")(lazy(setDataType((function(L_name, L_body, L_range, more) {
  return (Leisure_shouldDispatch(L_range, more))
    ? Leisure_dispatch(arguments)
    : setType(function(L_f){return resolve(L_f)(L_name)(L_body)(L_range)}, 'lambda');
 }), 'lambda')))},
 function(){return resolve(L_newDefine)("apply")(2)("apply func arg = \\f . f func arg")(lazy(setDataType((function(L_func, L_arg, more) {
  return (Leisure_shouldDispatch(L_arg, more))
    ? Leisure_dispatch(arguments)
    : setType(function(L_f){return resolve(L_f)(L_func)(L_arg)}, 'apply');
 }), 'apply')))},
 function(){return resolve(L_newDefine)("let")(4)("let name value body range = \\f . f name value body range")(lazy(setDataType((function(L_name, L_value, L_body, L_range, more) {
  return (Leisure_shouldDispatch(L_range, more))
    ? Leisure_dispatch(arguments)
    : setType(function(L_f){return resolve(L_f)(L_name)(L_value)(L_body)(L_range)}, 'let');
 }), 'let')))},
 function(){return resolve(L_newDefine)("anno")(3)("anno name data body = \\f . f name data body")(lazy(setDataType((function(L_name, L_data, L_body, more) {
  return (Leisure_shouldDispatch(L_body, more))
    ? Leisure_dispatch(arguments)
    : setType(function(L_f){return resolve(L_f)(L_name)(L_data)(L_body)}, 'anno');
 }), 'anno')))},
 function(){return resolve(L_newDefine)("withParens")(3)("withParens p err cont = isParens p (p cont) err")(lazy((function(L_p, L_err, L_cont, more) {
  return (Leisure_shouldDispatch(L_cont, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isParens)(L_p)(function(){return resolve(L_p)(L_cont)})(L_err);
 })))},
 function(){return resolve(L_newDefine)("setParens")(2)("setParens p func = isParens p\r\n  p \\start end content . parens start end (func content)\r\n  func p")(lazy((function(L_p, L_func, more) {
  return (Leisure_shouldDispatch(L_func, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isParens)(L_p)(function(){return resolve(L_p)(lazy(function(L_start){return function(L_end){return function(L_content){return resolve(L_parens)(L_start, L_end, function(){return resolve(L_func)(L_content)})}}}))})(function(){return resolve(L_func)(L_p)});
 })))},
 function(){return resolve(L_newDefine)("withStripped")(2)("withStripped list cont = withParens list (cont list) \\start end content . withStripped content cont")(lazy((function(L_list, L_cont, more) {
  return (Leisure_shouldDispatch(L_cont, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_withParens)(L_list, function(){return resolve(L_cont)(L_list)}, lazy(function(L_start){return function(L_end){return function(L_content){return resolve(L_withStripped)(L_content, L_cont)}}}));
 })))},
 ...
 function(){return resolve(L_newDefine)("createAst")(3)("createAst lineStarts inList names = withStripped inList \\list .\r\n  isToken list (createLitOrRef list names)\r\n    list\r\n      \\h t D .\r\n        isTokenString h '\\\\\\\\' (createLet h t names)\r\n          isTokenString h '\\\\@' (createAnno h t names)\r\n            isTokenString h '\\\\' (createLambda h t names)\r\n              createApply list names\r\n      nil")(lazy((function(L_lineStarts, L_inList, L_names, more) {
  return (Leisure_shouldDispatch(L_names, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_withStripped)(L_inList, lazy(function(L_list){return resolve(L_isToken)(L_list)(function(){return resolve(L_createLitOrRef)(L_list, L_names)})(function(){return resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isTokenString)(L_h, "\\\\")(function(){return resolve(L_createLet)(L_h, L_t, L_names)})(function(){return resolve(L_isTokenString)(L_h, "\\@")(function(){return resolve(L_createAnno)(L_h, L_t, L_names)})(function(){return resolve(L_isTokenString)(L_h, "\\")(function(){return resolve(L_createLambda)(L_h, L_t, L_names)})(function(){return resolve(L_createApply)(L_list, L_names)})})})}}}))(L_nil)})}));
 })))},
 function(){return resolve(L_newDefine)("strMatches")(2)("strMatches str pat = isCons (strMatch str pat)")(lazy((function(L_str, L_pat, more) {
  return (Leisure_shouldDispatch(L_pat, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isCons)(function(){return resolve(L_strMatch)(L_str, L_pat)});
 })))},
 ...
 function(){return resolve(L_newDefine)("convertStringEscape")(3)("convertStringEscape char codes values =\r\n  eq codes ''\r\n    char\r\n    eq char (strAt codes 0)\r\n      strAt values 0\r\n      convertStringEscape char (strSubstring codes 1 0) (strSubstring values 1 0)")(lazy((function(L_char, L_codes, L_values, more) {
  return (Leisure_shouldDispatch(L_values, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("createAnno")(3)("createAnno start list names =\r\n  withCons list (parseErr \"No annotation name or data in annotation \" (loc start)) \\name rest .\r\n    withCons rest (parseErr \"No data for annotation \" (loc start)) \\data rest . \\\\\r\n      finish data body = ifNotErr (createAst nil body names) \\bodyAst .\r\n        cleanTokens start name \\name .\r\n          cleanTokens start data \\data .\r\n            anno name data bodyAst\r\n      .\r\n      isTokenString data '.'\r\n        finish nil rest\r\n        withStripped data \\data .\r\n          withCons rest (parseErr \"No body for annotation \" (loc start)) \\dot body .\r\n            isTokenString dot '.'\r\n              finish data body\r\n              parseErr \"Annotation expects dot after name and data \" (loc start)")(lazy((function(L_start, L_list, L_names, more) {
  return (Leisure_shouldDispatch(L_names, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_withCons)(L_list, function(){return resolve(L_parseErr)("No annotation name or data in annotation ", function(){return resolve(L_loc)(L_start)})}, lazy(function(L_name){return function(L_rest){return resolve(L_withCons)(L_rest, function(){return resolve(L_parseErr)("No data for annotation ", function(){return resolve(L_loc)(L_start)})}, lazy(function(L_data){return function(L_rest_0){return (function(){
  var L_finish_1;
 ...
 function(){return resolve(L_newDefine)("parseLineG")(6)("parseLineG str pat names groups onDef onExpr = \\\\\r\n  astCallback cb = \\list . ifNotErr (createAst nil list names) \\ast . cb ast\r\n  .\r\n  scanLineG str pat groups (astCallback onDef) (astCallback onExpr)")(lazy((function(L_str, L_pat, L_names, L_groups, L_onDef, L_onExpr, more) {
  return (Leisure_shouldDispatch(L_onExpr, more))
    ? Leisure_dispatch(arguments)
    : (function(){
  var L_astCallback_0;
  L_astCallback_0 = function(){return function(L_cb){return function(L_list){return resolve(L_ifNotErr)(function(){return resolve(L_createAst)(L_nil, L_list, L_names)}, lazy(function(L_ast){return resolve(L_cb)(L_ast)}))}}};
 ...
 function(){return resolve(L_newDefine)("setDataTypeAnno")(2)("setDataTypeAnno toks name = \\\\\r\n  tok = \\str . token str (position toks)\r\n  .\r\n  cons (tok '\\\\@') (cons (tok 'dataType') (cons (tok (tokenString name)) (cons (tok '.') toks)))")(lazy((function(L_toks, L_name, more) {
  return (Leisure_shouldDispatch(L_name, more))
    ? Leisure_dispatch(arguments)
    : (function(){
  var L_tok_0;
 ...
 function(){return resolve(L_newDefine)("spliceFuncProps")(3)("spliceFuncProps arity props ast = or (isNil props) (== arity 0)\r\n  ast\r\n  subSpliceFuncProps props ast")(lazy((function(L_arity, L_props, L_ast, more) {
  return (Leisure_shouldDispatch(L_ast, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_or)(function(){return resolve(L_isNil)(L_props)}, function(){return resolve(L_$p$p)(L_arity)(0)})(L_ast)(function(){return resolve(L_subSpliceFuncProps)(L_props, L_ast)});
 })))},
 function(){return resolve(L_newDefine)("subSpliceFuncProps")(2)("subSpliceFuncProps props ast = \\\\\r\n  slash = head ast\r\n  var = head (tail ast)\r\n  afterVar = tail (tail ast)\r\n  dot = head afterVar\r\n  body = tail afterVar\r\n  .\r\n  isTokenString slash '\\\\'\r\n    cons\r\n      slash\r\n      cons\r\n        var\r\n        isTokenString dot '.'\r\n          cons dot (addProps props body)\r\n          cons '.' (addProps props afterVar)\r\n    cons\r\n      head ast\r\n      subSpliceFuncProps props (tail ast)")(lazy((function(L_props, L_ast, more) {
  return (Leisure_shouldDispatch(L_ast, more))
    ? Leisure_dispatch(arguments)
    : (function(){
 ...
 function(){return resolve(L_newDefine)("addProps")(2)("addProps props ast = foldr\r\n  \\prop result . cons '\\\\@' (cons (head prop) (cons (tail prop) (cons '.' result)))\r\n  ast\r\n  props")(lazy((function(L_props, L_ast, more) {
  return (Leisure_shouldDispatch(L_ast, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_foldr)(lazy(function(L_prop){return function(L_result){return resolve(L_cons)("\\@", function(){return resolve(L_cons)(function(){return resolve(L_head)(L_prop)}, function(){return resolve(L_cons)(function(){return resolve(L_tail)(L_prop)}, function(){return resolve(L_cons)(".", L_result)})})})}}), L_ast, L_props);
 })))},
 function(){return resolve(L_newDefine)("checkSetDataType")(3)("checkSetDataType toks curToks name = withCons curToks toks \\h t .\r\n  isTokenString h '='\r\n    isTokenString (head t) '\\\\'\r\n      setDataTypeAnno toks name\r\n      toks\r\n    checkSetDataType toks t name")(lazy((function(L_toks, L_curToks, L_name, more) {
  return (Leisure_shouldDispatch(L_name, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_withCons)(L_curToks, L_toks, lazy(function(L_h){return function(L_t){return resolve(L_isTokenString)(L_h, "=")(function(){return resolve(L_isTokenString)(function(){return resolve(L_head)(L_t)}, "\\")(function(){return resolve(L_setDataTypeAnno)(L_toks, L_name)})(L_toks)})(function(){return resolve(L_checkSetDataType)(L_toks, L_t, L_name)})}}));
 })))},
 function(){return resolve(L_newDefine)("arity")(2)("arity toks n = isTokenString (head toks) '=' n (arity (tail toks) (+ n 1))")(lazy((function(L_toks, L_n, more) {
  return (Leisure_shouldDispatch(L_n, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isTokenString)(function(){return resolve(L_head)(L_toks)}, "=")(L_n)(function(){return resolve(L_arity)(function(){return resolve(L_tail)(L_toks)}, function(){return resolve(L_$o)(L_n)(1)})});
 })))},
 ...
 function(){return resolve(L_newDefine)("runParseFilters")(2)("runParseFilters filters line = filters\r\n  \\h t D . bind (h line) \\filtered . runParseFilters t filtered\r\n  fakereturn line\r\n  #return line\r\n  #defer line")(lazy((function(L_filters, L_line, more) {
  return (Leisure_shouldDispatch(L_line, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_filters)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_bind)(function(){return resolve(L_h)(L_line)})(lazy(function(L_filtered){return resolve(L_runParseFilters)(L_t, L_filtered)}))}}}))(function(){return resolve(L_fakereturn)(L_line)});
 })))},
 ...
 function(){return resolve(L_newDefine)("macroSub")(2)("macroSub macs expr = postProcessMacro (emptyFor expr) (emptyFor expr) (baseMacroSub macs expr)")(lazy((function(L_macs, L_expr, more) {
  return (Leisure_shouldDispatch(L_expr, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_postProcessMacro)(function(){return resolve(L_emptyFor)(L_expr)}, function(){return resolve(L_emptyFor)(L_expr)}, function(){return resolve(L_baseMacroSub)(L_macs, L_expr)});
 })))},
 ...
 function(){return resolve(L_newDefine)("baseMacroSub")(2)("baseMacroSub macs expr = isToken expr\r\n  expr\r\n  isParens expr\r\n    expr \\start end content . \\\\\r\n      result = baseMacroSub macs content\r\n      .\r\n      isToken result result (parens start end result)\r\n    withCons expr expr \\h t .\r\n      isBlockStart h\r\n        cons h\r\n          isTokenString h '\\\\\\\\'\r\n            macroSubLet macs t\r\n            macroSubBody '.' macs t\r\n        withToken h\r\n          \\\\\r\n            subH = baseMacroSub macs h\r\n            .\r\n            withToken subH\r\n              cons subH (map (baseMacroSub macs) t)\r\n              \\tok pos . baseMacroSub macs (cons subH t)\r\n          \\tok pos . assoc tok macs\r\n            \\def . baseMacroSub macs (def t)\r\n            cons h (map (baseMacroSub macs) t)")(lazy((function(L_macs, L_expr, more) {
  return (Leisure_shouldDispatch(L_expr, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isToken)(L_expr)(L_expr)(function(){return resolve(L_isParens)(L_expr)(function(){return resolve(L_expr)(lazy(function(L_start){return function(L_end){return function(L_content){return (function(){
  var L_result_0;
  L_result_0 = function(){return resolve(L_baseMacroSub)(L_macs, L_content)};

  return resolve(L_isToken)(L_result_0)(L_result_0)(function(){return resolve(L_parens)(L_start, L_end, L_result_0)})})()}}}))})(function(){return resolve(L_withCons)(L_expr, L_expr, lazy(function(L_h){return function(L_t){return resolve(L_isBlockStart)(L_h)(function(){return resolve(L_cons)(L_h, function(){return resolve(L_isTokenString)(L_h, "\\\\")(function(){return resolve(L_macroSubLet)(L_macs, L_t)})(function(){return resolve(L_macroSubBody)(".", L_macs, L_t)})})})(function(){return resolve(L_withToken)(L_h, function(){return(function(){
  var L_subH_0;
  L_subH_0 = function(){return resolve(L_baseMacroSub)(L_macs, L_h)};

  return resolve(L_withToken)(L_subH_0, function(){return resolve(L_cons)(L_subH_0, function(){return resolve(L_map)(function(){return resolve(L_baseMacroSub)(L_macs)}, L_t)})}, lazy(function(L_tok){return function(L_pos){return resolve(L_baseMacroSub)(L_macs, function(){return resolve(L_cons)(L_subH_0, L_t)})}}))})();}, lazy(function(L_tok){return function(L_pos){return resolve(L_assoc)(L_tok, L_macs)(lazy(function(L_def){return resolve(L_baseMacroSub)(L_macs, function(){return resolve(L_def)(L_t)})}))(function(){return resolve(L_cons)(L_h, function(){return resolve(L_map)(function(){return resolve(L_baseMacroSub)(L_macs)}, L_t)})})}}))})}}))})});
 })))},
 function(){return resolve(L_newDefine)("macroSubLet")(2)("macroSubLet macs list = list\r\n  \\h t D . isTokenString h '.'\r\n    cons h (baseMacroSub macs t)\r\n    cons (setParens h \\content . macroSubBody '=' macs content) (macroSubLet macs t)\r\n  # Don't bother with parse errors at this point -- ast generator will detect them\r\n  nil")(lazy((function(L_macs, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isTokenString)(L_h, ".")(function(){return resolve(L_cons)(L_h, function(){return resolve(L_baseMacroSub)(L_macs, L_t)})})(function(){return resolve(L_cons)(function(){return resolve(L_setParens)(L_h, lazy(function(L_content){return resolve(L_macroSubBody)("=", L_macs, L_content)}))}, function(){return resolve(L_macroSubLet)(L_macs, L_t)})})}}}))(L_nil);
 })))},
 function(){return resolve(L_newDefine)("macroSubBody")(3)("macroSubBody char macs list = list\r\n  \\h t D . cons h\r\n    isTokenString h char baseMacroSub (macroSubBody char)\r\n      macs\r\n      t\r\n  nil")(lazy((function(L_char, L_macs, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_cons)(L_h, function(){return resolve(L_isTokenString)(L_h, L_char)(L_baseMacroSub)(function(){return resolve(L_macroSubBody)(L_char)})(L_macs)(L_t)})}}}))(L_nil);
 })))},
 function(){return resolve(L_newDefine)("postProcessMacro")(3)("postProcessMacro before after expr = isString expr\r\n  token expr (isEmptyPos after before after)\r\n  isParens expr\r\n    expr \\start end contents . parens start end (postProcessMacro start end contents)\r\n    isCons expr\r\n      expr \\h t .\r\n        isToken h\r\n          cons h (postProcessMacro (addFilepos (addFilepos (tokenFilepos h) (strLen (tokenString h))) 1) (emptyFor h) t)\r\n          \\\\\r\n            posStart = position h\r\n            posEnd = position t\r\n            t2 = postProcessMacro (emptyFor posStart) after t\r\n            h2 = postProcessMacro before (emptyFor posStart) h\r\n            .\r\n            isEmptyPos posStart\r\n              cons (postProcessMacro before (position t2) h) t2\r\n              cons h2 (postProcessMacro (addFilepos (lexEnd h2) 1) after t)\r\n      isNumber expr\r\n        token (strString expr) (isEmptyPos after before after)\r\n        expr")(lazy((function(L_before, L_after, L_expr, more) {
  return (Leisure_shouldDispatch(L_expr, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isString)(L_expr)(function(){return resolve(L_token)(L_expr, function(){return resolve(L_isEmptyPos)(L_after)(L_before)(L_after)})})(function(){return resolve(L_isParens)(L_expr)(function(){return resolve(L_expr)(lazy(function(L_start){return function(L_end){return function(L_contents){return resolve(L_parens)(L_start, L_end, function(){return resolve(L_postProcessMacro)(L_start, L_end, L_contents)})}}}))})(function(){return resolve(L_isCons)(L_expr)(function(){return resolve(L_expr)(lazy(function(L_h){return function(L_t){return resolve(L_isToken)(L_h)(function(){return resolve(L_cons)(L_h, function(){return resolve(L_postProcessMacro)(function(){return resolve(L_addFilepos)(function(){return resolve(L_addFilepos)(function(){return resolve(L_tokenFilepos)(L_h)}, function(){return resolve(L_strLen)(function(){return resolve(L_tokenString)(L_h)})})}, 1)}, function(){return resolve(L_emptyFor)(L_h)}, L_t)})})(function(){return(function(){
 ...
 function(){return resolve(L_newDefine)("defMacro")(2)("defMacro name def = bind (getValue 'macroDefs') \\macs . setValue 'macroDefs' (acons name def macs)")(lazy((function(L_name, L_def, more) {
  return (Leisure_shouldDispatch(L_def, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_newDefine)("addToken")(1)("addToken del = bind (getValue 'tokenList')\r\n  \\dels . contains dels del\r\n    false\r\n    \\\\\r\n      newDels = insertSorted (\\a b . > (strLen a) (strLen b)) del dels\r\n      .\r\n      bind (setValue 'tokenList' newDels)\r\n        \\_ . computeTokenPat newDels")(lazy(function(L_del){return resolve(L_bind)(function(){return resolve(L_getValue)("tokenList")})(lazy(function(L_dels){return resolve(L_contains)(L_dels, L_del)(L_false)(function(){return(function(){
  var L_newDels_0;
  L_newDels_0 = function(){return resolve(L_insertSorted)(lazy(function(L_a){return function(L_b){return resolve(L_$z)(function(){return resolve(L_strLen)(L_a)})(function(){return resolve(L_strLen)(L_b)})}}), L_del, L_dels)};
 ...
 function(){return resolve(L_newDefine)("parseToAst")(2)("parseToAst str pat = createAst nil (testParse str pat) nil")(lazy((function(L_str, L_pat, more) {
  return (Leisure_shouldDispatch(L_pat, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_createAst)(L_nil, function(){return resolve(L_testParse)(L_str, L_pat)}, L_nil);
 })))},
 function(){return resolve(L_newDefine)("parseM")(1)("parseM str =\r\n  bind2 (getValue 'tokenPat')\r\n    \\tokPat . bind2 (getValue 'tokenGroups')\r\n      \\groups . defer\r\n        parseG str tokPat groups")(lazy(function(L_str){return resolve(L_bind2)(function(){return resolve(L_getValue)("tokenPat")})(lazy(function(L_tokPat){return resolve(L_bind2)(function(){return resolve(L_getValue)("tokenGroups")})(lazy(function(L_groups){return resolve(L_defer)(function(){return resolve(L_parseG)(L_str, L_tokPat, L_groups)})}))}))}))},
 function(){return resolve(L_newDefine)("scanLine")(4)("scanLine str pat onDef onExpr = scanLineG str pat parenGroups onDef onExpr")(lazy((function(L_str, L_pat, L_onDef, L_onExpr, more) {
  return (Leisure_shouldDispatch(L_onExpr, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_scanLineG)(L_str, L_pat, L_parenGroups, L_onDef, L_onExpr);
 })))},
 function(){return resolve(L_newDefine)("parseLine")(5)("parseLine str pat names onDef onExpr = parseLineG str pat names parenGroups onDef onExpr")(lazy((function(L_str, L_pat, L_names, L_onDef, L_onExpr, more) {
  return (Leisure_shouldDispatch(L_onExpr, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_parseLineG)(L_str, L_pat, L_names, L_parenGroups, L_onDef, L_onExpr);
 })))},
 function(){return resolve(L_newDefine)("parseLineM")(1)("parseLineM str = bind2 (getValue 'tokenPat')\r\n  \\tokPat . bind2 (getValue 'tokenGroups')\r\n    \\groups . defer\r\n      parseLineG str tokPat nil groups id id")(lazy(function(L_str){return resolve(L_bind2)(function(){return resolve(L_getValue)("tokenPat")})(lazy(function(L_tokPat){return resolve(L_bind2)(function(){return resolve(L_getValue)("tokenGroups")})(lazy(function(L_groups){return resolve(L_defer)(function(){return resolve(L_parseLineG)(L_str, L_tokPat, L_nil, L_groups, L_id, L_id)})}))}))}))},
 function(){return resolve(L_newDefine)("macroSubM")(1)("macroSubM expr =\r\n  bind2 (getValue 'macroDefs')\r\n    \\macs . defer\r\n      macroSub macs expr")(lazy(function(L_expr){return resolve(L_bind2)(function(){return resolve(L_getValue)("macroDefs")})(lazy(function(L_macs){return resolve(L_defer)(function(){return resolve(L_macroSub)(L_macs, L_expr)})}))}))},
 function(){return resolve(L_newDefine)("macroParse")(1)("macroParse str =\r\n  bind2 (parseM str)\r\n    \\ex . macroSubM ex")(lazy(function(L_str){return resolve(L_bind2)(function(){return resolve(L_parseM)(L_str)})(lazy(function(L_ex){return resolve(L_macroSubM)(L_ex)}))}))},
 function(){return resolve(L_newDefine)("tokensM")(1)("tokensM str =\r\n  bind2 (getValue 'tokenPat')\r\n    \\delimiterPat . defer\r\n      tokens str delimiterPat")(lazy(function(L_str){return resolve(L_bind2)(function(){return resolve(L_getValue)("tokenPat")})(lazy(function(L_delimiterPat){return resolve(L_defer)(function(){return resolve(L_tokens)(L_str, L_delimiterPat)})}))}))},
 function(){return resolve(L_newDefine)("parseLines")(2)("parseLines lines result = lines\r\n  \\h t D . bind2 (parseLineM h)\r\n    \\ast . parseLines t (cons ast result)\r\n  defer\r\n    reverse result")(lazy((function(L_lines, L_result, more) {
  return (Leisure_shouldDispatch(L_result, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_lines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_bind2)(function(){return resolve(L_parseLineM)(L_h)})(lazy(function(L_ast){return resolve(L_parseLines)(L_t, function(){return resolve(L_cons)(L_ast, L_result)})}))}}}))(function(){return resolve(L_defer)(function(){return resolve(L_reverse)(L_result)})});
 })))},
 ...
 function(){return resolve(L_newDefine)("simpleScanLine")(1)("simpleScanLine line = bind2 (getValue 'tokenPat')\r\n  \\tokenPat . bind2 (getValue 'tokenGroups')\r\n    \\groups . defer\r\n      scanLineG line tokenPat groups id id")(lazy(function(L_line){return resolve(L_bind2)(function(){return resolve(L_getValue)("tokenPat")})(lazy(function(L_tokenPat){return resolve(L_bind2)(function(){return resolve(L_getValue)("tokenGroups")})(lazy(function(L_groups){return resolve(L_defer)(function(){return resolve(L_scanLineG)(L_line, L_tokenPat, L_groups, L_id, L_id)})}))}))}))},
 ...
 function(){return resolve(L_newDefine)("newParseLine")(3)("newParseLine offset names line = bind2 (scanLineM line)\r\n  \\scanned . ifNotErr (createAst (cons \"NEWPARSE.lsr\" (findLines offset line)) scanned names) \\ast . defer ast")(lazy((function(L_offset, L_names, L_line, more) {
  return (Leisure_shouldDispatch(L_line, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_bind2)(function(){return resolve(L_scanLineM)(L_line)})(lazy(function(L_scanned){return resolve(L_ifNotErr)(function(){return resolve(L_createAst)(function(){return resolve(L_cons)("NEWPARSE.lsr", function(){return resolve(L_findLines)(L_offset, L_line)})}, L_scanned, L_names)}, lazy(function(L_ast){return resolve(L_defer)(L_ast)}))}));
 })))},
 function(){return resolve(L_newDefine)("countedParseLine")(2)("countedParseLine names countedLine = bind2 (countedScanLineM (head countedLine) (tail countedLine))\r\n  \\scanned . defer (createAst (head countedLine) scanned names)")(lazy((function(L_names, L_countedLine, more) {
  return (Leisure_shouldDispatch(L_countedLine, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_bind2)(function(){return resolve(L_countedScanLineM)(function(){return resolve(L_head)(L_countedLine)}, function(){return resolve(L_tail)(L_countedLine)})})(lazy(function(L_scanned){return resolve(L_defer)(function(){return resolve(L_createAst)(function(){return resolve(L_head)(L_countedLine)}, L_scanned, L_names)})}));
 })))},
 function(){return resolve(L_newDefine)("runLine")(3)("runLine offset names line = bind2 (newParseLine offset names line)\r\n  \\ast . bind2 (runAst line ast)\r\n    \\result . defer\r\n      cons\r\n        ast\r\n        isErr result\r\n          left (errMsg result)\r\n          right result")(lazy((function(L_offset, L_names, L_line, more) {
  return (Leisure_shouldDispatch(L_line, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_bind2)(function(){return resolve(L_newParseLine)(L_offset, L_names, L_line)})(lazy(function(L_ast){return resolve(L_bind2)(function(){return resolve(L_runAst)(L_line)(L_ast)})(lazy(function(L_result){return resolve(L_defer)(function(){return resolve(L_cons)(L_ast, function(){return resolve(L_isErr)(L_result)(function(){return resolve(L_left)(function(){return resolve(L_errMsg)(L_result)})})(function(){return resolve(L_right)(L_result)})})})}))}));
 })))},
 function(){return resolve(L_newDefine)("countedRunLine")(3)("countedRunLine file names countedLine = bind2 (countedParseLine names countedLine)\r\n  \\ast . \\\\\r\n    wrapped = astFileWrap file ast\r\n    value = runAst (tail countedLine) wrapped\r\n    .\r\n    not (== (getType value) 'monad')\r\n      resultOfRun wrapped value\r\n      bind2 (runAst (tail countedLine) wrapped)\r\n        \\result . resultOfRun wrapped result")(lazy((function(L_file, L_names, L_countedLine, more) {
  return (Leisure_shouldDispatch(L_countedLine, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_bind2)(function(){return resolve(L_countedParseLine)(L_names, L_countedLine)})(lazy(function(L_ast){return (function(){
  ...
  return resolve(L_not)(function(){return resolve(L_$p$p)(function(){return resolve(L_getType)(L_value_1)})("monad")})(function(){return resolve(L_resultOfRun)(L_wrapped_0, L_value_1)})(function(){return resolve(L_bind2)(function(){return resolve(L_runAst)(function(){return resolve(L_tail)(L_countedLine)})(L_wrapped_0)})(lazy(function(L_result){return resolve(L_resultOfRun)(L_wrapped_0, L_result)}))})})()}));
 })))},
 function(){return resolve(L_newDefine)("resultOfRun")(2)("resultOfRun wrapped result =\r\n  defer\r\n    cons\r\n      wrapped\r\n      isErr result\r\n        left (errMsg result)\r\n        right result")(lazy((function(L_wrapped, L_result, more) {
  return (Leisure_shouldDispatch(L_result, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_defer)(function(){return resolve(L_cons)(L_wrapped, function(){return resolve(L_isErr)(L_result)(function(){return resolve(L_left)(function(){return resolve(L_errMsg)(L_result)})})(function(){return resolve(L_right)(L_result)})})});
 })))},
 function(){return resolve(L_newDefine)("astFileWrap")(2)("astFileWrap file ast = anno 'filename' (basename file) ast")(lazy((function(L_file, L_ast, more) {
  return (Leisure_shouldDispatch(L_ast, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_anno)("filename", function(){return resolve(L_basename)(L_file)}, L_ast);
 })))},
 ...
 function(){return resolve(L_newDefine)("runLines")(2)("runLines names lines = lines\r\n  \\h t D . bind2 (runLine 0 names h)\r\n    \\line . bind2 (runLines names t)\r\n      \\rest . defer\r\n        cons line rest\r\n  nil")(lazy((function(L_names, L_lines, more) {
  return (Leisure_shouldDispatch(L_lines, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_lines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_bind2)(function(){return resolve(L_runLine)(0, L_names, L_h)})(lazy(function(L_line){return resolve(L_bind2)(function(){return resolve(L_runLines)(L_names, L_t)})(lazy(function(L_rest){return resolve(L_defer)(function(){return resolve(L_cons)(L_line, L_rest)})}))}))}}}))(L_nil);
 })))},
 function(){return resolve(L_newDefine)("countedRunLines")(3)("countedRunLines file names countedLines = countedLines\r\n  \\h t D . bind2 (countedRunLine file names h)\r\n    \\line . bind2 (countedRunLines file names t)\r\n      \\rest . defer\r\n        cons line rest\r\n  nil")(lazy((function(L_file, L_names, L_countedLines, more) {
  return (Leisure_shouldDispatch(L_countedLines, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_countedLines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_bind2)(function(){return resolve(L_countedRunLine)(L_file, L_names, L_h)})(lazy(function(L_line){return resolve(L_bind2)(function(){return resolve(L_countedRunLines)(L_file, L_names, L_t)})(lazy(function(L_rest){return resolve(L_defer)(function(){return resolve(L_cons)(L_line, L_rest)})}))}))}}}))(L_nil);
 })))},
 ...
 function(){return resolve(L_newDefine)("baseLoad")(1)("baseLoad file = bind2 (readFile file)\r\n  \\result . result\r\n    \\err . defer err\r\n    \\contents . baseLoadString file contents")(lazy(function(L_file){return resolve(L_bind2)(function(){return resolve(L_readFile)(L_file)})(lazy(function(L_result){return resolve(L_result)(lazy(function(L_err){return resolve(L_defer)(L_err)}))(lazy(function(L_contents){return resolve(L_baseLoadString)(L_file, L_contents)}))}))}))},
 function(){return resolve(L_newDefine)("baseLoadString")(2)("baseLoadString file contents = bind2 (getValue 'activeTokenPacks')\r\n  \\activePacks . bind2 resetStdTokenPacks\r\n    \\_ . bind2 resetNameSpaceInfo\r\n      \\nsInfo . bind2 (runNamedFile file contents)\r\n        \\result . bind2 (setNameSpaceInfo nsInfo)\r\n          \\_ . isNil activePacks\r\n            bind2 resetStdTokenPacks \\_ . defer result\r\n            bind2 (resetTokenPacks activePacks) \\_ . defer result")(lazy((function(L_file, L_contents, more) {
  return (Leisure_shouldDispatch(L_contents, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_bind2)(function(){return resolve(L_getValue)("activeTokenPacks")})(lazy(function(L_activePacks){return resolve(L_bind2)(L_resetStdTokenPacks)(lazy(function(L__){return resolve(L_bind2)(L_resetNameSpaceInfo)(lazy(function(L_nsInfo){return resolve(L_bind2)(function(){return resolve(L_runNamedFile)(L_file, L_contents)})(lazy(function(L_result){return resolve(L_bind2)(function(){return resolve(L_setNameSpaceInfo)(L_nsInfo)})(lazy(function(L___0){return resolve(L_isNil)(L_activePacks)(function(){return resolve(L_bind2)(L_resetStdTokenPacks)(lazy(function(L___1){return resolve(L_defer)(L_result)}))})(function(){return resolve(L_bind2)(function(){return resolve(L_resetTokenPacks)(L_activePacks)})(lazy(function(L___1){return resolve(L_defer)(L_result)}))})}))}))}))}))}));
 })))},
 function(){return resolve(L_newDefine)("load")(1)("load file = bind2 (baseLoad file)\r\n  \\result . \\\\\r\n    errs = foldr (\\line results . tail line (\\er . cons er results) (\\x . results)) nil result\r\n    .\r\n    defer\r\n      isNil errs\r\n        right true\r\n        left errs")(lazy(function(L_file){return resolve(L_bind2)(function(){return resolve(L_baseLoad)(L_file)})(lazy(function(L_result){return (function(){
  var L_errs_0;
  L_errs_0 = function(){return resolve(L_foldr)(lazy(function(L_line){return function(L_results){return resolve(L_tail)(L_line)(lazy(function(L_er){return resolve(L_cons)(L_er, L_results)}))(lazy(function(L_x){return resolve(L_results)}))}}), L_nil, L_result)};

  return resolve(L_defer)(function(){return resolve(L_isNil)(L_errs_0)(function(){return resolve(L_right)(L_true)})(function(){return resolve(L_left)(L_errs_0)})})})()}))}))},
 function(){return resolve(L_newDefine)("require")(1)("require file = bind2 (getValue 'requiredFiles')\r\n  \\files . contains files file\r\n    right false\r\n    bind2 (setValue 'requiredFiles' (cons file files))\r\n      \\_. bind2 (load file)\r\n        \\result . defer\r\n          result\r\n            \\x . left x\r\n            \\_ . right true")(lazy(function(L_file){return resolve(L_bind2)(function(){return resolve(L_getValue)("requiredFiles")})(lazy(function(L_files){return resolve(L_contains)(L_files, L_file)(function(){return resolve(L_right)(L_false)})(function(){return resolve(L_bind2)(function(){return resolve(L_setValue)("requiredFiles")(function(){return resolve(L_cons)(L_file, L_files)})})(lazy(function(L__){return resolve(L_bind2)(function(){return resolve(L_load)(L_file)})(lazy(function(L_result){return resolve(L_defer)(function(){return resolve(L_result)(lazy(function(L_x){return resolve(L_left)(L_x)}))(lazy(function(L___0){return resolve(L_right)(L_true)}))})}))}))})}))}))},
 function(){return resolve(L_newDefine)("scanFile")(1)("scanFile file = bind2 (readFile file)\r\n  \\result . result\r\n    \\err . err\r\n      \\_ . bind2 (runNamedFile file contents)\r\n        counted = countedLinesForFile name text\r\n        lines = map tail counted\r\n        names = namesForLines lines\r\n        .\r\n        countedScanLines name names counted")(lazy(function(L_file){return resolve(L_bind2)(function(){return resolve(L_readFile)(L_file)})(lazy(function(L_result){return resolve(L_result)(lazy(function(L_err){return resolve(L_err)(lazy(function(L__){return resolve(L_bind2)(function(){return resolve(L_runNamedFile)(L_file, L_contents)})(function(){return resolve(L_counted)(L_$p)(L_countedLinesForFile)(L_name)(L_text)})(function(){return resolve(L_lines)(L_$p)(L_map)(L_tail)(L_counted)})(function(){return resolve(L_names)(L_$p)(L_namesForLines)(L_lines)})(L_$B)(function(){return resolve(L_countedScanLines)(L_name, L_names, L_counted)})}))}))}))}))},
 function(){return resolve(L_newDefine)("countedScanLines")(3)("countedScanLines file names countedLines = countedLines\r\n  \\h t D . bind2 (countedScanLineM (head h) (tail h))\r\n    \\line . bind2 (countedScanLines file names t)\r\n      \\rest . defer\r\n        cons line rest\r\n  nil")(lazy((function(L_file, L_names, L_countedLines, more) {
  return (Leisure_shouldDispatch(L_countedLines, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_countedLines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_bind2)(function(){return resolve(L_countedScanLineM)(function(){return resolve(L_head)(L_h)}, function(){return resolve(L_tail)(L_h)})})(lazy(function(L_line){return resolve(L_bind2)(function(){return resolve(L_countedScanLines)(L_file, L_names, L_t)})(lazy(function(L_rest){return resolve(L_defer)(function(){return resolve(L_cons)(L_line, L_rest)})}))}))}}}))(L_nil);
 })))},
 function(){return resolve(L_newDefine)("defTokenPack")(2)("defTokenPack name pack = bind (getValue 'tokenPacks')\r\n  \\packs . setValue 'tokenPacks' (acons name pack packs)")(lazy((function(L_name, L_pack, more) {
  return (Leisure_shouldDispatch(L_pack, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_bind)(function(){return resolve(L_getValue)("tokenPacks")})(lazy(function(L_packs){return resolve(L_setValue)("tokenPacks")(function(){return resolve(L_acons)(L_name, L_pack, L_packs)})}));
 })))},
 function(){return resolve(L_newDefine)("useTokenPack")(1)("useTokenPack name = bind (getValue 'tokenPacks')\r\n  \\packs . bind (getValue 'tokenGroups')\r\n    \\groups . bind (getValue 'tokenList')\r\n      \\tokens . bind (getValue 'activeTokenPacks')\r\n        \\activePacks . bind (getValue 'parseFilters')\r\n          \\filters . assoc name packs\r\n            \\pack . \\\\\r\n              groupToks = foldl (\\value el . el \\h t . cons h (cons t value)) nil (head (tail pack))\r\n              newToks = mergeSort (\\a b . > (strLen a) (strLen b)) (append (head pack) (append groupToks tokens))\r\n              .\r\n              bind (setValue 'tokenList' newToks)\r\n                \\_ . bind (setValue 'tokenGroups' (appendAlist (head (tail pack)) groups))\r\n                  \\_ . bind (setValue 'parseFilters' (append filters (head (tail (tail pack)))))\r\n                    \\_ . bind (computeTokenPat newToks)\r\n                      \\_ . setValue 'activeTokenPacks' (cons name activePacks)\r\n            nil")(lazy(function(L_name){return resolve(L_bind)(function(){return resolve(L_getValue)("tokenPacks")})(lazy(function(L_packs){return resolve(L_bind)(function(){return resolve(L_getValue)("tokenGroups")})(lazy(function(L_groups){return resolve(L_bind)(function(){return resolve(L_getValue)("tokenList")})(lazy(function(L_tokens){return resolve(L_bind)(function(){return resolve(L_getValue)("activeTokenPacks")})(lazy(function(L_activePacks){return resolve(L_bind)(function(){return resolve(L_getValue)("parseFilters")})(lazy(function(L_filters){return resolve(L_assoc)(L_name, L_packs)(lazy(function(L_pack){return (function(){
  ...
  L_groupToks_0 = function(){return resolve(L_foldl)(lazy(function(L_value){return function(L_el){return resolve(L_el)(lazy(function(L_h){return function(L_t){return resolve(L_cons)(L_h, function(){return resolve(L_cons)(L_t, L_value)})}}))}}), L_nil, function(){return resolve(L_head)(function(){return resolve(L_tail)(L_pack)})})};
  L_newToks_1 = function(){return resolve(L_mergeSort)(lazy(function(L_a){return function(L_b){return resolve(L_$z)(function(){return resolve(L_strLen)(L_a)})(function(){return resolve(L_strLen)(L_b)})}}), function(){return resolve(L_append)(function(){return resolve(L_head)(L_pack)}, function(){return resolve(L_append)(L_groupToks_0, L_tokens)})})};
 ...
 function(){return resolve(L_newDefine)("d")(3)("d label value expr = log (strCat (cons label (cons value nil))) expr")(lazy((function(L_label, L_value, L_expr, more) {
  return (Leisure_shouldDispatch(L_expr, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_log)(function(){return resolve(L_strCat)(function(){return resolve(L_cons)(L_label, function(){return resolve(L_cons)(L_value, L_nil)})})})(L_expr);
 })))},
 function(){return resolve(L_newDefine)("dd")(2)("dd label arg = d label arg arg")(lazy((function(L_label, L_arg, more) {
  return (Leisure_shouldDispatch(L_arg, more))
    ? Leisure_dispatch(arguments)
 ...
 function(){return resolve(L_setNameSpace)("core")},
 function(){return resolve(L_newDefine)("doall")(0)("doall = foldr1 (\\el res . bind2 el \\_ . res)")(function(){return resolve(L_foldr1)(lazy(function(L_el){return function(L_res){return resolve(L_bind2)(L_el)(lazy(function(L__){return resolve(L_res)}))}}))})},
 function(){return resolve(L_newDefine)("aconsf")(3)("aconsf key value list = acons key value (aremove key list)")(lazy((function(L_key, L_value, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_acons)(L_key, L_value, function(){return resolve(L_aremove)(L_key, L_list)});
 })))},
 function(){return resolve(L_newDefine)("aremove")(2)("aremove key list = isNil list\n  nil\n  eq (head (head list)) key\n    aremove key (tail list)\n    aconsPair (head list) (aremove key (tail list))")(lazy((function(L_key, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isNil)(L_list)(L_nil)(function(){return resolve(L_eq)(function(){return resolve(L_head)(function(){return resolve(L_head)(L_list)})})(L_key)(function(){return resolve(L_aremove)(L_key, function(){return resolve(L_tail)(L_list)})})(function(){return resolve(L_aconsPair)(function(){return resolve(L_head)(L_list)}, function(){return resolve(L_aremove)(L_key, function(){return resolve(L_tail)(L_list)})})})});
 })))},
 function(){return resolve(L_addTokenGroup)("[", "]")},
 function(){return resolve(L_addToken)("|")},
 function(){return resolve(L_newDefine)("listifyOp")(2)("listifyOp op list = list\n  \\h t D . isTokenString h '|'\n    cons t nil\n    cons (cons op (cons h (listifyOp op t))) nil\n  cons 'nil' nil")(lazy((function(L_op, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isTokenString)(L_h, "|")(function(){return resolve(L_cons)(L_t, L_nil)})(function(){return resolve(L_cons)(function(){return resolve(L_cons)(L_op, function(){return resolve(L_cons)(L_h, function(){return resolve(L_listifyOp)(L_op, L_t)})})}, L_nil)})}}}))(function(){return resolve(L_cons)("nil", L_nil)});
 })))},
 ...
 function(){return resolve(L_newDefine)("filterApplies")(2)("filterApplies code func = isParens code\n  code \\start end contents . parens start end (filterApplies contents func)\n  isCons code\n    \\\\\n      filtered = filterApplyElements code func\n      .\n      and (isCons filtered) (isBlockStart (head filtered))\n        filtered\n        func filtered\n    code")(lazy((function(L_code, L_func, more) {
  return (Leisure_shouldDispatch(L_func, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isParens)(L_code)(function(){return resolve(L_code)(lazy(function(L_start){return function(L_end){return function(L_contents){return resolve(L_parens)(L_start, L_end, function(){return resolve(L_filterApplies)(L_contents, L_func)})}}}))})(function(){return resolve(L_isCons)(L_code)(function(){return(function(){
  var L_filtered_0;
 ...
 function(){return resolve(L_newDefine)("filterLetBinding")(2)("filterLetBinding code func = isParens code\n  setParens code \\contents . filterLetBinding contents func\n  isCons code\n    code \\h t . cons h\n      isTokenString h '='\n        filterApplies t func\n        filterLetBinding t func\n    code")(lazy((function(L_code, L_func, more) {
  return (Leisure_shouldDispatch(L_func, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_isParens)(L_code)(function(){return resolve(L_setParens)(L_code, lazy(function(L_contents){return resolve(L_filterLetBinding)(L_contents, L_func)}))})(function(){return resolve(L_isCons)(L_code)(function(){return resolve(L_code)(lazy(function(L_h){return function(L_t){return resolve(L_cons)(L_h, function(){return resolve(L_isTokenString)(L_h, "=")(function(){return resolve(L_filterApplies)(L_t, L_func)})(function(){return resolve(L_filterLetBinding)(L_t, L_func)})})}}))})(L_code)});
 })))},
 function(){return resolve(L_newDefine)("filterLambda")(2)("filterLambda code func = code \\h t . cons h\n  isTokenString h '.'\n    filterApplies t func\n    filterLambda t func")(lazy((function(L_code, L_func, more) {
  return (Leisure_shouldDispatch(L_func, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_code)(lazy(function(L_h){return function(L_t){return resolve(L_cons)(L_h, function(){return resolve(L_isTokenString)(L_h, ".")(function(){return resolve(L_filterApplies)(L_t, L_func)})(function(){return resolve(L_filterLambda)(L_t, L_func)})})}}));
 })))},
 ...
 function(){return resolve(L_newDefine)("hamtWithPair")(2)("hamtWithPair pair t = hamtWith (head pair) (tail pair) t")(lazy((function(L_pair, L_t, more) {
  return (Leisure_shouldDispatch(L_t, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_hamtWith)(function(){return resolve(L_head)(L_pair)})(function(){return resolve(L_tail)(L_pair)})(L_t);
 })))},
 ...
 function(){return resolve(L_newDefine)("listMacroFoldOp")(3)("listMacroFoldOp op emptyCase list = list \\h t . foldr\n    \\case result . [op case result]\n    emptyCase\n    h")(lazy((function(L_op, L_emptyCase, L_list, more) {
  return (Leisure_shouldDispatch(L_list, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return resolve(L_foldr)(lazy(function(L_case){return function(L_result){return resolve(L_cons)(L_op, function(){return resolve(L_cons)(L_case, function(){return resolve(L_cons)(L_result, L_nil)})})}}), L_emptyCase, L_h)}}));
 })))},
 ...
 function(){return resolve(L_newDefine)("isInfixArg")(2)("isInfixArg closes item = or[\n  isParens item\n  isCons item\n  and[\n    isToken item\n    not (contains closes (tokenString item))\n    not (isBlockStart item)]]")(lazy((function(L_closes, L_item, more) {
  return (Leisure_shouldDispatch(L_item, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_or)(function(){return resolve(L_isParens)(L_item)}, function(){return resolve(L_or)(function(){return resolve(L_isCons)(L_item)}, function(){return resolve(L_or)(function(){return resolve(L_and)(function(){return resolve(L_isToken)(L_item)}, function(){return resolve(L_and)(function(){return resolve(L_not)(function(){return resolve(L_contains)(L_closes, function(){return resolve(L_tokenString)(L_item)})})}, function(){return resolve(L_and)(function(){return resolve(L_not)(function(){return resolve(L_isBlockStart)(L_item)})}, L_true)})})}, L_false)})});
 })))},
 function(){return resolve(L_newDefine)("isInfix")(4)("isInfix opPrec head1 head2 len = and[\n  > len 1\n  > opPrec -1\n  isInfixArg nil head1]")(lazy((function(L_opPrec, L_head1, L_head2, L_len, more) {
  return (Leisure_shouldDispatch(L_len, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_and)(function(){return resolve(L_$z)(L_len)(1)}, function(){return resolve(L_and)(function(){return resolve(L_$z)(L_opPrec)(-1)}, function(){return resolve(L_and)(function(){return resolve(L_isInfixArg)(L_nil, L_head1)}, L_true)})});
 })))},
 function(){return resolve(L_newDefine)("getPrec")(2)("getPrec prec token = \\\\\n  str = tokenString token\n  .\n  isToken token\n    findIndex (\\level . contains level str) prec\n    -1")(lazy((function(L_prec, L_token, more) {
  return (Leisure_shouldDispatch(L_token, more))
    ? Leisure_dispatch(arguments)
    : (function(){
  var L_str_0;
 ...
 function(){return resolve(L_newDefine)("handleDo")(3)("handleDo list inLet cont = list\n  \\h t D . isNil t\n    cont (inLet ['.' h] [h])\n    doClause (stripParens h) h nil inLet \\newInLet chain .\n      handleDo t newInLet \\rest . cont (chain rest)\n  cont nil")(lazy((function(L_list, L_inLet, L_cont, more) {
  return (Leisure_shouldDispatch(L_cont, more))
    ? Leisure_dispatch(arguments)
    : resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isNil)(L_t)(function(){return resolve(L_cont)(function(){return resolve(L_inLet)(function(){return resolve(L_cons)(".", function(){return resolve(L_cons)(L_h, L_nil)})})(function(){return resolve(L_cons)(L_h, L_nil)})})})(function(){return resolve(L_doClause)(function(){return resolve(L_stripParens)(L_h)}, L_h, L_nil, L_inLet, lazy(function(L_newInLet){return function(L_chain){return resolve(L_handleDo)(L_t, L_newInLet, lazy(function(L_rest){return resolve(L_cont)(function(){return resolve(L_chain)(L_rest)})}))}}))})}}}))(function(){return resolve(L_cont)(L_nil)});
 })))},
 function(){return resolve(L_newDefine)("doClause")(5)("doClause steppingClause clause prefix inLet cont = \\\\\n  makeBind var monad = cont false \\rest . inLet (cons '.') id\n    ['bind2' monad ['\\\\' var '.' | rest]]\n  .\n  isCons steppingClause\n    steppingClause \\h t . isTokenString h '='\n      inLet\n        cont true \\rest . [clause | rest]\n        cont true \\rest . ['\\\\\\\\' clause | rest]\n      isTokenString h '<-'\n        isNil t\n          parseErr \"No monad in do-clause: \" clause\n          prefix\n            \\ph pt D . isNil pt\n              makeBind (isNil prefix '_' (head prefix)) t\n              parseErr \"More than one variable in do-clause: \" clause\n            makeBind '_' t\n        doClause t clause [h | prefix] inLet cont\n    makeBind '_' clause")(lazy((function(L_steppingClause, L_clause, L_prefix, L_inLet, L_cont, more) {
  return (Leisure_shouldDispatch(L_cont, more))
    ? Leisure_dispatch(arguments)
    : (function(){
  var L_makeBind_0;
  L_makeBind_0 = function(){return function(L_var){return function(L_monad){return resolve(L_cont)(L_false)(lazy(function(L_rest){return resolve(L_inLet)(function(){return resolve(L_cons)(".")})(L_id)(function(){return resolve(L_cons)("bind2", function(){return resolve(L_cons)(L_monad, function(){return resolve(L_cons)(function(){return resolve(L_cons)("\\", function(){return resolve(L_cons)(L_var, function(){return resolve(L_cons)(".", L_rest)})})}, L_nil)})})})}))}}};

  return resolve(L_isCons)(L_steppingClause)(function(){return resolve(L_steppingClause)(lazy(function(L_h){return function(L_t){return resolve(L_isTokenString)(L_h, "=")(function(){return resolve(L_inLet)(function(){return resolve(L_cont)(L_true)(lazy(function(L_rest){return resolve(L_cons)(L_clause, L_rest)}))})(function(){return resolve(L_cont)(L_true)(lazy(function(L_rest){return resolve(L_cons)("\\\\", function(){return resolve(L_cons)(L_clause, L_rest)})}))})})(function(){return resolve(L_isTokenString)(L_h, "<-")(function(){return resolve(L_isNil)(L_t)(function(){return resolve(L_parseErr)("No monad in do-clause: ", L_clause)})(function(){return resolve(L_prefix)(lazy(function(L_ph){return function(L_pt){return function(L_D){return resolve(L_isNil)(L_pt)(function(){return resolve(L_makeBind_0)(function(){return resolve(L_isNil)(L_prefix)("_")(function(){return resolve(L_head)(L_prefix)})})(L_t)})(function(){return resolve(L_parseErr)("More than one variable in do-clause: ", L_clause)})}}}))(function(){return resolve(L_makeBind_0)("_")(L_t)})})})(function(){return resolve(L_doClause)(L_t, L_clause, function(){return resolve(L_cons)(L_h, L_prefix)}, L_inLet, L_cont)})})}}))})(function(){return resolve(L_makeBind_0)("_")(L_clause)})})();
 })))},
