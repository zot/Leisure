module.exports = L_runMonads([
 ...
 function(){return resolve(L_advise)("bind2")("option")(2)(lazy(function(L_opt){return $F(arguments, function(L_cont){return resolve(L_or)(function(){return resolve(L_hasType)(L_opt)(L_some)}, function(){return resolve(L_hasType)(L_opt)(L_none)})(function(){return resolve(L_some)(function(){return resolve(L_opt)(lazy(function(L_value){return resolve(L_bindIOish)(function(){return resolve(L_cont)(L_value)}, lazy(function(L_res){return resolve(L_isOption)(L_res)(L_res)(function(){return resolve(L_some)(L_res)})}))}))(L_unit)})})(L_none)})}))},
 function(){return resolve(L_advise)("bind2")("either")(2)(lazy(function(L_either){return $F(arguments, function(L_cont){return resolve(L_isEither)(L_either)(function(){return resolve(L_some)(function(){return resolve(L_either)(lazy(function(L__){return resolve(L_unit)}))(lazy(function(L_value){return resolve(L_bindIOish)(function(){return resolve(L_cont)(L_value)}, lazy(function(L_res){return resolve(L_isEither)(L_res)(L_res)(function(){return resolve(L_right)(L_res)})}))}))})})(L_none)})}))},
 ...
 function(){return resolve(L_newDefine)("bindIOish")(2)("bindIOish m cont = bind2\n  or (hasType m \"*Monad2\") (hasType m 'monad')\n    m\n    wrap m\n  cont")(lazy((function () {
  var main;
  var full = function (L_m, L_cont) {
    return resolve(L_bind2)(function(){return resolve(L_or)(function(){return resolve(L_hasType)(L_m)("*Monad2")}, function(){return resolve(L_hasType)(L_m)("monad")})(L_m)(function(){return resolve(L_wrap)(L_m)})})(L_cont);
  };
