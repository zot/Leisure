module.exports = L_runMonads([
  ...
  var full = function (L_k, L_alist) {
    return resolve(L_alist)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_h)(lazy(function(L_key){return function(L_value){return resolve(L_eq)(L_key)(L_k)(L_value)(function(){return resolve(L_afetch)(L_k, L_t)})}}))}}}))(L_nil);
  };
 ...
 function(){return resolve(L_newDefine)("take")(2)("take n list = positive n\r\n  list\r\n    \\h t D . cons h (take (-- n) t)\r\n    nil\r\n  nil")(lazy((function () {
  ...
  var full = function (L_n, L_list) {
    return resolve(L_positive)(L_n)(function(){return resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_cons)(L_h, function(){return resolve(L_take)(function(){return resolve(L_$_$_)(L_n)}, L_t)})}}}))(L_nil)})(L_nil);
  };
 ...
 function(){return resolve(L_newDefine)("takeWhile")(2)("takeWhile predicate list = list\r\n  \\h t D . predicate (head list)\r\n    cons h (takeWhile predicate t)\r\n    nil\r\n  nil")(lazy((function () {
  ...
  var full = function (L_predicate, L_list) {
    return resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_predicate)(function(){return resolve(L_head)(L_list)})(function(){return resolve(L_cons)(L_h, function(){return resolve(L_takeWhile)(L_predicate, L_t)})})(L_nil)}}}))(L_nil);
  };
 ...
 function(){return resolve(L_newDefine)("drop")(2)("drop x list = positive x\r\n  list\r\n    \\h t D . drop (-- x) t\r\n    nil\r\n  list")(lazy((function () {
  ...
  var full = function (L_x, L_list) {
    return resolve(L_positive)(L_x)(function(){return resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_drop)(function(){return resolve(L_$_$_)(L_x)}, L_t)}}}))(L_nil)})(L_list);
  };
  var partial = function(L_x) {
    var _1 = function(L_list) {
 ...
 function(){return resolve(L_newDefine)("dropWhile")(2)("dropWhile predicate list = list\r\n  \\h t D . predicate h\r\n    dropWhile predicate t\r\n    list\r\n  nil")(lazy((function () {
  var main;
  var full = function (L_predicate, L_list) {
    return resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_predicate)(L_h)(function(){return resolve(L_dropWhile)(L_predicate, L_t)})(L_list)}}}))(L_nil);
  };
  var partial = function(L_predicate) {
    var _1 = function(L_list) {
            return full(L_predicate, L_list);
 ...
 function(){return resolve(L_newDefine)("bindRepeat")(3)("bindRepeat nums cont res = nums\r\n  \\n t D . subbind (cont n) \\result . bindRepeat t cont [result | res]\r\n  foldr (\\el prev . isList el append cons el prev) nil (reverse res)")(lazy((function () {
  ...
  var full = function (L_nums, L_cont, L_res) {
    return resolve(L_nums)(lazy(function(L_n){return function(L_t){return function(L_D){return resolve(L_subbind)(function(){return resolve(L_cont)(L_n)})(lazy(function(L_result){return resolve(L_bindRepeat)(L_t, L_cont, function(){return resolve(L_cons)(L_result, L_res)})}))}}}))(function(){return resolve(L_foldr)(lazy(function(L_el){return function(L_prev){return resolve(L_isList)(L_el)(L_append)(L_cons)(L_el)(L_prev)}}), L_nil, function(){return resolve(L_reverse)(L_res)})});
  };
