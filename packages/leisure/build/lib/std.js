module.exports = L_runMonads([
 ...
 function(){return resolve(L_advise)("bind2")("option")(2)(lazy(function(L_opt){return $F(arguments, function(L_cont){return resolve(L_isOption)(L_opt)(function(){return resolve(L_some)(function(){return resolve(L_opt)(lazy(function(L_value){return resolve(L_bindIOish)(function(){return resolve(L_cont)(L_value)})(lazy(function(L_res){return resolve(L_isOption)(L_res)(L_res)(function(){return resolve(L_some)(L_res)})}))}))(L_none)})})(L_none)})}))},
 function(){return resolve(L_advise)("bind2")("either")(2)(lazy(function(L_either){return $F(arguments, function(L_cont){return resolve(L_isEither)(L_either)(function(){return resolve(L_some)(function(){return resolve(L_either)(lazy(function(L__){return resolve(L_either)}))(lazy(function(L_value){return resolve(L_bindIOish)(function(){return resolve(L_cont)(L_value)})(lazy(function(L_res){return resolve(L_isEither)(L_res)(L_res)(function(){return resolve(L_right)(L_res)})}))}))})})(L_none)})}))},
 ...
 function(){return resolve(L_newDefine)("bindCons")(3)("bindCons list cont results = list\n  \\h t D . bindIOish (cont h) \\result . bindCons t cont\n    result == unit\n      results\n      isCons result\n        dlAppend results (append result)\n        dlPush results result\n  results nil")(lazy((function () {
  var main;
  var full = function (L_list, L_cont, L_results) {
    return resolve(L_list)(lazy(function(L_h){return $F(arguments, function(L_t){return $F(arguments, function(L_D){return resolve(L_bindIOish)(function(){return resolve(L_cont)(L_h)})(lazy(function(L_result){return resolve(L_bindCons)(L_t, L_cont, function(){return resolve(L_$p$p)(L_result)(L_unit)(L_results)(function(){return resolve(L_isCons)(L_result)(function(){return resolve(L_dlAppend)(L_results, function(){return resolve(L_append)(L_result)})})(function(){return resolve(L_dlPush)(L_results, L_result)})})})}))})})}))(function(){return resolve(L_results)(L_nil)});
  };
  var partial = function(L_list) {
 ...
 function(){return resolve(L_newDefine)("bindRepeat")(3)("bindRepeat nums cont res = nums\n  \\n t D . bindIOish (cont n) \\result . bindRepeat t cont [result | res]\n  foldr (\\el prev . isList el append cons el prev) nil (reverse res)")(lazy((function () {
  var main;
  var full = function (L_nums, L_cont, L_res) {
    return resolve(L_nums)(lazy(function(L_n){return $F(arguments, function(L_t){return $F(arguments, function(L_D){return resolve(L_bindIOish)(function(){return resolve(L_cont)(L_n)})(lazy(function(L_result){return resolve(L_bindRepeat)(L_t, L_cont, function(){return resolve(L_cons)(L_result, L_res)})}))})})}))(function(){return resolve(L_foldr)(lazy(function(L_el){return $F(arguments, function(L_prev){return resolve(L_isList)(L_el)(L_append)(L_cons)(L_el)(L_prev)})}), L_nil, function(){return resolve(L_reverse)(L_res)})});
  };
 ...
 function(){return resolve(L_newDefine)("bindIOish")(2)("bindIOish m cont = bind2 (wrap m) cont")(lazy((function () {
  var main;
 ...
 function(){return resolve(L_advise)("bindIOish")("monad")(2)(lazy(function(L_m){return $F(arguments, function(L_cont){return resolve(L_or)(function(){return resolve(L_hasType)(L_m)("*Monad2")}, function(){return resolve(L_hasType)(L_m)("monad")})(function(){return resolve(L_some)(function(){return resolve(L_bind2)(L_m)(L_cont)})})(L_none)})}))},
 function(){return resolve(L_advise)("bindIOish")("boolean")(2)(lazy(function(L_m){return $F(arguments, function(L_cont){return resolve(L_$p$p)(L_m)(L_false)(function(){return resolve(L_some)(function(){return resolve(L_bind2)(L_unit)(L_cont)})})(L_none)})}))},
 function(){return resolve(L_advise)("bindIOish")("option")(2)(lazy(function(L_m){return $F(arguments, function(L_cont){return resolve(L_hasType)(L_m)(L_none)(function(){return resolve(L_some)(function(){return resolve(L_bind2)(L_unit)(L_cont)})})(L_none)})}))},
 function(){return resolve(L_advise)("bindIOish")("either")(2)(lazy(function(L_m){return $F(arguments, function(L_cont){return resolve(L_hasType)(L_m)(L_left)(function(){return resolve(L_some)(function(){return resolve(L_bind2)(L_unit)(L_cont)})})(L_none)})}))},
