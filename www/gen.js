...
(function() {
  ...
  findName = function(name) {
    ...
    for (i = _i = _ref4 = root.nameSpacePath.length - 1; _ref4 <= 0 ? _i <= 0 : _i >= 0; i = _ref4 <= 0 ? ++_i : --_i) {
      if ((_ref5 = LeisureNameSpaces[root.nameSpacePath[i]]) != null ? _ref5[name] : void 0) {
  ...
  location = function(ast) {
    var col, line, _ref4;
    _ref4 = locateAst(ast), line = _ref4[0], col = _ref4[1];
    return "" + line + ":" + col;
  };
