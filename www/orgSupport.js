...
(function() {
  ...
  mutations = (_ref5 = require('./mutation-summary'), MutationSummary = _ref5.MutationSummary, _ref5);
  ...
  getMarkPositions = function(node) {
    var cur, offset, positions, _i, _len, _ref6;
    positions = [];
    offset = 0;
    cur = node;
    _ref6 = $('[data-mark]');
  ...
  createMarkNode = function(id) {
    return $("<span data-mark=" + (id != null ? id : markId++) + "></span>");
  };
  ...
  getStartTextNodeAtOffset = function(node, pos) {
    var offset;
    offset = 0;
  ...
  getEndTextNodeAtOffset = function(node, pos) {
    var offset;
    offset = 0;
    while (node && offset < pos) {
      if (node.nodeType === 3) {
        ...
        if (offset > pos) {
          return node.splitText(pos - offset + node.data.length);
        }
      }
      node = nodeAfter(node);
    }
  ...
  orgNotebook = {
    useNode: function(node, source) {
      var lastOrgText, newNode, oldContent, orgNode, _ref6,
        _this = this;
      root.orgApi = this;
      sourceDiv = source;
