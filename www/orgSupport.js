...
(function() {
  ...
  saveFile = function(fileInput) {
    ...
    fs.writeFile(file.path, $(fileInput.parentSpec).text(), function(err) {
      return alert("Error saving file " + file.path + ": " + err);
    });
    return window.FILE = file;
  };
