...
(function() {
  ...
  markupSource = function(org, name, intertext) {
    ...
    while (node) {
      ...
      } else if (node instanceof Headline) {
        break;
      } else {
