...
(function() {
  var BS, DEL, DOCUMENT_POSITION_CONTAINED_BY, ENTER, HL_TAGS, Headline, KW_BOILERPLATE, KW_INFO, KW_NAME, Keyword, ListItem, Meat, Results, SimpleMarkup, Source, TAB, addComment, addKeyPress, allowEvents, atTextEnd, atTextStart, baseEnv, bindContent, boundarySpan, bsWillDestroyParent, checkCollapsed, checkEnterReparse, checkExtraNewline, checkSourceMod, checkStart, clearResults, colonify, commentBlock, commentButton, commentHtml, content, contentSpan, createResults, crossesHidden, curPos, currentLine, currentTextPosition, defaultBindings, defaultEnv, defaultMarkup, define, displaySource, documentTop, eatListItem, emptyPresenter, escapeAttr, escapeHtml, escapePresentationHtml, executeDef, executeSource, executeText, fancyCheckSourceMod, fancyOrg, findDomPosition, findKeyBinding, followingSpan, getCodeContainer, getNodeSource, getOrgParent, getOrgType, getResultsForSource, getTextPosition, getType, handleKey, handleMutation, headlineRE, hideSlider, hideSlides, hlStars, htmlForResults, invalidateOrgText, isCollapsed, isDef, isHtml, isMonad, isOrContains, keyFuncs, keywordRE, lastOrgOffset, lazy, lz, makeSyncMonad, markupGuts, markupHeadline, markupHtml, markupLeisure, markupListItem, markupNode, markupOrg, markupOrgWithNode, markupSimple, markupSource, matchLine, matchLineAt, modifiers, modifyingKey, nativeRange, newCodeContent, newCommentBox, nextOrgId, nextSlide, oldRestorePosition, optionalBoundary, orgAttrs, orgEnv, orgNotebook, orgSrcAttrs, parseOrgMode, parseTags, presentValue, presenter, prevSlide, processResults, propsFor, psgn, recreateAstButtons, redrawAllIssues, redrawIssue, replacePresenter, replaceRelatedPresenter, replaceUnrelatedPresenter, reprocessResults, resolve, restorePosition, restoreSlide, root, runMonad, rz, setCurKeyBinding, setCurrentSlide, setMinMax, setShadowHtml, setSlideAt, shouldCancelBS, shouldCancelDEL, show, showAst, showSliderButton, showSlides, slideBindings, slideMode, slideOffset, slideParent, splitLines, srcStartRE, swapMarkup, toggleComment, toggleSlides, unescapePresentationHtml, unwrap, _, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
  ...
  root.restorePosition = restorePosition = function(parent, block) {
    var end, endContainer, endOffset, newSlide, offset, r, sel, slide, slideIndex, start, _ref6;
    sel = getSelection();
    if (sel != null ? sel.rangeCount : void 0) {
      ...
      if (slideIndex > -1) {
        ...
        if (start > -1 && (r = nativeRange(findDomPosition(newSlide, start)))) {
          _ref6 = findDomPosition(newSlide, end), endContainer = _ref6[0], endOffset = _ref6[1];
