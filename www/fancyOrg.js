...
(function() {
  ...
  showAst = function(evt, astButton, offset) {
    ...
    evt.preventDefault();
    evt.stopPropagation();
    if (presenter.button === astButton) {
      return replacePresenter(emptyPresenter);
    } else {
