...
(function() {
  ...
  markupHeadline = function(org, delay) {
    var k, last, match, properties, stars, starsM, start, tags, v, _ref7, _ref8;
    ...
    if (org.text.trim() !== '') {
      return "<div " + (orgAttrs(org)) + "><span class='hidden'>" + stars + "</span><span data-org-type='text'><div data-org-type='text-content'><div class='textcontent'>" + (escapeHtml(start)) + "</div><span class='tags'>" + properties + tags + "</span><div class='textborder'></div></div>" + last + "</span>" + (markupGuts(org, checkStart(start, org.text))) + "</div>";
    } else {
