...
(function() {
  ...
  createNotes = function(node) {
    var dest, html, noteSpec, org, spec, splitSpec, _i, _len, _ref7, _results;
    ...
    for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        var _j, _len1, _ref8, _ref9, _results1;
        _ref8 = noteSpec.split(/,/);
        _results1 = [];
          ...
          switch ((splitSpec = spec.split(/\ +/))[0]) {
            case 'sidebar':
              if (dest = $("[data-org-headline-text='" + splitSpec[1] + "'] div.sidebar")[0]) {
                ...
                _ref9 = markupOrgWithNode(node.textContent, true), org = _ref9[0], html = _ref9[1];
  ...
  fancyOrg = {
    ...
    installOrgDOM: function(parent, orgNode, orgText) {
      ...
      return restorePosition(parent, function() {
        ...
        fixupHtml(parent);
        setTheme(theme);
        _ref7 = $(parent).find('[data-org-notes]');
        for (_i = 0, _len = _ref7.length; _i < _len; _i++) {
          node = _ref7[_i];
          createNotes(node);
        }
