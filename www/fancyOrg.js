...
(function() {
  ...
  getDocRange = function() {
    var doc, note, offset, r, s, shadow, _ref7, _ref8, _ref9;
    s = getSelection();
    r = s.getRangeAt(0);
    offset = getDocumentOffset(r);
    if (((_ref7 = s.focusNode) != null ? _ref7.nodeType : void 0) === 1 && s.rangeCount === 1 && r.collapsed && (shadow = (_ref8 = r.startContainer.children[r.startOffset]) != null ? _ref8.shadowRoot : void 0)) {
      s = shadow.getSelection();
      note = (_ref9 = $(s.focusNode).closest('[data-note-origin]')) != null ? _ref9[0] : void 0;
      if (note) {
