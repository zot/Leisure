...
(function() {
  ...
  fancyOrg = {
    ...
    installOrgDOM: function(parent, orgNode, orgText) {
      this.parent = parent;
      return restorePosition(parent, function() {
        var node, props, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref10, _ref11, _ref7, _ref8, _ref9,
          _this = this;
        ...
        _ref11 = $('[data-org-properties]');
        for (_m = 0, _len4 = _ref11.length; _m < _len4; _m++) {
          node = _ref11[_m];
          props = JSON.parse(node.getAttribute('data-org-properties'));
          if (props['note-attachment']) {
            console.log("NOTE: " + (node.getAttribute('data-org-properties')));
          }
        }
        setTheme(theme);
        setTimeout((function() {
