...
(function() {
  var BS, DEL, ENTER, burp, buttons, clean, cleaning, configureCalc, configurePanelToggle, defaultEnv, define, delayedEval, evalCount, evalDiv, genSource, getParseErr, getType, isMonad, lazy, lz, minInt, resetText, resolve, root, runMonad, rz, show, showButton, svgMeasureText, textNode, toggleAll, toggleButton, updateAllButton, _ref, _ref1, _ref2;
  ...
  svgMeasureText = require('./browserSupport').svgMeasureText;
