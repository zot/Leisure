...
Leisure.createMethod('nil', 'merge', "\\cmp a b      . a", function(_cmp, _a, _b) {return _a();});
  _submerge = Parse.define('submerge', (function() {var f; return function _submerge(){return f || (f = (function(_cmp){return function(_a){return function(_b){return _cmp()((function(){var $m; return (function(){return $m || ($m = (_head()(_a)))})})())((function(){var $m; return (function(){return $m || ($m = (_head()(_b)))})})())((function(){var $m; return (function(){return $m || ($m = (_cons()((function(){var $m; return (function(){return $m || ($m = (_head()(_a)))})})())((function(){var $m; return (function(){return $m || ($m = (_merge()((function(){var $m; return (function(){return $m || ($m = (_tail()(_a)))})})())(_b)))})})())))})})())((function(){var $m; return (function(){return $m || ($m = (_cons()((function(){var $m; return (function(){return $m || ($m = (_head()(_b)))})})())((function(){var $m; return (function(){return $m || ($m = (_merge()(_a)((function(){var $m; return (function(){return $m || ($m = (_tail()(_b)))})})())))})})())))})})());};};}));}})(), 3, "\\cmp a b . cmp (head a) (head b)\n  [(head a) | (merge (tail a) b)]\n  [(head b) | (merge a (tail b))]");;
...
Leisure.createMethod('nil', 'mergeSort', "\\cmp l      . nil", function(_cmp, _l) {return _nil();});
  _sort = Parse.define('sort', (function() {var f; return function _sort(){return f || (f = (function(_cmp){return function(_l){return _mergeSort()(_cmp)(_l);};}));}})(), 2, "\\cmp l . mergeSort cmp l");;
