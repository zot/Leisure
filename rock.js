...
;
//clickRock = AST(bind event \e . print (concat ([ event x:  , (eventX e) ])))
root.defs._clickRock = _clickRock = define('clickRock', _bind()(_event)((function(){var $m; return function(){return $m || ($m = (function(_e){return _print()((function(){var $m; return function(){return $m || ($m = (_concat()((function(){var $m; return function(){return $m || ($m = (_$r()((function(){return "event x: "}))(_$b)((function(){var $m; return function(){return $m || ($m = (_eventX()(_e)))}})())(_$s)))}})())))}})())}))}})()));
;
