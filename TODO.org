* TODO change UI system to use a data filter to manage view definition
* TODO coffeescript errors: deal with sourcemaps properly [[https://github.com/rich-harris/sorcery][sorcery]]
* TODO think about using *.org instead of *.lorg
* TODO register handlebars helpers directly with leisure source blocks
