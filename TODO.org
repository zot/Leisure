...
** TODO "immediate" macro/function
** TODO work on optimizing compiler
- remove fancy generated stuff from compiler code
- make sure calls are generated with proper arity
- add arity to function name list
