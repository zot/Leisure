...
- nested IO monad execution is not using bind properly

  This works (it does not print 4 and returns none):
    do
      none
      print 4

  This works (it prints 4 and returns some true):
    do
      some 3
      print 4

  This works (it does not print 4 and returns some true):
    do
      do (some 3) none
      print 4

  This does not work (it prints 3 and 4 and returns true):
    do
      do (print 3) none
      print 4

  This does not work (it prints 4 and returns true):
    do
      do 3 none
      print 4

  need to call bind on result of nested execution
