...
** TODO handle inserts with org change/regen
** TODO typing a character on the first new blank line adds another blank line
** TODO merge root.modCancelled wth root.ignoreModCheck
** TODO code view doesn't handle rapid typing when there are numbers and operators
** TODO AST buttons are horked for code containing blank lines
** TODO pop up a toolbar for code blocks
** TODO make the selection bubble pop up a toolbar
** TODO allow views to markup headlines
