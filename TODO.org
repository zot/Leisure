...
- named views org:bubbaObj/fredView
  - if bubbaObj's type is btype, view's name is btype/fredView
...
- collaboration
  ...
  - spawn document copy
    ...
    - temporary ones disappear when the last user disconnects
...
* Milestone features
- alternate views org:bubbaObj/fredView
- nested views {{view bubbaObj}}  {{view bubbaObj 'fredView'}}
- script screencast
