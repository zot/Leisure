...
(function() {
  var Github, Headline, Keyword, Meat, Results, Source, addComment, addIssue, checkEvents, commentHtml, commentIssueURLs, commentIssues, connectStorage, connection, createComment, currentFile, defaultEnv, getAllIssuesAndCommentsThen, getContent, getRelevantIssueName, githubParams, initCollaboration, initStorage, isIssueEvent, lastUpdate, lazy, loadOrg, redrawAllIssues, redrawIssue, redrawIssues, refreshIssueData, repo, resolve, root, storageListener, storeInGit, useFile, useUrl, _ref, _ref1,
  ...
  initCollaboration = require('./collaborate').initCollaboration;
