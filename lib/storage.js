...
(function() {
  var Github, Headline, Keyword, Meat, Results, Source, addComment, addIssue, checkEvents, commentHtml, commentIssueURLs, commentIssues, connectStorage, connection, currentFile, defaultEnv, getAllIssuesAndCommentsThen, getContent, getRelevantIssueName, initStorage, isIssueEvent, lastUpdate, lazy, loadOrg, redrawAllIssues, redrawIssue, redrawIssues, refreshIssueData, repo, resolve, root, storageListener, useFile, useUrl, _ref, _ref1,
