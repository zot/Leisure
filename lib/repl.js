...
(function() {
  ...
  _ref = require('./ast'), getType = _ref.getType, setType = _ref.setType, setDataType = _ref.setDataType, ast2Json = _ref.ast2Json, json2Ast = _ref.json2Ast, Nil = _ref.Nil;

  gen = require('./gen').gen;

  _ref1 = require('./node'), readFile = _ref1.readFile, writeFile = _ref1.writeFile;

  _ref2 = require('./runtime'), identity = _ref2.identity, runMonad = _ref2.runMonad, newRunMonad = _ref2.newRunMonad, isMonad = _ref2.isMonad, asyncMonad = _ref2.asyncMonad, defaultEnv = _ref2.defaultEnv, replaceErr = _ref2.replaceErr, getMonadSyncMode = _ref2.getMonadSyncMode, setWarnAsync = _ref2.setWarnAsync;
      ...
      try {
        ...
        return runMonad(result, replEnv, function(ast) {
          ...
          try {
            ...
            err = _error;
            return cont("ERROR: " + ((_ref3 = err.stack) != null ? _ref3 : err));
          }
        });
      } catch (_error) {
        err = _error;
    ...
    return fs.exists(historyFile, function(exists) {
      return (function(cont) {
        ...
        root.defaultEnv.err = function(err) {
          ...
          console.log("REPL Error: " + ((_ref3 = err.stack) != null ? _ref3 : err));
          multiline = false;
          return prompt();
        };
