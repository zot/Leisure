...
(function() {
  var Nil, action, ast2Json, asyncMonad, compile, createAstFile, createJsFile, defaultEnv, diag, evalInput, fs, gen, genJsFromAst, gennedAst, gennedJs, getMonadSyncMode, getParseErr, getType, help, identity, interactive, interrupted, isMonad, json2Ast, lazy, leisureCompleter, leisureFunctions, loadedParser, lz, newOptions, newRunMonad, oldFunctionCount, outDir, path, primCompile, processArg, processedFiles, prog, prompt, promptText, readFile, readline, recompiled, repl, replEnv, replaceErr, requireList, resolve, rl, root, run, runFile, runMonad, rz, setDataType, setType, setWarnAsync, stage, stages, tokenString, updateCompleter, usage, verbose, writeFile, _, _ref, _ref1, _ref2, _ref3;
  ...
  _ref2 = require('./node'), readFile = _ref2.readFile, writeFile = _ref2.writeFile;

  _ref3 = require('./runtime'), identity = _ref3.identity, runMonad = _ref3.runMonad, newRunMonad = _ref3.newRunMonad, isMonad = _ref3.isMonad, asyncMonad = _ref3.asyncMonad, defaultEnv = _ref3.defaultEnv, replaceErr = _ref3.replaceErr, getMonadSyncMode = _ref3.getMonadSyncMode, setWarnAsync = _ref3.setWarnAsync;
  ...
  evalInput = function(text, cont) {
    var err, result, _ref4;

    if (text) {
      try {
        result = L_newParseLine()(0)(function() {
          return Nil;
        })(function() {
          return text;
        });
        return runMonad(result, replEnv, function(ast) {
          ...
          try {
            ...
            err = _error;
            return cont("ERROR: " + ((_ref4 = err.stack) != null ? _ref4 : err));
          }
        });
      } catch (_error) {
        err = _error;
    ...
    return fs.exists(historyFile, function(exists) {
      return (function(cont) {
        ...
        root.defaultEnv.err = function(err) {
          ...
          console.log("REPL Error: " + ((_ref4 = err.stack) != null ? _ref4 : err));
          multiline = false;
          return prompt();
        };
          ...
          if (dumpInput) {
            ...
            try {
              if (line.substring(0, 2) === ':s') {
                if (typeof L_simplify !== "undefined" && L_simplify !== null) {
                  console.log("\n" + (L_show()(function() {
                    return runMonad(L_simplify()(function() {
                ...
                evalInput(line, function(result) {
                  console.log("RESULT: " + L_show()(function() {
                    return result;
                  }));
                  return prompt();
                });
  ...
  runFile = function(file, cont) {
    ...
    try {
      return runMonad(L_protect()(function() {
        return L_require()(function() {
          return file;
        });
  ...
  primCompile = function(file, cont) {
    var compileFile, ext, parseLine, _ref4;

    _ref4 = require(stages[stage]), parseLine = _ref4.parseLine, compileFile = _ref4.compileFile;
    ext = path.extname(file);
      ...
      default:
        ...
        if (process.argv[pos][0] === '-') {
          ...
          if (!loadedParser) {
            ...
            for (_i = 0, _len = requireList.length; _i < _len; _i++) {
              f = requireList[_i];
              require(f);
            }
          }
