...
(function() {
  ...
  _ref2 = require('./runtime'), identity = _ref2.identity, runMonad = _ref2.runMonad, isMonad = _ref2.isMonad, defaultEnv = _ref2.defaultEnv, replaceErr = _ref2.replaceErr;
  ...
  compileLines = function(lines, names, asts, cont) {
    if (lines.isNil()) {
      return cont(asts);
    } else {
