...
(function() {
  var Nil, action, ast2Json, compile, createAstFile, createJsFile, defaultEnv, diag, evalInput, fs, gen, genJsFromAst, gennedAst, gennedJs, help, identity, json2Ast, leisureCompleter, leisureFunctions, loadedParser, newOptions, oldFunctionCount, outDir, path, primCompile, processArg, processedFiles, readFile, readline, recompiled, repl, root, run, runMonad, setDataType, setType, stage, stages, tokenString, updateCompleter, verbose, writeFile, _, _ref, _ref1, _ref2;
