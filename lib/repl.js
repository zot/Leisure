...
(function() {
  ...
  _ref2 = require('./runtime'), identity = _ref2.identity, runMonad = _ref2.runMonad, basicRunMonad = _ref2.basicRunMonad, defaultEnv = _ref2.defaultEnv;
    ...
    if (lines.isNil()) {
      ...
      return runMonad(L_runLine()(function() {
        ...
        if (ast instanceof Error) {
          return cont(replaceErr(ast, "Error compiling line: " + (lines.head()) + "...\n" + ast.message));
        } else {
          asts.push(ast.head());
