...
(function() {
  var Nil, action, ast2Json, asyncMonad, compile, compileLines, compileResult, createAstFile, createJsFile, defaultEnv, diag, evalInput, fs, gen, genJsFromAst, gennedAst, gennedJs, getMonadSyncMode, help, identity, interrupted, isMonad, json2Ast, leisureCompleter, leisureFunctions, loadedParser, newCompileLines, newOptions, oldFunctionCount, outDir, path, primCompile, processArg, processedFiles, readFile, readline, recompiled, repl, replEnv, replaceErr, rl, root, run, runMonad, setDataType, setType, stage, stages, tokenString, updateCompleter, usage, verbose, writeFile, _, _ref, _ref1, _ref2;
  ...
  _ref2 = require('./runtime'), identity = _ref2.identity, runMonad = _ref2.runMonad, isMonad = _ref2.isMonad, asyncMonad = _ref2.asyncMonad, defaultEnv = _ref2.defaultEnv, replaceErr = _ref2.replaceErr, getMonadSyncMode = _ref2.getMonadSyncMode;
      ...
      try {
        ...
        return runMonad(result, replEnv, function(ast) {
          ...
          try {
            ...
            return runMonad(eval("(" + (gen(ast)) + ")"), replEnv, cont);
          } catch (_error) {
            err = _error;
      ...
      lineData = runMonad(L_runLine()(function() {
        ...
        if (getMonadSyncMode()) {
          ...
          if (res) {
            ...
            return newCompileLines(lines.tail(), names, asts, cont);
          }
        }
      });
      if (lineData === asyncMonad) {
        return;
      }
      res = compileResult(lineData, asts);
      if (res) {
  ...
  compileResult = function(lineData, asts) {
    var ast, result;
