...
(function() {
  ...
  useSkin = function() {
    ...
    $('#input').css('font-size', '36px').css('top', '0').css('height', 'calc(49px * 4)').css('left', '32px').css('padding', '0').css('padding-left', '2px').css('padding-right', '2px').css('width', '651px').css('position', 'fixed').css('margin', '0').css('border', 'none').css('outline', '1px solid black');
    $('#inputLabel').css('display', 'none');
    $('#outputLabel').css('font-size', '36px').css('top', 'calc(49px * 4)').css('position', 'fixed');
    return $('#output').css('font-size', '36px').css('top', 'calc(49px * 5)').css('left', '32px').css('padding', '0').css('padding-left', '2px').css('padding-right', '2px').css('width', '651px').css('position', 'fixed').css('margin', '0').css('border', 'none').css('outline', '1px solid green');
  };
