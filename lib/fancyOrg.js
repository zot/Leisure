...
(function() {
  ...
  root.toggleTestCase = function(evt) {
    var node;
    node = evt.target;
    while (!(typeof node.hasAttribute === "function" ? node.hasAttribute('org-test') : void 0)) {
      node = node.parentNode;
    }
    if (node) {
      node.setAttribute('org-test', 'edit');
      node.setAttribute('onclick', '');
      return $(node).find('[org-test-expected="true"]').remove();
    }
  };
