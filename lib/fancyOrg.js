...
(function() {
  ...
  codeBlockForNode = function(node) {
    ...
    if (node && !node.hasAttribute('data-org-test')) {
  ...
  runAutotests = function(doc) {
    ...
    _ref6 = $(doc).find("[data-org-results='autotest']");
    _results = [];
    for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
      n = _ref6[_i];
  ...
  runTest = function(doc, node) {
    return executeSource(doc, node, (function() {
