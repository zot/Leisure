...
(function() {
  ...
  markupSource = function(org, name, intertext, delay) {
    var channels, codeBlock, contHtml, expected, finalIntertext, lead, nameM, node, resText, result, srcContent, startHtml, testAttr, testCase, testValue, trail, wrapper, _ref7;
