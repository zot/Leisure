...
(function() {
  ...
  root.restorePosition = restorePosition = function(parent, block) {
    var c, container, doc, docPos, end, endContainer, endOffset, newSlide, offset, r, sel, slide, slideIndex, sta, start, _ref6, _ref7;
    sel = getSelection();
    ...
    if ((sel != null ? sel.rangeCount : void 0) && slideIndex > -1) {
      ...
      _ref6 = findDomPosition(doc, start), container = _ref6[0], sta = _ref6[1];
      ...
      if (doc = parent.children[docPos]) {
        ...
        if (start > -1 && (r = nativeRange(findDomPosition(doc, start)))) {
          if (isCollapsed(r.startContainer)) {
            ...
            _ref7 = findDomPosition(doc, end), endContainer = _ref7[0], endOffset = _ref7[1];
            if (endOffset === 0) {
  ...
  markupSource = function(org, name, intertext) {
    var codeBlock, contHtml, expected, lead, nameM, node, resText, result, srcContent, startHtml, testCase, trail, wrapper, _ref6;
    ...
    wrapper += "</td></tr></table>";
    testCase = ((_ref6 = resultsType(org)) === 'test' || _ref6 === 'autotest') && expected && (resText != null);
