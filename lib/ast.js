...
(function() {
  var L_anno, L_apply, L_lambda, L_let, L_lit, L_ref, LeisureObject, Leisure_BaseCons, Leisure_cons, Leisure_nil, Nil, anno, apply, ast2Json, ast2JsonEncodings, astString, charCodes, checkType, cons, consEq, consFrom, define, dummyPosition, ensureLeisureClass, evalFunc, firstRange, foldLeft, functionInfo, getAnnoBody, getAnnoData, getAnnoName, getAnnoRange, getApplyArg, getApplyFunc, getApplyRange, getDataType, getLambdaBody, getLambdaRange, getLambdaVar, getLetBody, getLetName, getLetRange, getLetValue, getLitRange, getLitVal, getPos, getRefName, getRefRange, getType, head, isNil, jsType, json2Ast, json2AstEncodings, jsonToRange, lambda, lazy, leisureAddFunc, letStr, lit, llet, lz, makeSuper, mkProto, nameFunc, nameSub, nsLog, primCons, primFoldLeft, rangeToJson, ref, resolve, root, rz, save, setDataType, setType, supertypes, tail, throwError, _, _ref,
  ...
  getType = function(f) {
    var t, _ref1;
    t = typeof f;
    return (t === 'function' && (f != null ? f.type : void 0)) || ("*" + ((t === 'object' && ((_ref1 = f.constructor) != null ? _ref1.name : void 0)) || t));
  };
  ...
  firstRange = function(a, b) {
    var colA, colB, lineA, lineB, _ref1, _ref2;
    if (!a || !b) {
      console.log("NIL = " + Nil);
    }
    _ref1 = a.toArray(), lineA = _ref1[0], colA = _ref1[1];
    _ref2 = b.toArray(), lineB = _ref2[0], colB = _ref2[1];
  ...
  ast2Json = function(ast) {
    var _ref1;
    if (ast2JsonEncodings[(_ref1 = ast.constructor) != null ? _ref1.name : void 0]) {
