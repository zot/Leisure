...
(function() {
  var Monad, Nil, booleanFor, codeMonad, cons, consFrom, define, getDataType, getType, getValue, head, identity, makeMonad, nextMonad, root, runMonad, setValue, strCoord, strFromList, strToList, tail, values, _, _false, _ref, _true;
