...
(function() {
  var Monad, Nil, ast2Json, booleanFor, codeMonad, cons, consFrom, defaultEnv, define, ensureLeisureClass, getDataType, getType, getValue, head, identity, left, makeMonad, nextMonad, none, parensContent, parensEnd, parensStart, readFile, replaceErr, right, root, runMonad, setType, setValue, some, strCoord, strFromList, strToList, tail, tokenPos, tokenString, values, wrapCont, wrapContAsync, _, _false, _identity, _ref, _true,
    __slice = [].slice;
  ...
  defaultEnv = {
    ...
    err: function(err) {
      ...
      return this.write("ENV Error: " + ((_ref1 = err.stack) != null ? _ref1 : err));
    },
    asyncBind: function(state) {
      return this.wrapCont = state ? function(cont) {
