...
(function() {
  var Monad, Nil, ast2Json, booleanFor, codeMonad, cons, consFrom, define, ensureLeisureClass, getDataType, getType, getValue, head, identity, left, makeMonad, nextMonad, none, parensContent, parensEnd, parensStart, readFile, right, root, runMonad, setType, setValue, some, strCoord, strFromList, strToList, tail, tokenPos, tokenString, values, _, _false, _identity, _ref, _true;
  ...
  runMonad = function(monad, env, cont) {
    ...
    try {
      ...
      err = _error;
      return console.log("ERROR RUNNING MONAD, MONAD: " + monad + ", ENV: " + env + ", CONT: " + cont + ": " + err.stack);
    }
  };
