...
(function() {
  var Monad, Nil, booleanFor, codeMonad, cons, consFrom, define, getDataType, getType, getValue, head, identity, makeMonad, nextMonad, root, runMonad, setValue, strFromList, strToList, tail, values, _, _false, _ref, _true;
  ...
  define('strSubstring', function() {
    return function(str) {
      return function(start) {
        return function(end) {
          return str().substring(start(), (end() < 1 ? str().length + end() : end()));
        };
      };
    };
  });
