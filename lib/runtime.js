...
(function() {
  var Monad, Nil, ast2Json, booleanFor, codeMonad, cons, consFrom, define, ensureLeisureClass, getDataType, getType, getValue, head, identity, left, makeMonad, nextMonad, parensContent, parensEnd, parensStart, readFile, right, root, runMonad, setType, setValue, strCoord, strFromList, strToList, tail, tokenPos, tokenString, values, _, _false, _identity, _ref, _true;
