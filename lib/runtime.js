...
(function() {
  var Monad, booleanFor, codeMonad, consFrom, define, makeMonad, nextMonad, root, runMonad, values, _, _ref;

  root = module.exports = require('./base');

  _ref = require('./ast'), define = _ref.define, consFrom = _ref.consFrom;
  ...
  define('strStartsWith', function() {
    return function(str) {
      return function(prefix) {
        return booleanFor(str().startsWith(prefix()));
      };
    };
  });
