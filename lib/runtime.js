...
(function() {
  var Monad, Nil, ast2Json, booleanFor, codeMonad, cons, consFrom, define, ensureLeisureClass, getDataType, getType, getValue, head, identity, makeMonad, nextMonad, parensContent, parensEnd, parensStart, root, runMonad, setType, setValue, strCoord, strFromList, strToList, tail, tokenPos, tokenString, values, _, _false, _ref, _true;
