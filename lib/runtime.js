...
(function() {
  var Monad, Nil, ast2Json, asyncMonad, basicCall, booleanFor, call, callMonad, cons, consFrom, continueMonads, defaultEnv, define, ensureLeisureClass, getDataType, getMonadSyncMode, getType, getValue, head, identity, isMonad, left, makeMonad, makeSyncMonad, monadModeSync, newRunMonad, nextMonad, none, parensContent, parensEnd, parensStart, readFile, replaceErr, right, root, runMonad, setDataType, setType, setValue, setWarnAsync, some, strCoord, strFromList, strToList, tail, tokenPos, tokenString, values, warnAsync, withSyncModeDo, _, _false, _identity, _ref, _ref1, _true,
    __slice = [].slice;
  ...
  define('delay', function() {
    return function(func) {
      return makeSyncMonad(function(env, cont) {
        setTimeout((function() {
          return runMonad(func(), env, identity);
        }), 1);
        return cont(_true);
      });
    };
