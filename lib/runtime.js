...
(function() {
  var Monad, Nil, ast2Json, basicRunMonad, booleanFor, cons, consFrom, defaultEnv, define, ensureLeisureClass, getDataType, getType, getValue, head, identity, left, makeMonad, nextMonad, none, parensContent, parensEnd, parensStart, readFile, replaceErr, right, root, runMonad, setType, setValue, some, strCoord, strFromList, strToList, tail, tokenPos, tokenString, values, wrapCont, wrapContAsync, _, _false, _identity, _ref, _true,
    __slice = [].slice;
    ...
    asyncBind: function(state) {
      if (state) {
        return this.wrapCont = function(cont) {
          return wrapContAsync(this, cont);
        };
      } else {
        return this.wrapCont = function(cont) {
  ...
  wrapContAsync = function(env, cont) {
    if (cont.wrap) {
      return cont;
    } else {
      cont.wrap = true;
  ...
  runMonad = function(monad, env, cont) {
    ...
    return basicRunMonad(monad, env, cont != null ? cont : identity);
  };
      ...
      return function(binding) {
        return makeMonad(function(env, cont) {
          return runMonad(m(), env, function(value) {
            return basicRunMonad(binding()(function() {
              return value;
