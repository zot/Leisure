      ...
      return writeFile('/tmp/simpleParse.js', compileFile(code, "simpleParse.js"), function(err) {
        ...
        runTests('Leisure AST', {
          ...
          leisureAst25: function() {
            ...
            assertEq(String(lsr("scanLine " + (s('id = \\x . x')) + " " + delimiterPatStr + " id id")), "Cons[Token(\"define\", EMPTYFILE.lsr:1.5) Token(\"\\\"id\\\"\", EMPTYFILE.lsr:1.5) Token(\"0\", EMPTYFILE.lsr:1.5) Token(\"\\\"id = \\\\\\\\x . x\\\"\", EMPTYFILE.lsr:1.5) [Token(\"\\\\@\", EMPTYFILE.lsr:1.5) Token(\"dataType\", EMPTYFILE.lsr:1.5) Token(\"id\", EMPTYFILE.lsr:1.5) Token(\".\", EMPTYFILE.lsr:1.5) [Token(\"\\\\@\", EMPTYFILE.lsr:1.5) Token(\"type\", EMPTYFILE.lsr:1.5) Token(\"id\", EMPTYFILE.lsr:1.5) Token(\".\", EMPTYFILE.lsr:1.5) [Token(\"\\\\\", EMPTYFILE.lsr:1.5) Token(\"x\", EMPTYFILE.lsr:1.6) Token(\".\", EMPTYFILE.lsr:1.8) Token(\"x\", EMPTYFILE.lsr:1.10)]]]]");
