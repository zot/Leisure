      ...
      return writeFile('/tmp/simpleParse.js', compileFile(code, "simpleParse.js"), function(err) {
        ...
        runTests('Leisure parser', {
          ...
          leisureParse14: function() {
            return assertEq(strLsrD("parse 'a\n b c\n  d e\n f'"), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Parens(1, 12, Cons[Token("b", EMPTYFILE.lsr:1.3) Token("c", EMPTYFILE.lsr:1.5) Parens(6, 12, Cons[Token("d", EMPTYFILE.lsr:1.9) Token("e", EMPTYFILE.lsr:1.11)])]) Token("f", EMPTYFILE.lsr:1.14)]');
          },
          ...
          leisureParse27: function() {
            ...
            return assertEq(strLsrD("parse " + (s("a (\\b .\n  c\n  d (e f)) g"))), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Parens(EMPTYFILE.lsr:1.2, EMPTYFILE.lsr:1.22, Cons[Token("\\\\", EMPTYFILE.lsr:1.3) Token("b", EMPTYFILE.lsr:1.4) Token(".", EMPTYFILE.lsr:1.6) Token("c", EMPTYFILE.lsr:1.10) Parens(11, 21, Cons[Token("d", EMPTYFILE.lsr:1.14) Parens(EMPTYFILE.lsr:1.16, EMPTYFILE.lsr:1.21, Cons[Token("e", EMPTYFILE.lsr:1.17) Token("f", EMPTYFILE.lsr:1.19)])])]) Token("g", EMPTYFILE.lsr:1.23)]');
          },
        ...
        runTests('Leisure AST', {
          ...
          leisureAst25: function() {
            ...
            assertEq(String(lsr("scanLine " + (s('id = \\x . x')) + " " + delimiterPatStr + " id id")), "Cons[Token(\"define\", 5) Token(\"\\\"id\\\"\", 5) Token(\"0\", 5) Token(\"\\\"id = \\\\\\\\x . x\\\"\", 5) [Token(\"\\\\@\", 5) Token(\"dataType\", 5) Token(\"id\", 5) Token(\".\", 5) [Token(\"\\\\@\", 5) Token(\"type\", 5) Token(\"id\", 5) Token(\".\", 5) [Token(\"\\\\\", EMPTYFILE.lsr:1.5) Token(\"x\", EMPTYFILE.lsr:1.6) Token(\".\", EMPTYFILE.lsr:1.8) Token(\"x\", EMPTYFILE.lsr:1.10)]]]]");
