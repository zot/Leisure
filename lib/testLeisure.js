      ...
      return writeFile('/tmp/simpleParse.js', compileFile(code, "simpleParse.js"), function(err) {
        ...
        runTests('Leisure parser', {
          ...
          leisureParse3: function() {
            return assertEq(strLsrD("tokens 'a b'"), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Token("b", EMPTYFILE.lsr:1.2)]');
          },
          ...
          leisureParse14: function() {
            return assertEq(strLsrD("parse 'a\n b c\n  d e\n f'"), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Parens(EMPTYFILE.lsr:1.1, EMPTYFILE.lsr:1.12, Cons[Token("b", EMPTYFILE.lsr:1.3) Token("c", EMPTYFILE.lsr:1.5) Parens(EMPTYFILE.lsr:1.6, EMPTYFILE.lsr:1.12, Cons[Token("d", EMPTYFILE.lsr:1.9) Token("e", EMPTYFILE.lsr:1.11)])]) Token("f", EMPTYFILE.lsr:1.14)]');
          },
          ...
          leisureParse18: function() {
            return assertEq(strLsrD("tokens 'a b  c'"), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Token("b", EMPTYFILE.lsr:1.2) Token("c", EMPTYFILE.lsr:1.5)]');
          },
          ...
          leisureParse21: function() {
            return assertEq(strLsrD("parse 'a'"), 'Token("a", EMPTYFILE.lsr:1.0)');
          },
          leisureParse22: function() {
            return assertEq(strLsrD("parse 'a b  c'"), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Token("b", EMPTYFILE.lsr:1.2) Token("c", EMPTYFILE.lsr:1.5)]');
          },
          leisureParse23: function() {
            return assertEq(lsrD("splitTokens 'a (b)'").toArray(), ['a', ' ', '(', 'b', ')']);
          },
          leisureParse24: function() {
            return assertEq(strLsrD("parse 'a (b)'"), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Parens(EMPTYFILE.lsr:1.2, EMPTYFILE.lsr:1.5, Cons[Token("b", EMPTYFILE.lsr:1.3)])]');
          },
          leisureParse25: function() {
            return assertEq(strLsrD("tokens 'a ( (b  )   c) '"), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Token("(", EMPTYFILE.lsr:1.2) Token("(", EMPTYFILE.lsr:1.4) Token("b", EMPTYFILE.lsr:1.5) Token(")", EMPTYFILE.lsr:1.8) Token("c", EMPTYFILE.lsr:1.12) Token(")", EMPTYFILE.lsr:1.13)]');
          },
          leisureParse26: function() {
            return assertEq(strLsrD("parse 'a ( (b  )   c) '"), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Parens(EMPTYFILE.lsr:1.2, EMPTYFILE.lsr:1.14, Cons[Parens(EMPTYFILE.lsr:1.4, EMPTYFILE.lsr:1.9, Cons[Token("b", EMPTYFILE.lsr:1.5)]) Token("c", EMPTYFILE.lsr:1.12)])]');
          },
          leisureParse27: function() {
            ...
            assertEq(strLsrD("tokens 'a (\\\\b . c d (e f)) g'"), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Token("(", EMPTYFILE.lsr:1.2) Token("\\\\", EMPTYFILE.lsr:1.3) Token("b", EMPTYFILE.lsr:1.4) Token(".", EMPTYFILE.lsr:1.6) Token("c", EMPTYFILE.lsr:1.8) Token("d", EMPTYFILE.lsr:1.10) Token("(", EMPTYFILE.lsr:1.12) Token("e", EMPTYFILE.lsr:1.13) Token("f", EMPTYFILE.lsr:1.15) Token(")", EMPTYFILE.lsr:1.16) Token(")", EMPTYFILE.lsr:1.17) Token("g", EMPTYFILE.lsr:1.19)]');
            assertEq(strLsrD("parse 'a (\\\\b . c d (e f)) g'"), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Parens(EMPTYFILE.lsr:1.2, EMPTYFILE.lsr:1.18, Cons[Token("\\\\", EMPTYFILE.lsr:1.3) Token("b", EMPTYFILE.lsr:1.4) Token(".", EMPTYFILE.lsr:1.6) Token("c", EMPTYFILE.lsr:1.8) Token("d", EMPTYFILE.lsr:1.10) Parens(EMPTYFILE.lsr:1.12, EMPTYFILE.lsr:1.17, Cons[Token("e", EMPTYFILE.lsr:1.13) Token("f", EMPTYFILE.lsr:1.15)])]) Token("g", EMPTYFILE.lsr:1.19)]');
            assertEq(strLsrD("tokens " + (s("a (\\b .\n  c\n  d (e f)) g"))), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Token("(", EMPTYFILE.lsr:1.2) Token("\\\\", EMPTYFILE.lsr:1.3) Token("b", EMPTYFILE.lsr:1.4) Token(".", EMPTYFILE.lsr:1.6) Token("\\n  ", EMPTYFILE.lsr:1.7) Token("c", EMPTYFILE.lsr:1.10) Token("\\n  ", EMPTYFILE.lsr:1.11) Token("d", EMPTYFILE.lsr:1.14) Token("(", EMPTYFILE.lsr:1.16) Token("e", EMPTYFILE.lsr:1.17) Token("f", EMPTYFILE.lsr:1.19) Token(")", EMPTYFILE.lsr:1.20) Token(")", EMPTYFILE.lsr:1.21) Token("g", EMPTYFILE.lsr:1.23)]');
            return assertEq(strLsrD("parse " + (s("a (\\b .\n  c\n  d (e f)) g"))), 'Cons[Token("a", EMPTYFILE.lsr:1.0) Parens(EMPTYFILE.lsr:1.2, EMPTYFILE.lsr:1.22, Cons[Token("\\\\", EMPTYFILE.lsr:1.3) Token("b", EMPTYFILE.lsr:1.4) Token(".", EMPTYFILE.lsr:1.6) Token("c", EMPTYFILE.lsr:1.10) Parens(EMPTYFILE.lsr:1.11, EMPTYFILE.lsr:1.21, Cons[Token("d", EMPTYFILE.lsr:1.14) Parens(EMPTYFILE.lsr:1.16, EMPTYFILE.lsr:1.21, Cons[Token("e", EMPTYFILE.lsr:1.17) Token("f", EMPTYFILE.lsr:1.19)])])]) Token("g", EMPTYFILE.lsr:1.23)]');
          },
          leisureParse28: function() {
            return assertEq(strLsrD("parse " + (s('"a b"'))), 'Token("\\"a b\\"", EMPTYFILE.lsr:1.0)');
          }
        });
        runTests('Leisure AST', {
          ...
          leisureAst25: function() {
            ...
            assertEq(String(lsr("scanLine " + (s('id = \\x . x')) + " " + delimiterPatStr + " id id")), "Cons[\\@ leisureName id . Token(\"define\", EMPTYFILE.lsr:1.0) Token(\"\\\"id\\\"\", EMPTYFILE.lsr:1.0) Token(\"0\", EMPTYFILE.lsr:1.0) Token(\"\\\"id = \\\\\\\\x . x\\\"\", EMPTYFILE.lsr:1.0) [Token(\"\\\\@\", EMPTYFILE.lsr:1.5) Token(\"dataType\", EMPTYFILE.lsr:1.5) Token(\"id\", EMPTYFILE.lsr:1.5) Token(\".\", EMPTYFILE.lsr:1.5) [Token(\"\\\\@\", EMPTYFILE.lsr:1.5) Token(\"type\", EMPTYFILE.lsr:1.5) Token(\"id\", EMPTYFILE.lsr:1.5) Token(\".\", EMPTYFILE.lsr:1.5) [Token(\"\\\\\", EMPTYFILE.lsr:1.5) Token(\"x\", EMPTYFILE.lsr:1.6) Token(\".\", EMPTYFILE.lsr:1.8) Token(\"x\", EMPTYFILE.lsr:1.10)]]]]");
            ...
            return assertEq(String(lsr("parseLine 'id x = x' " + delimiterPatStr + " nil id id")), 'anno(\\@leisureName id . define id 1 id x = x \\x . x)');
          },
          ...
          leisureAst49: function() {
            ...
            assertEq(String(lsr("parseG " + (s('[a] [b]')) + " " + (s(LZ.delimiterPat.source)) + " (acons '[' ']' parenGroups)")), 'Cons[[Token("[", EMPTYFILE.lsr:1.0) [Token("a", EMPTYFILE.lsr:1.1)] Token("]", EMPTYFILE.lsr:1.2)] [Token("[", EMPTYFILE.lsr:1.4) [Token("b", EMPTYFILE.lsr:1.5)] Token("]", EMPTYFILE.lsr:1.6)]]');
            assertEq(String(lsr("parseG " + (s('(a]')) + " " + (s(LZ.delimiterPat.source)) + " (acons '[' ']' parenGroups)")), 'ParseErr("Mismatched group: (] at position: EMPTYFILE.lsr, 1.0")');
          ...
          leisureAst52: function() {
            ...
            return assertEq(String(lsr("postProcessMacro -1 -1 (cons (cons (token 'hello' 15) nil) (cons 'goodbye' nil))")), 'Cons[[Token("hello", 15)] Token("goodbye", NOTHING.lsr:0.6)]');
          },
