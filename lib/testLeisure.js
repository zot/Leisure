      ...
      return writeFile('/tmp/simpleParse.js', compileFile(code, "simpleParse.js"), function(err) {
        ...
        runTests('Leisure AST', {
          ...
          leisureAst25: function() {
            ...
            assertEq(String(lsr("scanLine " + (s('id = \\x . x')) + " " + delimiterPatStr + " id id")), "Cons[Token(\"\\\\@\", 5) [Token(\"definition\", 5) Token(undefined, 5)] Token(\".\", 5) Token(\"define\", 5) Token(\"\\\"id\\\"\", 5) Token(\"0\", 5) Token(\"\\\"id = \\\\\\\\x . x\\\"\", 5) [Token(\"\\\\@\", 5) Token(\"dataType\", 5) Token(\"id\", 5) Token(\".\", 5) [Token(\"\\\\@\", 5) Token(\"type\", 5) Token(\"id\", 5) Token(\".\", 5) [Token(\"\\\\\", 5) Token(\"x\", 6) Token(\".\", 8) Token(\"x\", 10)]]]]");
            ...
            return assertEq(String(lsr("parseLine 'id x = x' " + delimiterPatStr + " nil id id")), 'anno(\\@Cons[definition Token("id", 0)] Cons[] . define id 1 id x = x \\x . x)');
          },
