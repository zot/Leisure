...
(function() {
  var Leisure_anno, Leisure_apply, Leisure_lambda, Leisure_let, Leisure_lit, Leisure_ref, Nil, addUniq, cons, consFrom, define, dumpAnno, gen, genApplyArg, genLets, genUniq, getAnnoBody, getAnnoData, getAnnoName, getApplyArg, getApplyFunc, getLambdaBody, getLambdaVar, getLastLetBody, getLetBody, getLetName, getLetValue, getLitVal, getRefName, letList, makeMonad, memoize, nameSub, root, runMonad, setDataType, setType, uniqName, varNameSub, _, _false, _ref, _ref1;
  ...
  _ref1 = require('./runtime'), makeMonad = _ref1.makeMonad, runMonad = _ref1.runMonad, _false = _ref1._false;
...
(function() {
  var Monad, Nil, ast2Json, booleanFor, cons, consFrom, continueMonads, defaultEnv, define, ensureLeisureClass, getDataType, getType, getValue, head, identity, isMonad, left, makeMonad, makeSyncMonad, newRunMonad, nextMonad, none, parensContent, parensEnd, parensStart, readFile, replaceErr, right, root, runMonad, setType, setValue, some, strCoord, strFromList, strToList, tail, tokenPos, tokenString, values, _, _false, _identity, _ref, _true;
  ...
  runMonad = function(monad, env, cont) {
    ...
    return ret = newRunMonad(monad, env, cont, []);
  };
