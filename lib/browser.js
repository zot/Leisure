...
return L_runLines()(L_names)(L_lines)})()})}})())},
  ...
  function(){return L_define()(function(){return "require"})(function(){return 1})(function(){return "require file = bind (getValue 'requiredFiles')\n  \\files . contains files file\n    false\n    bind (load file)\n      \\_ . bind (setValue 'requiredFiles' (cons file files))\n        \\_ . true"})((function(){var $m; return function(){return $m || ($m = function(L_file){return L_bind()((function(){var $m; return function(){return $m || ($m = L_getValue()(function(){return "requiredFiles"}))}})())((function(){var $m; return function(){return $m || ($m = function(L_files){return L_contains()(L_files)(L_file)(L_false)((function(){var $m; return function(){return $m || ($m = L_bind()((function(){var $m; return function(){return $m || ($m = L_load()(L_file))}})())((function(){var $m; return function(){return $m || ($m = function(L__){return L_bind()((function(){var $m; return function(){return $m || ($m = L_setValue()(function(){return "requiredFiles"})((function(){var $m; return function(){return $m || ($m = L_cons()(L_file)(L_files))}})()))}})())((function(){var $m; return function(){return $m || ($m = function(L___0){return L_true()})}})())})}})()))}})())})}})())})}})())},
...
(function() {
  var Monad, Nil, ast2Json, asyncMonad, booleanFor, cons, consFrom, continueMonads, defaultEnv, define, ensureLeisureClass, getDataType, getMonadSyncMode, getType, getValue, head, identity, isMonad, left, makeMonad, makeSyncMonad, monadModeSync, newRunMonad, nextMonad, none, parensContent, parensEnd, parensStart, readFile, replaceErr, right, root, runMonad, setType, setValue, some, strCoord, strFromList, strToList, tail, tokenPos, tokenString, values, withSyncModeDo, _, _false, _identity, _ref, _true;
