...
},{"./base":1,"./lodash.min":3,"./peer":4,"./proto":5,"./transport":6}],3:[function(require,module,exports){
(function(global){/*!
...
(function() {
  ...
  exports.Peer = Peer = (function() {
    ...
    Peer.prototype.removeTree = function(key, value) {
    ...
    Peer.prototype.setsForTree = function(msg) {
      ...
      _results = [];
      for (i = _i = 4, _ref1 = msg.length - 2; _i <= _ref1; i = _i += 2) {
        _results.push(['set', msg[i], msg[i + 1]]);
      }
      return _results;
    };
  ...
  DelegationHandler = (function() {
    ...
    DelegationHandler.prototype.removeTree = function(reqId, cmd) {};
...
},{"./base":1,"./lodash.min":3,"./proto":5}],5:[function(require,module,exports){
// Generated by CoffeeScript 1.6.3
(function() {
...
},{"./base":1,"./lodash.min":3,"./transport":6}],6:[function(require,module,exports){
(function(process){// Generated by CoffeeScript 1.6.3
(function() {
  var CometClientConnection, CometConnection, Connection, ConnectionEndpoint, JSONCodec, ProxyMux, SocketConnection, WebSocketConnection, XusEndpoint, d, deadComets, error_bad_connection, exports, _,
...
},{"./base":1,"./lodash.min":3,"./proto":5,"__browserify_process":7}],7:[function(require,module,exports){
