...
(function() {
  var Leisure_anno, Leisure_apply, Leisure_lambda, Leisure_let, Leisure_lit, Leisure_ref, Nil, addUniq, basicRunMonad, cons, consFrom, define, dumpAnno, gen, genApplyArg, genLets, genUniq, getAnnoBody, getAnnoData, getAnnoName, getApplyArg, getApplyFunc, getLambdaBody, getLambdaVar, getLastLetBody, getLetBody, getLetName, getLetValue, getLitVal, getRefName, letList, makeMonad, memoize, nameSub, root, runMonad, setDataType, setType, uniqName, varNameSub, _, _false, _ref, _ref1;
  ...
  _ref1 = require('./runtime'), makeMonad = _ref1.makeMonad, runMonad = _ref1.runMonad, basicRunMonad = _ref1.basicRunMonad, _false = _ref1._false;
  ...
  define('runAst', function() {
    return function(ast) {
      return makeMonad(function(env, cont) {
        ...
        return basicRunMonad(result, env, cont);
      });
    };
  });
