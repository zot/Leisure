...
(function() {
  var L_parens, L_parseErr, L_token, Nil, addDelimiter, anno, apply, arity, ast2Json, chainApply, charCodes, checkSetDataType, cleanTokens, compileFile, compileLine, cons, consFrom, createAnno, createApply, createAst, createDef, createLambda, createLet, createLitOrRef, createSublets, defPat, defaultEnv, define, delimiterList, delimiterListPrefix, delimiterPat, delimiters, ensureLeisureClass, gen, genLine, getLetLambda, getLetNames, getNameAndDef, head, identity, isParens, isToken, isTokenStart, isTokenString, jsonForFile, lambda, lexEnd, linesForFile, lit, llet, loc, makeDelimterPat, makeMoreTokens, makeTokens, myEval, namesForLines, parens, parensContent, parensEnd, parensFromToks, parensStart, parse, parseErr, parseErrMsg, parseGroup, parseIndent, parseLine, parseString, parseToAst, parseTok, parseToks, position, ref, root, runMonad, scanLine, setDataType, setDataTypeAnno, setType, setTypeAnno, splitTokens, strip, stripParens, tail, tokListStr, token, tokenPos, tokenString, tokens, transformDef, withCons, withParens, withToken, _, _ref, _ref1,
  ...
  compileLine = function(str, names, isDef, isExpr) {
    return genLine(str, names, (function(code) {
      return runMonad(myEval("(" + code + ")"), defaultEnv, isDef);
    }), (function(code) {
      return runMonad(myEval("(" + code + ")"), defaultEnv, isExpr);
    }));
  };
