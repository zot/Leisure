...
(function() {
  ...
  define(['./domCursor', 'fingertree', 'immutable', './advice', 'lodash'], function(DOMCursor, Fingertree, Immutable, Advice, _) {
    ...
    LeisureEditCore = (function(superClass) {
      ...
      LeisureEditCore.prototype.domCursorForDocOffset = function(dOff, visual) {
        var bOff, cur, node;
      ...
      LeisureEditCore.prototype.triggerMoved = function(pos) {
      ...
      LeisureEditCore.prototype.oldMoveForward = function() {
