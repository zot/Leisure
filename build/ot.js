...
(function() {
  define(['./lib/fingertree', './lib/lodash.min', './testing'], function(Fingertree, _, Testing) {
    var ConcurrentReplacements, SequentialReplacements, addOperation, addOperations, assert, assertEq, buildReplacementTest, computeNodeEffect, concurrentReplacements, isReplace, mergeRepl, newNode, replacementsString, runReplacements, sequentialReplacements, sortReplacements, tests;
    ...
    ConcurrentReplacements = (function() {
      ...
      ConcurrentReplacements.prototype.eachOperation = function(func) {
        var i, len, node, offset, ref, ref1, repl, results, t;
        offset = 0;
        t = this.replacements;
        results = [];
        while (!t.isEmpty()) {
    ...
    buildReplacementTest = function() {
      ...
      return {
        ...
        dump: function() {
          return console.log(replacementsString(reps));
        }
      };
    };
    tests = function() {
      ...
      return buildReplacementTest().replace(63, 63, "a").replace(60, 60, "a").replace(59, 59, "a").dump();
    };
    return {
