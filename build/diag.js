...
(function() {
  define(['cs!./editor.litcoffee'], function(Editor) {
    var bindCount, checkStructure, createEditorDisplay, createStructureDisplay, displayStructure, getBlockLine, last, lineInfo, numSpan, posFor, structureInfo;
    bindCount = 0;
    ...
    displayStructure = function(data, div) {
      return $(div).html(structureInfo(data).description);
    };
