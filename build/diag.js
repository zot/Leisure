...
(function() {
  define(['cs!./editor.litcoffee', 'cs!./editorSupport.litcoffee', 'cs!./export.litcoffee'], function(Editor, EditorSupport, Exports) {
    var bindCount, checkStructure, createEditorDisplay, createStructureDisplay, displayStructure, editorForToolbar, errorDisplay, escapeHtml, getBlockLine, getDiagShowing, last, lineInfo, mergeExports, numSpan, posFor, showDiag, showStructureErrors, structureInfo;
    bindCount = 0;
