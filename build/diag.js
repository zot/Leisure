...
(function() {
  define(['cs!./editor.litcoffee', 'cs!./editorSupport.litcoffee', 'cs!./export.litcoffee'], function(Editor, EditorSupport, Exports) {
    var bindCount, checkStructure, createEditorDisplay, createStructureDisplay, displayStructure, editorForToolbar, escapeHtml, getBlockLine, getDiagShowing, last, lineInfo, mergeExports, numSpan, posFor, showDiag, structureInfo;
    bindCount = 0;
    ...
    displayStructure = function(data, div) {
      return $(div).html(escapeHtml(structureInfo(data).description));
    };
