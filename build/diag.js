...
(function() {
  define(['cs!./editor.litcoffee'], function(Editor) {
    var bindCount, checkStructure, createEditorDisplay, createStructureDisplay, displayStructure, escapeHtml, getBlockLine, last, lineInfo, numSpan, posFor, structureInfo;
    bindCount = 0;
