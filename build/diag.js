...
(function() {
  ...
  define(['./editor', './editorSupport'], function(Editor, EditorSupport) {
    ...
    Object.assign(Leisure, {showDiag, getDiagShowing});
    return {createStructureDisplay, createEditorDisplay, structureInfo, showDiag, getDiagShowing, diagMessage};
  });
