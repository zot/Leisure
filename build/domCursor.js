...
(function() {
  ...
  define(function() {
    ...
    DOMCursor = (function() {
      ...
      DOMCursor.prototype.scrollIntoViewIfNeeded = function() {
      ...
      DOMCursor.prototype.forwardChars = function(count, contain, containIfSpace) {
        var n, skipped;
        n = this;
        count += this.pos;
      ...
      DOMCursor.prototype.skipToFrontOfSpace = function(force) {
        var n, ref;
      ...
      DOMCursor.prototype.filterVisibleNodes = function() {
        return this.addFilter(function(n) {
      ...
      DOMCursor.prototype.getText = function(len) {
        var n, t;
      ...
      DOMCursor.prototype.backwardChar = function(spanSpace) {
        var oldNode, p, ref;
        p = this;
        oldNode = this.node;
