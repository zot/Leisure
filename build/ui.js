...
(function() {
  ...
  define(['handlebars', './editor', './coffee-script', 'immutable'], function(Handlebars, Editor, CoffeeScript, Immutable) {
    ...
    nextImageSrc = function(src) {
      var hashLoc, ref, ref1, ref2, slide;
      if ((ref = (slide = (ref1 = root.context) != null ? (ref2 = ref1.currentView) != null ? ref2.closest('.slideholder') : void 0 : void 0)) != null ? ref.length : void 0) {
    ...
    dontRerender = function(view, func) {
      var oldDonts, ref, ref1;
      if (view) {
        oldDonts = (ref = (ref1 = root.context) != null ? ref1.dontRender : void 0) != null ? ref : new Set();
        return mergeContext({
    ...
    Handlebars.registerHelper('find', function(...name) {
      var data, item, items, j, len, options, ref, ref1, res;
      ref = name, [...name] = ref, [options] = splice.call(name, -1);
    ...
    Handlebars.registerHelper('findReverse', function(...name) {
      var data, item, items, j, len, options, ref, ref1, res;
      ref = name, [...name] = ref, [options] = splice.call(name, -1);
      data = options.data.opts.data;
      items = name.length === 1 ? data.find(name[0]) : data.find(name[0], name[1]);
    ...
    bindView = function(view, block) {
      var i, index, input, j, len, name, opts, parent, path, ref, ref1, results;
      if (!(opts = (ref = findEditor(view)) != null ? ref.options : void 0)) {
        return;
      }
      ref1 = $(view).find('input[data-value]');
      results = [];
    ...
    renderView = function(type, contextName, data, targets, block, blockName, addIds, extraAttrs) {
      var attr, attrs, classAttr, isTop, j, key, len, node, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, requestedKey, results, settings, template, value;
      if (!block && ((ref = root.context) != null ? (ref1 = ref.currentBlock) != null ? ref1.yaml : void 0 : void 0) === data) {
        block = (ref2 = root.context) != null ? ref2.currentBlock : void 0;
      }
      blockName = blockName != null ? blockName : block != null ? block.codeName : void 0;
      isTop = !((ref3 = root.context) != null ? ref3.topView : void 0);
      ...
      classAttr = 'view';
      ref5 = (ref4 = root.context.viewAttrs) != null ? ref4 : {};
      for (attr in ref5) {
        value = ref5[attr];
        if (attr === 'class') {
          classAttr += ` ${value}`;
      ...
      if (targets) {
        ...
        for (j = 0, len = targets.length; j < len; j++) {
          node = targets[j];
          if ((ref6 = root.context) != null ? (ref7 = ref6.dontRender) != null ? ref7.has(node) : void 0 : void 0) {
            continue;
          }
          settings.view = node;
    ...
    runTemplate = function(template, ...args) {
      var err, ref;
      try {
    ...
    activateScripts = function(el, context, data, block) {
      if (!activating) {
        ...
        return withContext(_.merge({
          ...
          var err, img, j, l, len, len1, len2, len3, m, newScript, node, o, ref, ref1, ref2, ref3, results, script;
