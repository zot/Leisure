...
(function() {
  define(['handlebars'], function(Handlebars) {
    var activateScripts, activating, addController, addView, compile, controllers, create, getView, hasView, initializePendingViews, mergeContext, pendingViews, registerHelper, removeController, removeView, renderView, root, simpleRenderView, templates, viewIdCounter, viewKey, withContext;
