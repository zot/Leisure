...
(function() {
  define(['handlebars', 'cs!./export.litcoffee', 'cs!./editor.litcoffee'], function(Handlebars, Exports, Editor) {
    var activateScripts, activating, addController, addView, compile, configurePanels, controllers, create, escapeAttr, escapeHtml, getPanel, getPendingViews, getView, hasView, imageRefreshCounter, initializePendingViews, mergeContext, mergeExports, nextImageSrc, pendingViews, prevImageSrc, pushPendingInitialzation, refreshImage, registerHelper, removeController, removeView, renderView, root, setPanelExpanded, showMessage, simpleRenderView, templates, viewIdCounter, viewKey, withContext;
      ...
      if (!activating) {
        return withContext(_.merge({}, context), function() {
          ...
          try {
            ...
            if ((ref2 = controllers[$(el).attr('data-view')]) != null) {
