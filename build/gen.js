...
(function() {
  ...
  define(['./base', './ast', './runtime', 'lib/lodash.min', 'lib/source-map'], function(Base, Ast, Runtime, _, SourceMap) {
    ...
    lz = lazy;
    lc = Leisure_call;
    nameSub = Ast.nameSub, getLitVal = Ast.getLitVal, getRefName = Ast.getRefName, getLambdaVar = Ast.getLambdaVar, getLambdaBody = Ast.getLambdaBody, getApplyFunc = Ast.getApplyFunc, getApplyArg = Ast.getApplyArg, getAnnoName = Ast.getAnnoName, getAnnoData = Ast.getAnnoData, getAnnoBody = Ast.getAnnoBody, getLetName = Ast.getLetName, getLetValue = Ast.getLetValue, getLetBody = Ast.getLetBody, Leisure_lit = Ast.Leisure_lit, Leisure_ref = Ast.Leisure_ref, Leisure_lambda = Ast.Leisure_lambda, Leisure_apply = Ast.Leisure_apply, Leisure_let = Ast.Leisure_let, Leisure_anno = Ast.Leisure_anno, setType = Ast.setType, setDataType = Ast.setDataType, cons = Ast.cons, Nil = Ast.Nil, define = Ast.define, functionInfo = Ast.functionInfo, getPos = Ast.getPos, isNil = Ast.isNil;
    ...
    ref1 = SourceMap.sourceMap, SourceNode = ref1.SourceNode, SourceMapConsumer = ref1.SourceMapConsumer;
