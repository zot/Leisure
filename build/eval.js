...
(function() {
  define(['cs!./base', 'cs!./ast', 'cs!./runtime', 'acorn', 'acorn_walk', 'acorn_loose', './lib/lispyscript/browser-bundle'], function(Base, Ast, Runtime, Acorn, AcornWalk, AcornLoose, LispyScript) {
