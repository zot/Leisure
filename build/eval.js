...
(function() {
  ...
  define(['./base', './ast', './runtime', 'acorn', 'acorn_walk', './lib/lispyscript/browser-bundle', './coffee-script'], function(Base, Ast, Runtime, Acorn, AcornWalk, LispyScript, CS) {
    var Html, Node, _true, acorn, acornLoose, acornWalk, blockVars, cons, csEnv, defaultEnv, define, errorDiv, escapeHtml, findError, getType, getValue, handleErrors, html, isError, jsEnv, jsEval, jsonConvert, knownLanguages, languageEnvMaker, lazy, lc, leisureEnv, lispyScript, localEval, lsEnv, lz, makeHamt, makeSyncMonad, newConsFrom, presentHtml, replacements, resolve, runMonad, runMonad2, runNextResult, rz, setValue, unescapePresentationHtml, walk, writeValues;
    acorn = Acorn;
    acornWalk = AcornWalk;
    acornLoose = null;
    setTimeout((function() {
