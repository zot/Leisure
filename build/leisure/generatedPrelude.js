define([], function(){
  ...
  return resolve(L_and)(function(){"use strict";return resolve(L_eq)(L_newH_0, function(){"use strict";return resolve(L_head)(L_l);});}, function(){"use strict";return resolve(L_eq)(L_newT_1, function(){"use strict";return resolve(L_tail)(L_l);});})(L_l)(function(){"use strict";return resolve(L_cons)(L_newH_0, L_newT_1);})})();});
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return L$(resolve(L_func))(L_h, function(){"use strict";return resolve(L_foldr)(L_func, L_initialValue, L_t);})}}}), L_initialValue);
})))},
  ...
  return resolve(L_merge)(L_cmp, function(){"use strict";return resolve(L_mergeSort)(L_cmp, L_e_1);}, function(){"use strict";return resolve(L_mergeSort)(L_cmp, L_o_2);})})();})}}}), L_nil);
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return (function(){"use strict";
  ...
  return resolve(L_isNil)(L_list)(L_false)(function(){"use strict";return L$(resolve(L_func))(function(){"use strict";return resolve(L_head)(L_list);}, L_nil, function(){"use strict";return resolve(L_$p$p)(L_ret_0, L_false)(L_false)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_list);}, L_ret_0);});});})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isTokenString)(L_h, "|")(function(){"use strict";return resolve(L_cons)(L_t, L_nil);})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)(L_op, function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_listifyOp)(L_op, L_t);});});}, L_nil);})}}}), function(){"use strict";return resolve(L_cons)("nil", L_nil);});
})))},
  ...
  L_accEq_3 = function(){"use strict";return L$(resolve(L_at))(L_acc_0, 1);};
  ...
  return resolve(L_not)(function(){"use strict";return resolve(L_$h$h)(function(){"use strict";return resolve(L_isCons)(L_value_1);})(function(){"use strict";return resolve(L_$q$q)(function(){"use strict";return resolve(L_isNil)(L_acc_0);})(function(){"use strict";return resolve(L_$h$h)(function(){"use strict";return resolve(L_$z)(function(){"use strict";return resolve(L_length)(L_acc_0);}, 2);})(function(){"use strict";return resolve(L_isTokenString)(L_accEq_3, "=");});});});})(function(){"use strict";return resolve(L_err)("Fold clause expects VAR <-| ACC_VAR = ACC_VALUE | VALUE or VAR <-| | VALUE");})(function(){"use strict";return resolve(L_triple)(L_false, L_accVar_2, lazy(function(L_rest){return L$(resolve(L_inLet))(function(){"use strict";return resolve(L_cons)(".");}, L_id, function(){"use strict";return resolve(L_cons)("bind2", function(){"use strict";return resolve(L_cons)(L_accInit_4, function(){"use strict";return resolve(L_cons)(L_value_1, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)("\\", function(){"use strict";return resolve(L_cons)(L_accVar_2, function(){"use strict";return resolve(L_cons)(L_var, function(){"use strict";return resolve(L_cons)(".", L_rest);});});});}, L_nil);});});});})}));})})();
})))},
