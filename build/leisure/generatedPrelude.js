define([], function(){
  return L_runMonads([
    ...
    function(){return resolve(L_newDefine)("recur", 1, "recur x = \\f . f x", lazy(setDataType(function(L_x){return setType(function(L_f){return resolve(L_f)(L_x)}, 'recur')}, 'recur')))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_isCons)(L_l)(function(){return resolve(L_cons)(function(){return resolve(L_func)(function(){return resolve(L_head)(L_l);});}, function(){return resolve(L_map)(L_func, function(){return resolve(L_tail)(L_l);});});})(L_l);
})))},
  ...
  return resolve(L_parens)(L_start_0, L_end_1, L_content)})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_reverse)(function(){return resolve(L_withRecur)(function(){return resolve(L__basicSplitTokens)(L_str, L_pat, L_prevIsDel, L_nil);});});
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_$p$p)(L_str, "")(L_toks)(function(){return (function(){
  ...
  return resolve(L_recur)(function(){return resolve(L__basicSplitTokens)(function(){return resolve(L_strSubstring)(L_str, function(){return resolve(L_strLen)(L_first_5);}, 0);}, L_pat, function(){return resolve(L_select_4)(L_true)(L_false)(L_false);}, function(){return resolve(L_cons)(L_first_5, L_toks);});})})();});
})))},
  ...
  return resolve(L_hasType)(L_res_0, L_parseErr)(L_parseErr)(function(){return resolve(L_cont)(L_res_0);})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_eq)(L_str, "")(L_str)(function(){return resolve(L_eq)(function(){return resolve(L_strAt)(L_str, 0);}, "\\")(function(){return resolve(L_eq)(function(){return resolve(L_strLen)(L_str);}, 1)(function(){return resolve(L_parseErr)("Error, backslash without character in string: ", L_orig);})(function(){return (function(){
  var L_rest_0;
  L_rest_0 = function(){return resolve(L__convertStringEscapes)(L_orig, function(){return resolve(L_strSubstring)(L_str, 2, 0);});};

  return resolve(L_hasType)(L_rest_0, L_parseErr)(L_rest_0)(function(){return resolve(L_strAdd)(function(){return resolve(L_convertStringEscape)(function(){return resolve(L_strAt)(L_str, 1);}, L_backslashCodes, L_backslashValues);}, L_rest_0);})})();});})(function(){return (function(){
  var L_rest_0;
  ...
  return resolve(L_isTokenString)(L_slash_0, "\\")(function(){return resolve(L_cons)(L_slash_0, function(){return resolve(L_cons)(L_var_1, function(){return resolve(L_isTokenString)(L_dot_3, ".")(function(){return resolve(L_cons)(L_dot_3, function(){return resolve(L_addProps)(L_props, L_body_4);});})(function(){return resolve(L_cons)(".", function(){return resolve(L_addProps)(L_props, L_afterVar_2);});});});});})(function(){return resolve(L_cons)(function(){return resolve(L_head)(L_ast);}, function(){return resolve(L_subSpliceFuncProps)(L_props, function(){return resolve(L_tail)(L_ast);});});})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_reverse)(function(){return resolve(L_withRecur)(function(){return resolve(L__countedLines)(L_filename, L_lineOffset, L_str, L_nil);});});
})))},
  ...
  return resolve(L_eq)(L_str, "")(L_lines)(function(){return resolve(L_isNil)(L_m_0)(function(){return resolve(L_cons)(function(){return resolve(L_cons)(function(){return resolve(L_cons)(L_filename, function(){return resolve(L_cons)(L_lineOffset, function(){return resolve(L_tail)(function(){return resolve(L_findLines)(0, L_str);});});});}, L_str);}, L_lines);})(function(){return resolve(L_recur)(function(){return resolve(L__countedLines)(L_filename, function(){return resolve(L_$o)(L_lineOffset, function(){return resolve(L_length)(L_chunkLines_4);});}, function(){return resolve(L_strSubstring)(L_str, L_next_3, 0);}, function(){return resolve(L_cons)(function(){return resolve(L_cons)(function(){return resolve(L_cons)(L_filename, function(){return resolve(L_cons)(L_lineOffset, function(){return resolve(L_tail)(L_chunkLines_4);});});}, L_chunk_2);}, L_lines);});});});})})();
})))},
  ...
  return resolve(L_isNil)(L_m_0)(L_result)(function(){return resolve(L_cons)(function(){return resolve(L_head)(function(){return resolve(L_tail)(L_m_0);});}, L_result);})})()}}), L_nil, L_lines)}))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_filters)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){return resolve(L_h)(L_line);}, lazy(function(L_filtered){return resolve(L_runParseFilters)(L_t, L_filtered)}))}}}))(function(){return resolve(L_fakereturn)(L_line);});
})))},
  ...
  return resolve(L_isEmptyPos)(L_posStart_0)(function(){return resolve(L_cons)(function(){return resolve(L_postProcessMacro)(L_before, function(){return resolve(L_position)(L_t2_2);}, L_h);}, L_t2_2);})(function(){return resolve(L_cons)(L_h2_3, function(){return resolve(L_postProcessMacro)(function(){return resolve(L_addFilepos)(function(){return resolve(L_lexEnd)(L_h2_3);}, 1);}, L_after, L_t);});})})();})}}));})(function(){return resolve(L_isNumber)(L_expr)(function(){return resolve(L_token)(function(){return resolve(L_strString)(L_expr);}, function(){return resolve(L_isEmptyPos)(L_after)(L_before)(L_after);});})(L_expr);});});});
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_primBind)(function(){return resolve(L_getValue)("macroDefs");}, lazy(function(L_macs){return resolve(L_setValue)("macroDefs", function(){return resolve(L_acons)(L_name, L_def, L_macs);})}));
})))},
    ...
    function(){return resolve(L_newDefine)("addToken", 1, "addToken del = primBind (getValue 'tokenList')\r\n  \\dels . contains dels del\r\n    false\r\n    \\\\\r\n      newDels = insertSorted (\\a b . > (strLen a) (strLen b)) del dels\r\n      .\r\n      primBind (setValue 'tokenList' newDels)\r\n        \\_ . computeTokenPat newDels", lazy(function(L_del){return resolve(L_primBind)(function(){return resolve(L_getValue)("tokenList");}, lazy(function(L_dels){return resolve(L_contains)(L_dels, L_del)(L_false)(function(){return (function(){
  var L_newDels_0;
  ...
  return resolve(L_primBind)(function(){return resolve(L_setValue)("tokenList", L_newDels_0);}, lazy(function(L__){return resolve(L_computeTokenPat)(L_newDels_0)}))})();})}))}))},
  ...
  return resolve(L_setValue)("tokenPat", L_newPat_1)})()}))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_primBind)(function(){return resolve(L_addToken)(L_open);}, lazy(function(L__){return resolve(L_primBind)(function(){return resolve(L_addToken)(L_close);}, lazy(function(L___0){return resolve(L_primBind)(function(){return resolve(L_getValue)("tokenGroups");}, lazy(function(L_gr){return resolve(L_setValue)("tokenGroups", function(){return resolve(L_acons)(L_open, L_close, L_gr);})}))}))}));
})))},
    ...
    function(){return resolve(L_newDefine)("parseM", 1, "parseM str =\r\n  primBind (getValue 'tokenPat')\r\n    \\tokPat . primBind (getValue 'tokenGroups')\r\n      \\groups . parseG str tokPat groups", lazy(function(L_str){return resolve(L_primBind)(function(){return resolve(L_getValue)("tokenPat");}, lazy(function(L_tokPat){return resolve(L_primBind)(function(){return resolve(L_getValue)("tokenGroups");}, lazy(function(L_groups){return resolve(L_parseG)(L_str, L_tokPat, L_groups)}))}))}))},
    ...
    function(){return resolve(L_newDefine)("parseLineM", 1, "parseLineM str = primBind (getValue 'tokenPat')\r\n  \\tokPat . primBind (getValue 'tokenGroups')\r\n    \\groups . parseLineG str tokPat nil groups id id", lazy(function(L_str){return resolve(L_primBind)(function(){return resolve(L_getValue)("tokenPat");}, lazy(function(L_tokPat){return resolve(L_primBind)(function(){return resolve(L_getValue)("tokenGroups");}, lazy(function(L_groups){return resolve(L_parseLineG)(L_str, L_tokPat, L_nil, L_groups, L_id, L_id)}))}))}))},
    function(){return resolve(L_newDefine)("macroSubM", 1, "macroSubM expr =\r\n  primBind (getValue 'macroDefs')\r\n    \\macs . macroSub macs expr", lazy(function(L_expr){return resolve(L_primBind)(function(){return resolve(L_getValue)("macroDefs");}, lazy(function(L_macs){return resolve(L_macroSub)(L_macs, L_expr)}))}))},
    function(){return resolve(L_newDefine)("macroParse", 1, "macroParse str =\r\n  primBind (parseM str)\r\n    \\ex . macroSubM ex", lazy(function(L_str){return resolve(L_primBind)(function(){return resolve(L_parseM)(L_str);}, lazy(function(L_ex){return resolve(L_macroSubM)(L_ex)}))}))},
    function(){return resolve(L_newDefine)("tokensM", 1, "tokensM str =\r\n  primBind (getValue 'tokenPat')\r\n    \\delimiterPat . tokens str delimiterPat", lazy(function(L_str){return resolve(L_primBind)(function(){return resolve(L_getValue)("tokenPat");}, lazy(function(L_delimiterPat){return resolve(L_tokens)(L_str, L_delimiterPat)}))}))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_lines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){return resolve(L_parseLineM)(L_h);}, lazy(function(L_ast){return resolve(L_parseLines)(L_t, function(){return resolve(L_cons)(L_ast, L_result);})}))}}}))(function(){return resolve(L_reverse)(L_result);});
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_primBind)(function(){return resolve(L_getValue)("tokenPat");}, lazy(function(L_tokenPat){return resolve(L_primBind)(function(){return resolve(L_getValue)("tokenGroups");}, lazy(function(L_groups){return resolve(L_primBind)(function(){return resolve(L_getValue)("parseFilters");}, lazy(function(L_filters){return resolve(L_primBind)(function(){return resolve(L_getValue)("macroDefs");}, lazy(function(L_macros){return resolve(L_primBind)(function(){return resolve(L_getValue)("parser_funcProps");}, lazy(function(L_props){return resolve(L_primBind)(function(){return resolve(L_runParseFilters)(L_filters, function(){return resolve(L_countedScanLineG)(L_lineStarts, L_line, L_tokenPat, L_groups, L_props, L_id, L_id);});}, lazy(function(L_scanned){return resolve(L_macroSub)(L_macros, L_scanned)}))}))}))}))}))}));
})))},
  ...
  return resolve(L_eq)(L_m_0, L_nil)(function(){return resolve(L_cons)(L_offset, L_nil);})(function(){return resolve(L_cons)(L_offset, function(){return resolve(L_findLines)(function(){return resolve(L_$o)(L_offset, L_idx_1);}, function(){return resolve(L_strSubstring)(L_line, L_idx_1, 0);});});})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_primBind)(function(){return resolve(L_scanLineM)(L_line);}, lazy(function(L_scanned){return resolve(L_ifNotErr)(function(){return resolve(L_createAst)(function(){return resolve(L_cons)("NEWPARSE.lsr", function(){return resolve(L_findLines)(L_offset, L_line);});}, L_scanned, L_names);}, L_id)}));
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_primBind)(function(){return resolve(L_countedScanLineM)(function(){return resolve(L_head)(L_countedLine);}, function(){return resolve(L_tail)(L_countedLine);});}, lazy(function(L_scanned){return resolve(L_createAst)(function(){return resolve(L_head)(L_countedLine);}, L_scanned, L_names)}));
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_primBind)(function(){return resolve(L_newParseLine)(L_offset, L_names, L_line);}, lazy(function(L_ast){return resolve(L_primBind)(function(){return resolve(L_runAst)(L_line)(L_ast);}, lazy(function(L_res){return resolve(L_primBind)(L_res, lazy(function(L_result){return resolve(L_cons)(L_ast, function(){return resolve(L_isErr)(L_result)(function(){return resolve(L_left)(function(){return resolve(L_errMsg)(L_result);});})(function(){return resolve(L_right)(L_result);});})}))}))}));
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_primBind)(function(){return resolve(L_countedParseLine)(L_names, L_countedLine);}, lazy(function(L_ast){return (function(){
  var L_wrapped_0;
  L_wrapped_0 = function(){return resolve(L_astFileWrap)(L_file, L_ast);};

  return resolve(L_primBind)(function(){return resolve(L_runAst)(function(){return resolve(L_tail)(L_countedLine);})(L_wrapped_0);}, lazy(function(L_res){return resolve(L_primBind)(L_res, lazy(function(L_result){return resolve(L_resultOfRun)(L_wrapped_0, L_result)}))}))})()}));
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_lines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){return resolve(L_runLine)(0, L_names, L_h);}, lazy(function(L_line){return resolve(L_primBind)(function(){return resolve(L_runLines)(L_names, L_t);}, lazy(function(L_rest){return resolve(L_cons)(L_line, L_rest)}))}))}}}))(L_nil);
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_countedLines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){return resolve(L_countedRunLine)(L_file, L_names, L_h);}, lazy(function(L_line){return resolve(L_countedRunLines)(L_file, L_names, L_t, function(){return resolve(L_cons)(L_line, L_result);})}))}}}))(function(){return resolve(L_reverse)(L_result);});
})))},
  ...
  return resolve(L_countedRunLines)(L_name, L_names_2, L_counted_0, L_nil)})();
    ...
    function(){return resolve(L_newDefine)("baseLoad", 1, "baseLoad file = primBind (readFile file)\r\n  \\result . result\r\n    \\err . err\r\n    \\contents . baseLoadString file contents", lazy(function(L_file){return resolve(L_primBind)(function(){return resolve(L_readFile)(L_file);}, lazy(function(L_result){return resolve(L_result)(lazy(function(L_err){return resolve(L_err)}))(lazy(function(L_contents){return resolve(L_baseLoadString)(L_file, L_contents)}))}))}))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_primBind)(function(){return resolve(L_getValue)("activeTokenPacks");}, lazy(function(L_activePacks){return resolve(L_primBind)(L_resetStdTokenPacks, lazy(function(L__){return resolve(L_primBind)(L_resetNameSpaceInfo, lazy(function(L_nsInfo){return resolve(L_primBind)(function(){return resolve(L_runNamedFile)(L_file, L_contents);}, lazy(function(L_result){return resolve(L_primBind)(function(){return resolve(L_setNameSpaceInfo)(L_nsInfo);}, lazy(function(L___0){return resolve(L_primBind)(function(){return resolve(L_isNil)(L_activePacks)(L_resetStdTokenPacks)(function(){return resolve(L_resetTokenPacks)(L_activePacks);});}, lazy(function(L___1){return resolve(L_result)}))}))}))}))}))}));
})))},
    function(){return resolve(L_newDefine)("load", 1, "load file = primBind (baseLoad file)\r\n  \\result . \\\\\r\n    errs = foldr (\\line results . tail line (\\er . cons er results) (\\x . results)) nil result\r\n    .\r\n    isNil errs\r\n      right true\r\n      left errs", lazy(function(L_file){return resolve(L_primBind)(function(){return resolve(L_baseLoad)(L_file);}, lazy(function(L_result){return (function(){
  var L_errs_0;
  ...
  return resolve(L_isNil)(L_errs_0)(function(){return resolve(L_right)(L_true);})(function(){return resolve(L_left)(L_errs_0);})})()}))}))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_countedLines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){return resolve(L_countedScanLineM)(function(){return resolve(L_head)(L_h);}, function(){return resolve(L_tail)(L_h);});}, lazy(function(L_line){return resolve(L_primBind)(function(){return resolve(L_countedScanLines)(L_file, L_names, L_t);}, lazy(function(L_rest){return resolve(L_cons)(L_line, L_rest)}))}))}}}))(L_nil);
})))},
  ...
  return resolve(L_primBind)(function(){return resolve(L_setValue)("tokenList", L_newToks_1);}, lazy(function(L__){return resolve(L_primBind)(function(){return resolve(L_setValue)("tokenGroups", function(){return resolve(L_appendAlist)(function(){return resolve(L_head)(function(){return resolve(L_tail)(L_pack);});}, L_groups);});}, lazy(function(L___2){return resolve(L_primBind)(function(){return resolve(L_setValue)("parseFilters", function(){return resolve(L_append)(L_filters, function(){return resolve(L_head)(function(){return resolve(L_tail)(function(){return resolve(L_tail)(L_pack);});});});});}, lazy(function(L___3){return resolve(L_primBind)(function(){return resolve(L_computeTokenPat)(L_newToks_1);}, lazy(function(L___4){return resolve(L_setValue)("activeTokenPacks", function(){return resolve(L_cons)(L_name, L_activePacks);})}))}))}))}))})()}))(L_nil)}))}))}))}))}))}))},
    function(){return resolve(L_newDefine)("resetTokenPacks", 1, "resetTokenPacks packs = primBind (setValue 'tokenGroups' nil)\r\n  \\_ . primBind (setValue 'tokenList' nil)\r\n    \\_ . primBind (setValue 'activeTokenPacks' nil)\r\n      \\_ . primBind (setValue 'parseFilters' nil)\r\n        \\_ . foldr1\r\n          \\packCmd result . primBind packCmd \\_ . result\r\n          map useTokenPack packs", lazy(function(L_packs){return resolve(L_primBind)(function(){return resolve(L_setValue)("tokenGroups", L_nil);}, lazy(function(L__){return resolve(L_primBind)(function(){return resolve(L_setValue)("tokenList", L_nil);}, lazy(function(L___0){return resolve(L_primBind)(function(){return resolve(L_setValue)("activeTokenPacks", L_nil);}, lazy(function(L___1){return resolve(L_primBind)(function(){return resolve(L_setValue)("parseFilters", L_nil);}, lazy(function(L___2){return resolve(L_foldr1)(lazy(function(L_packCmd){return function(L_result){return resolve(L_primBind)(L_packCmd, lazy(function(L___3){return resolve(L_result)}))}}), function(){return resolve(L_map)(L_useTokenPack, L_packs);})}))}))}))}))}))},
    function(){return resolve(L_newDefine)("resetStdTokenPacks", 0, "resetStdTokenPacks = primBind (getValue 'stdTokenPacks')\r\n  \\stds . primBind (resetTokenPacks stds)\r\n    \\_ . setValue 'activeTokenPacks' nil", function(){return resolve(L_primBind)(function(){return resolve(L_getValue)("stdTokenPacks");}, lazy(function(L_stds){return resolve(L_primBind)(function(){return resolve(L_resetTokenPacks)(L_stds);}, lazy(function(L__){return resolve(L_setValue)("activeTokenPacks", L_nil)}))}));})},
    function(){return resolve(L_newDefine)("addStdTokenPacks", 1, "addStdTokenPacks morePacks = primBind (getValue 'stdTokenPacks')\r\n  \\stds . setValue 'stdTokenPacks' (append stds morePacks)", lazy(function(L_morePacks){return resolve(L_primBind)(function(){return resolve(L_getValue)("stdTokenPacks");}, lazy(function(L_stds){return resolve(L_setValue)("stdTokenPacks", function(){return resolve(L_append)(L_stds, L_morePacks);})}))}))},
    function(){return resolve(L_newDefine)("addParseFilter", 1, "addParseFilter filt = primBind (getValue 'parseFilters')\r\n  \\filters . setValue 'parseFilters' (append filters (cons filt nil))", lazy(function(L_filt){return resolve(L_primBind)(function(){return resolve(L_getValue)("parseFilters");}, lazy(function(L_filters){return resolve(L_setValue)("parseFilters", function(){return resolve(L_append)(L_filters, function(){return resolve(L_cons)(L_filt, L_nil);});})}))}))},
    ...
    function(){return resolve(L_newDefine)("doall", 1, "doall x = isNil x\n  unit\n  foldr1 (\\el res . primBind el \\_ . res) x", lazy(function(L_x){return resolve(L_isNil)(L_x)(L_unit)(function(){return resolve(L_foldr1)(lazy(function(L_el){return function(L_res){return resolve(L_primBind)(L_el, lazy(function(L__){return resolve(L_res)}))}}), L_x);})}))},
  ...
  return resolve(L_and)(function(){return resolve(L_$z)(L_len, 2);}, function(){return resolve(L_and)(function(){return resolve(L_isInfix)(L_nextPrec_0, L_curArg, L_nextOp, L_len);}, function(){return resolve(L_and)(function(){return resolve(L_or)(function(){return resolve(L_$z)(L_opPrec, L_nextPrec_0);}, function(){return resolve(L_and)(function(){return resolve(L_$p$p)(L_opPrec, L_nextPrec_0);}, L_isRight);});}, function(){return resolve(L_and)(function(){return resolve(L_isInfixArg)(L_closes, L_nextArg);}, L_true);});});})})();
    ...
    function(){return resolve(L_newDefine)("setPrecedenceLevels", 1, "setPrecedenceLevels levels = primBind\n  setValue 'infixPrecedence' levels\n  \\_ . doall (map addInfixProp (flatten levels))", lazy(function(L_levels){return resolve(L_primBind)(function(){return resolve(L_setValue)("infixPrecedence", L_levels);}, lazy(function(L__){return resolve(L_doall)(function(){return resolve(L_map)(L_addInfixProp, function(){return resolve(L_flatten)(L_levels);});})}))}))},
  ...
  L_makeBind_0 = function(){return function(L_var){return function(L_monad){return resolve(L_cont)(L_false)(lazy(function(L_rest){return resolve(L_inLet)(function(){return resolve(L_cons)(".");})(L_id)(function(){return resolve(L_cons)("bind", function(){return resolve(L_cons)(L_monad, function(){return resolve(L_cons)(function(){return resolve(L_cons)("\\", function(){return resolve(L_cons)(L_var, function(){return resolve(L_cons)(".", L_rest);});});}, L_nil);});});})}))}};};
