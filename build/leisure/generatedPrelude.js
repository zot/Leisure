define([], function(){
  ...
  return resolve(L_parens)(L_start_0, L_end_1, L_content)})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_withRecur)(function(){"use strict";return resolve(L_makeMoreTokens)(L_lineStarts, L_strings, L_start, L_nil);});
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_strings)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_recur)(function(){"use strict";return resolve(L_makeMoreTokens)(L_lineStarts, L_t, function(){"use strict";return resolve(L_$o)(L_start, function(){"use strict";return resolve(L_strLen)(L_h);});}, function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_strStartsWith)(L_h, " ");}, function(){"use strict";return resolve(L_strStartsWith)(L_h, "#");});}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_strMatches)(L_h, L_emptyToken);}, function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_isNil)(L_t);}, function(){"use strict";return resolve(L_strMatches)(function(){"use strict";return resolve(L_head)(L_t);}, L_lineStart);});});})(L_result)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_makeTokenAt)(L_lineStarts, L_h, L_start);}, L_result);});});})}}}))(function(){"use strict";return resolve(L_reverse)(L_result);});
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_reverse)(function(){"use strict";return resolve(L_withRecur)(function(){"use strict";return resolve(L__basicSplitTokens)(L_str, L_pat, L_prevIsDel, L_nil);});});
})))},
  ...
  return resolve(L_recur)(function(){"use strict";return resolve(L__basicSplitTokens)(function(){"use strict";return resolve(L_strSubstring)(L_str, function(){"use strict";return resolve(L_strLen)(L_first_5);}, 0);}, L_pat, function(){"use strict";return resolve(L_select_4)(L_true)(L_false)(L_false);}, function(){"use strict";return resolve(L_cons)(L_first_5, L_toks);});})})();});
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_withParens)(L_list, function(){"use strict";return resolve(L_cont)(L_list);}, lazy(function(L_start){return function(L_end){return function(L_content){return resolve(L_withStripped)(L_content, L_cont)}}}));
})))},
  ...
  return resolve(L_isTokenString)(L_slash_0, "\\")(function(){"use strict";return resolve(L_cons)(L_slash_0, function(){"use strict";return resolve(L_cons)(L_var_1, function(){"use strict";return resolve(L_isTokenString)(L_dot_3, ".")(function(){"use strict";return resolve(L_cons)(L_dot_3, function(){"use strict";return resolve(L_addProps)(L_props, L_body_4);});})(function(){"use strict";return resolve(L_cons)(".", function(){"use strict";return resolve(L_addProps)(L_props, L_afterVar_2);});});});});})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_ast);}, function(){"use strict";return resolve(L_subSpliceFuncProps)(L_props, function(){"use strict";return resolve(L_tail)(L_ast);});});})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_reverse)(function(){"use strict";return resolve(L_withRecur)(function(){"use strict";return resolve(L__countedLines)(L_filename, L_lineOffset, L_str, L_nil);});});
})))},
  ...
  return resolve(L_eq)(L_str, "")(L_lines)(function(){"use strict";return resolve(L_isNil)(L_m_0)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)(L_filename, function(){"use strict";return resolve(L_cons)(L_lineOffset, function(){"use strict";return resolve(L_tail)(function(){"use strict";return resolve(L_findLines)(0, L_str);});});});}, L_str);}, L_lines);})(function(){"use strict";return resolve(L_recur)(function(){"use strict";return resolve(L__countedLines)(L_filename, function(){"use strict";return resolve(L_$o)(L_lineOffset, function(){"use strict";return resolve(L_length)(L_chunkLines_4);});}, function(){"use strict";return resolve(L_strSubstring)(L_str, L_next_3, 0);}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)(L_filename, function(){"use strict";return resolve(L_cons)(L_lineOffset, function(){"use strict";return resolve(L_tail)(L_chunkLines_4);});});}, L_chunk_2);}, L_lines);});});});})})();
})))},
  ...
  return resolve(L_and)(function(){"use strict";return resolve(L_$z)(L_len, 2);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_isInfix)(L_nextPrec_0, L_curArg, L_nextOp, L_len);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_$z)(L_opPrec, L_nextPrec_0);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_$p$p)(L_opPrec, L_nextPrec_0);}, L_isRight);});}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_isInfixArg)(L_closes, L_nextArg);}, L_true);});});})})();
    ...
    function(){return resolve(L_defMacro)("do", lazy(function(L_list){return resolve(L_withRecur)(function(){"use strict";return resolve(L_handleDo)(L_list, L_false, L_nil, L_id);})}))},
    function(){return resolve(L_defMacro)("doFold", lazy(function(L_list){return (function(){"use strict";
  var L_first_0, L_foldVar_1, L_eq_2, L_init_3, L_rest_4, L_code_5;
  L_first_0 = function(){"use strict";return resolve(L_stripParens)(function(){"use strict";return resolve(L_head)(function(){"use strict";return resolve(L_stripParens)(L_list);});});};
  L_foldVar_1 = function(){"use strict";return resolve(L_at)(L_first_0)(0);};
  L_eq_2 = function(){"use strict";return resolve(L_at)(L_first_0)(1);};
  L_init_3 = function(){"use strict";return resolve(L_drop)(2)(L_first_0);};
  L_rest_4 = function(){"use strict";return resolve(L_tail)(function(){"use strict";return resolve(L_stripParens)(L_list);});};
  L_code_5 = function(){"use strict";return resolve(L_withRecur)(function(){"use strict";return resolve(L_handleDo)(L_rest_4, L_true, L_foldVar_1, L_id);});};

  return resolve(L_$h$h)(function(){"use strict";return resolve(L_$h$h)(function(){"use strict";return resolve(L_$h$h)(function(){"use strict";return resolve(L_$h$h)(function(){"use strict";return resolve(L_isCons)(function(){"use strict";return resolve(L_stripParens)(L_list);});})(function(){"use strict";return resolve(L_$z)(function(){"use strict";return resolve(L_length)(function(){"use strict";return resolve(L_stripParens)(L_list);});}, 0);});})(function(){"use strict";return resolve(L_isCons)(L_first_0);});})(function(){"use strict";return resolve(L_$z)(function(){"use strict";return resolve(L_length)(L_first_0);}, 2);});})(function(){"use strict";return resolve(L_isTokenString)(L_eq_2, "=");})(function(){"use strict";return resolve(L_ifNotErr)(L_code_5, lazy(function(L_x){return resolve(L_log)(L_x, function(){"use strict";return resolve(L_cons)("\\\\", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(function(){"use strict";return resolve(L_stripParens)(L_list);});}, L_x);});})}));})(function(){"use strict";return resolve(L_parseErr)("Bad initializer in doFold: ", L_list);})})()}))},
    function(){return resolve(L_newDefine)("handleDo", 4, "handleDo list inLet foldVar cont = list\r\n  \\h t D . isNil t\r\n    cont (inLet ['.' h] [h])\r\n    \\\\\r\n      next = doClause (stripParens h) h nil inLet foldVar triple\r\n      newInLet = triple1 next\r\n      newFoldVar = triple2 next\r\n      chain = triple3 next\r\n      .\r\n      recur\r\n        handleDo t newInLet foldVar \\rest . cont (chain rest)\r\n  cont nil", lazy((function(L_list, L_inLet, L_foldVar, L_cont) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
  ...
  L_next_0 = function(){"use strict";return resolve(L_doClause)(function(){"use strict";return resolve(L_stripParens)(L_h);}, L_h, L_nil, L_inLet, L_foldVar, L_triple);};
  ...
  return resolve(L_recur)(function(){"use strict";return resolve(L_handleDo)(L_t, L_newInLet_1, L_foldVar, lazy(function(L_rest){return resolve(L_cont)(function(){"use strict";return resolve(L_chain_3)(L_rest);})}));})})();})}}}))(function(){"use strict";return resolve(L_cont)(L_nil);});
})))},
    function(){return resolve(L_newDefine)("doClause", 6, "doClause steppingClause clause prefix inLet foldVar cont = \\\\\r\n  makeBind var value = cont false foldVar \\rest . inLet (cons '.') id\r\n    isNil foldVar\r\n      ['bind' value ['\\\\' var '.' | rest]]\r\n      ['bind2' foldVar value ['\\\\' foldVar var '.' | rest]]\r\n  h = head steppingClause\r\n  t = tail steppingClause\r\n  .\r\n  isCons steppingClause\r\n    isTokenString h '='\r\n      inLet\r\n        cont true foldVar \\rest . [clause | rest]\r\n        cont true foldVar \\rest . ['\\\\\\\\' clause | rest]\r\n      isTokenString h '<-'\r\n        isNil t\r\n          parseErr \"No monad in do-clause: \" clause\r\n          prefix\r\n            \\ph pt D . isNil pt\r\n              makeBind (isNil prefix '_' (head prefix)) t\r\n              parseErr \"More than one variable in do-clause: \" clause\r\n            makeBind '_' t\r\n        doClause t clause [h | prefix] inLet foldVar cont\r\n    makeBind '_' clause", lazy((function(L_steppingClause, L_clause, L_prefix, L_inLet, L_foldVar, L_cont) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : (function(){"use strict";
  var L_makeBind_0, L_h_1, L_t_2;
  L_makeBind_0 = function(){"use strict";return function(L_var){return function(L_value){return resolve(L_cont)(L_false)(L_foldVar)(lazy(function(L_rest){return resolve(L_inLet)(function(){"use strict";return resolve(L_cons)(".");})(L_id)(function(){"use strict";return resolve(L_isNil)(L_foldVar)(function(){"use strict";return resolve(L_cons)("bind", function(){"use strict";return resolve(L_cons)(L_value, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)("\\", function(){"use strict";return resolve(L_cons)(L_var, function(){"use strict";return resolve(L_cons)(".", L_rest);});});}, L_nil);});});})(function(){"use strict";return resolve(L_cons)("bind2", function(){"use strict";return resolve(L_cons)(L_foldVar, function(){"use strict";return resolve(L_cons)(L_value, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)("\\", function(){"use strict";return resolve(L_cons)(L_foldVar, function(){"use strict";return resolve(L_cons)(L_var, function(){"use strict";return resolve(L_cons)(".", L_rest);});});});}, L_nil);});});});});})}))}};};
  ...
  return resolve(L_isCons)(L_steppingClause)(function(){"use strict";return resolve(L_isTokenString)(L_h_1, "=")(function(){"use strict";return resolve(L_inLet)(function(){"use strict";return resolve(L_cont)(L_true)(L_foldVar)(lazy(function(L_rest){return resolve(L_cons)(L_clause, L_rest)}));})(function(){"use strict";return resolve(L_cont)(L_true)(L_foldVar)(lazy(function(L_rest){return resolve(L_cons)("\\\\", function(){"use strict";return resolve(L_cons)(L_clause, L_rest);})}));});})(function(){"use strict";return resolve(L_isTokenString)(L_h_1, "<-")(function(){"use strict";return resolve(L_isNil)(L_t_2)(function(){"use strict";return resolve(L_parseErr)("No monad in do-clause: ", L_clause);})(function(){"use strict";return resolve(L_prefix)(lazy(function(L_ph){return function(L_pt){return function(L_D){return resolve(L_isNil)(L_pt)(function(){"use strict";return resolve(L_makeBind_0)(function(){"use strict";return resolve(L_isNil)(L_prefix)("_")(function(){"use strict";return resolve(L_head)(L_prefix);});})(L_t_2);})(function(){"use strict";return resolve(L_parseErr)("More than one variable in do-clause: ", L_clause);})}}}))(function(){"use strict";return resolve(L_makeBind_0)("_")(L_t_2);});});})(function(){"use strict";return resolve(L_doClause)(L_t_2, L_clause, function(){"use strict";return resolve(L_cons)(L_h_1, L_prefix);}, L_inLet, L_foldVar, L_cont);});});})(function(){"use strict";return resolve(L_makeBind_0)("_")(L_clause);})})();
})))},
