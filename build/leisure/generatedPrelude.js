define([], function(){
  return L_runMonads([
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_isNil)(L_list)(L_nil)(function(){"use strict";return L$(resolve(L_func))(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_list);});}, L_id, function(){"use strict";return resolve(L_filter)(L_func, function(){"use strict";return resolve(L_tail)(L_list);});});});
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_isNil)(L_list)(L_none)(function(){"use strict";return L$(resolve(L_predicate))(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_some)(function(){"use strict";return resolve(L_head)(L_list);});}, function(){"use strict";return resolve(L_find)(L_predicate, function(){"use strict";return resolve(L_tail)(L_list);});});});
})))},
  ...
  return resolve(L_withCons)(L_list, L_names, lazy(function(L_binding){return function(L_body){return resolve(L_isTokenString)(L_binding, ".")(L_names)(function(){"use strict";return resolve(L_withParens)(L_binding, L_err_0, lazy(function(L_start){return function(L_end){return function(L_def){return resolve(L_withCons)(L_def, L_err_0, lazy(function(L_name){return function(L_rest){return resolve(L_withToken)(L_name, L_err_0, lazy(function(L_str){return function(L_pos){return resolve(L_getLetNames)(L_start, L_body, function(){"use strict";return resolve(L_cons)(L_str, L_names);})}}))}}))}}}));})}}))})();
    ...
    function(){return resolve(L_newDefine)("getLetLambda", 4, "getLetLambda pos def args names =\r\n  withCons def (parseErr \"Let expected binding at \" pos) \\arg rest .\r\n    not (isToken arg) (parseErr \"Let expected binding at \" pos)\r\n      isTokenString arg '='\r\n        createAst nil (cons (token '\\\\' pos) (_append (reverse args) (cons (token '.' (position arg)) rest))) names\r\n        getLetLambda pos rest (cons arg args) names", lazy((function(L_pos, L_def, L_args, L_names) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_withCons)(L_def, function(){"use strict";return resolve(L_parseErr)("Let expected binding at ", L_pos);}, lazy(function(L_arg){return function(L_rest){return resolve(L_not)(function(){"use strict";return resolve(L_isToken)(L_arg);})(function(){"use strict";return resolve(L_parseErr)("Let expected binding at ", L_pos);})(function(){"use strict";return resolve(L_isTokenString)(L_arg, "=")(function(){"use strict";return resolve(L_createAst)(L_nil, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_token)("\\", L_pos);}, function(){"use strict";return resolve(L__append)(function(){"use strict";return resolve(L_reverse)(L_args);}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_token)(".", function(){"use strict";return resolve(L_position)(L_arg);});}, L_rest);});});}, L_names);})(function(){"use strict";return resolve(L_getLetLambda)(L_pos, L_rest, function(){"use strict";return resolve(L_cons)(L_arg, L_args);}, L_names);});})}}));
})))},
  ...
  return resolve(L_isCons)(L_steppingClause)(function(){"use strict";return resolve(L_isTokenString)(L_h_1, "=")(function(){"use strict";return resolve(L_triple)(L_true, L_foldVar, lazy(function(L_rest){return L$(resolve(L_inLet))(function(){"use strict";return resolve(L_cons)(L_clause, L_rest);}, function(){"use strict";return resolve(L_cons)("\\\\", function(){"use strict";return resolve(L_cons)(L_clause, L_rest);});})}));})(function(){"use strict";return resolve(L_isTokenString)(L_h_1, "<-")(function(){"use strict";return resolve(L_isNil)(L_t_2)(function(){"use strict";return resolve(L_parseErr)("No value in do-clause: ", L_clause);})(function(){"use strict";return L$(resolve(L_prefix))(lazy(function(L_ph){return function(L_pt){return function(L_D){return resolve(L_isNil)(L_pt)(function(){"use strict";return resolve(L_makeBind_0)(function(){"use strict";return resolve(L_isNil)(L_prefix)("_")(function(){"use strict";return resolve(L_head)(L_prefix);});})(L_t_2);})(function(){"use strict";return resolve(L_any)(lazy(function(L_el){return resolve(L_not)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_isString)(L_el);}, function(){"use strict";return resolve(L_isToken)(L_el);});})}), L_prefix)(function(){"use strict";return resolve(L_parseErr)("Non-variable for bind in do clause: ", L_clause);})(function(){"use strict";return resolve(L_triple)(L_false, L_foldVar, lazy(function(L_rest){return L$(resolve(L_inLet))(function(){"use strict";return resolve(L_cons)(".");}, L_id, function(){"use strict";return resolve(L_cons)("bind", function(){"use strict";return resolve(L_cons)(L_t_2, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L__append)(function(){"use strict";return resolve(L_cons)("\\", L_prefix);}, function(){"use strict";return resolve(L_cons)(".", L_rest);});}, L_nil);});});})}));});})}}}), function(){"use strict";return resolve(L_makeBind_0)("_")(L_t_2);});});})(function(){"use strict";return resolve(L_doClause)(L_t_2, L_clause, function(){"use strict";return resolve(L_cons)(L_h_1, L_prefix);}, L_inLet, L_foldVar);});});})(function(){"use strict";return resolve(L_makeBind_0)("_")(L_clause);})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_isNil)(L_list)(function(){"use strict";return resolve(L_triple)(L_nil, L_nil, L_nil);})(function(){"use strict";return L$(resolve(L_func))(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_triple)(function(){"use strict";return resolve(L_reverse)(L_res);}, function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_tail)(L_list);});}, function(){"use strict";return resolve(L_partition)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_list);}, L_res);}, L_func, function(){"use strict";return resolve(L_tail)(L_list);});});});
})))},
    function(){return resolve(L_addToken)("<-")},
