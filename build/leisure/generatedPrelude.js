define([], function(){
  ...
  return resolve(L_and)(function(){"use strict";return resolve(L_$z)(L_len, 2);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_isInfix)(L_nextPrec_0, L_curArg, L_nextOp, L_len);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_$z)(L_opPrec, L_nextPrec_0);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_$p$p)(L_opPrec, L_nextPrec_0);}, L_isRight);});}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_isInfixArg)(L_closes, L_nextArg);}, L_true);});});})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isNil)(L_t)(function(){"use strict";return resolve(L_cont)(function(){"use strict";return resolve(L_inLet)(function(){"use strict";return resolve(L_cons)(".", function(){"use strict";return resolve(L_cons)(L_h, L_nil);});})(function(){"use strict";return resolve(L_cons)(L_h, L_nil);});});})(function(){"use strict";return resolve(L_doClause)(function(){"use strict";return resolve(L_stripParens)(L_h);}, L_h, L_nil, L_inLet, lazy(function(L_newInLet){return function(L_chain){return resolve(L_handleDo)(L_t, L_newInLet, lazy(function(L_rest){return resolve(L_cont)(function(){"use strict";return resolve(L_chain)(L_rest);})}))}}));})}}}))(function(){"use strict";return resolve(L_cont)(L_nil);});
})))},
  ...
  L_makeBind_0 = function(){"use strict";return function(L_var){return function(L_monad){return resolve(L_cont)(L_false)(lazy(function(L_rest){return resolve(L_inLet)(function(){"use strict";return resolve(L_cons)(".");})(L_id)(function(){"use strict";return resolve(L_cons)("bind", function(){"use strict";return resolve(L_cons)(L_monad, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)("\\", function(){"use strict";return resolve(L_cons)(L_var, function(){"use strict";return resolve(L_cons)(".", L_rest);});});}, L_nil);});});})}))}};};
  ...
  return resolve(L_isCons)(L_steppingClause)(function(){"use strict";return resolve(L_isTokenString)(L_h_1, "=")(function(){"use strict";return resolve(L_inLet)(function(){"use strict";return resolve(L_cont)(L_true)(lazy(function(L_rest){return resolve(L_cons)(L_clause, L_rest)}));})(function(){"use strict";return resolve(L_cont)(L_true)(lazy(function(L_rest){return resolve(L_cons)("\\\\", function(){"use strict";return resolve(L_cons)(L_clause, L_rest);})}));});})(function(){"use strict";return resolve(L_isTokenString)(L_h_1, "<-")(function(){"use strict";return resolve(L_isNil)(L_t_2)(function(){"use strict";return resolve(L_parseErr)("No monad in do-clause: ", L_clause);})(function(){"use strict";return resolve(L_prefix)(lazy(function(L_ph){return function(L_pt){return function(L_D){return resolve(L_isNil)(L_pt)(function(){"use strict";return resolve(L_makeBind_0)(function(){"use strict";return resolve(L_isNil)(L_prefix)("_")(function(){"use strict";return resolve(L_head)(L_prefix);});})(L_t_2);})(function(){"use strict";return resolve(L_parseErr)("More than one variable in do-clause: ", L_clause);})}}}))(function(){"use strict";return resolve(L_makeBind_0)("_")(L_t_2);});});})(function(){"use strict";return resolve(L_doClause)(L_t_2, L_clause, function(){"use strict";return resolve(L_cons)(L_h_1, L_prefix);}, L_inLet, L_cont);});});})(function(){"use strict";return resolve(L_makeBind_0)("_")(L_clause);})})();
})))},
    function(){return resolve(L_addToken)("<-")},
