define([], function(){
  ...
  return L_$_F;
    ...
    function(){return resolve(L_newDefine)("tokListStr", 1, "tokListStr toks = jsonStringify (join (_map (\\t . tokenString t) toks) ' ')", lazy(function(L_toks){return resolve(L_jsonStringify)(function(){"use strict";return resolve(L_join)(function(){"use strict";return resolve(L__map)(lazy(function(L_t){return resolve(L_tokenString)(L_t)}), L_toks);}, " ");})}))},
  ...
  L_newToks_1 = function(){"use strict";return resolve(L_mergeSort)(lazy(function(L_a){return function(L_b){return resolve(L_$z)(function(){"use strict";return resolve(L_strLen)(L_a);}, function(){"use strict";return resolve(L_strLen)(L_b);})}}), function(){"use strict";return resolve(L__append)(function(){"use strict";return resolve(L_head)(L_pack);}, function(){"use strict";return resolve(L__append)(L_groupToks_0, L_tokens);});});};
