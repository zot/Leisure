define([], function(){
  return L_runMonads([
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_isCons)(L_l)(function(){"use strict";return L$(resolve(L_l))(lazy(function(L_h){return function(L_t){return function(L_D){return L$(resolve(L_cont))(L_h, L_t)}}}), L_nilCase);})(L_nilCase);
})))},
    ...
    function(){return resolve(L_newDefine)("_foldl", 3, "_foldl func initialValue l = l (\\h t D . foldl func (func initialValue h) t) initialValue", lazy((function(L_func, L_initialValue, L_l) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_l))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_foldl)(L_func)(function(){"use strict";return L$(resolve(L_func))(L_initialValue, L_h);})(L_t)}}}), L_initialValue);
})))},
    function(){return resolve(L_newDefine)("_foldl1", 2, "_foldl1 func l = l \\h t . foldl func h t", lazy((function(L_func, L_l) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_l)(lazy(function(L_h){return function(L_t){return resolve(L_foldl)(L_func)(L_h)(L_t)}}));
})))},
    function(){return resolve(L_newDefine)("_foldr", 3, "_foldr func finalValue list = list\r\n  \\h t D . func h (foldr func finalValue t)\r\n  finalValue", lazy((function(L_func, L_finalValue, L_list) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return L$(resolve(L_func))(L_h, function(){"use strict";return resolve(L_foldr)(L_func)(L_finalValue)(L_t);})}}}), L_finalValue);
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_list)(lazy(function(L_h){return function(L_t){return resolve(L_isNil)(L_t)(L_h)(function(){"use strict";return L$(resolve(L_func))(L_h, function(){"use strict";return resolve(L_foldr1)(L_func)(L_t);});})}}));
})))},
    function(){return resolve(L_newDefine)("_append", 2, "_append a b = _foldr cons b a", lazy((function(L_a, L_b) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L__foldr)(L_cons, L_b, L_a);
})))},
    ...
    function(){return resolve(L_newDefine)("_filter", 2, "_filter func list = isNil list\r\n  nil\r\n  func (head list) (cons (head list)) id (_filter func (tail list))", lazy((function(L_func, L_list) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_isNil)(L_list)(L_nil)(function(){"use strict";return L$(resolve(L_func))(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_list);});}, L_id, function(){"use strict";return resolve(L__filter)(L_func, function(){"use strict";return resolve(L_tail)(L_list);});});});
})))},
    function(){return resolve(L_newDefine)("filter", 0, "filter = _filter", L__filter)},
    function(){return resolve(L_newDefine)("_find", 2, "_find predicate list = isNil list\r\n  none\r\n  predicate (head list) (some (head list)) (_find predicate (tail list))", lazy((function(L_predicate, L_list) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_isNil)(L_list)(L_none)(function(){"use strict";return L$(resolve(L_predicate))(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_some)(function(){"use strict";return resolve(L_head)(L_list);});}, function(){"use strict";return resolve(L__find)(L_predicate, function(){"use strict";return resolve(L_tail)(L_list);});});});
})))},
    function(){return resolve(L_newDefine)("find", 0, "find = _find", L__find)},
    function(){return resolve(L_newDefine)("_contains", 2, "_contains item list = find (\\el . eq el item) list (\\x . true) false", lazy((function(L_item, L_list) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return L$(resolve(L_func))(L_h, L_pos, function(){"use strict";return resolve(L_idx)(L_t, L_func, function(){"use strict";return resolve(L_$o)(1, L_pos);});})}}}), -1);
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_isCons)(L_l)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_func)(function(){"use strict";return resolve(L_head)(L_l);});}, function(){"use strict";return resolve(L__map)(L_func, function(){"use strict";return resolve(L_tail)(L_l);});});})(L_l);
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isNil)(L_t)(L_list)(function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_cons)(L_element, function(){"use strict";return resolve(L_intersperse)(L_t, L_element);});});})}}}), L_nil);
})))},
    ...
    function(){return resolve(L_newDefine)("appendAlist", 2, "appendAlist a b = _foldr aconsPair a b", lazy((function(L_a, L_b) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L__foldr)(L_aconsPair, L_a, L_b);
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_l))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_eq)(function(){"use strict";return resolve(L_tail)(L_l);}, L_nil)(L_l)(function(){"use strict";return (function(){"use strict";
  ...
  return resolve(L_parens)(L_start_0, L_end_1, L_content)})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L__reverse)(function(){"use strict";return resolve(L__withRecur)(function(){"use strict";return resolve(L__basicSplitTokens)(L_str, L_pat, L_prevIsDel, L_nil);});});
})))},
  ...
  return resolve(L_isTokenString)(L_slash_0, "\\")(function(){"use strict";return resolve(L_cons)(L_slash_0, function(){"use strict";return resolve(L_cons)(L_var_1, function(){"use strict";return resolve(L_isTokenString)(L_dot_3, ".")(function(){"use strict";return resolve(L_cons)(L_dot_3, function(){"use strict";return resolve(L_addProps)(L_props, L_body_4);});})(function(){"use strict";return resolve(L_cons)(".", function(){"use strict";return resolve(L_addProps)(L_props, L_afterVar_2);});});});});})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_ast);}, function(){"use strict";return resolve(L_subSpliceFuncProps)(L_props, function(){"use strict";return resolve(L_tail)(L_ast);});});})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L__foldr)(lazy(function(L_prop){return function(L_result){return resolve(L_cons)("\\@", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_prop);}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_tail)(L_prop);}, function(){"use strict";return resolve(L_cons)(".", L_result);});});})}}), L_ast, L_props);
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L__reverse)(function(){"use strict";return resolve(L__withRecur)(function(){"use strict";return resolve(L__countedLines)(L_filename, L_lineOffset, L_str, L_nil);});});
})))},
  ...
  return resolve(L_isNil)(L_m_0)(L_result)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(function(){"use strict";return resolve(L_tail)(L_m_0);});}, L_result);})})()}}), L_nil, L_lines)}))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_filters))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){"use strict";return resolve(L_h)(L_line);}, lazy(function(L_filtered){return resolve(L_runParseFilters)(L_t, L_filtered)}))}}}), function(){"use strict";return resolve(L_fakereturn)(L_line);});
})))},
  ...
  return resolve(L_withToken)(L_subH_0, function(){"use strict";return resolve(L_cons)(L_subH_0, function(){"use strict";return resolve(L__map)(function(){"use strict";return resolve(L_baseMacroSub)(L_macs);}, L_t);});}, lazy(function(L_tok){return function(L_pos){return resolve(L_baseMacroSub)(L_macs, function(){"use strict";return resolve(L_cons)(L_subH_0, L_t);})}}))})();}, lazy(function(L_tok){return function(L_pos){return resolve(L_assoc)(L_tok, L_macs)(lazy(function(L_def){return resolve(L_baseMacroSub)(L_macs, function(){"use strict";return resolve(L_def)(L_t);})}))(function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L__map)(function(){"use strict";return resolve(L_baseMacroSub)(L_macs);}, L_t);});})}}));})}}));});});
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isTokenString)(L_h, ".")(function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_baseMacroSub)(L_macs, L_t);});})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_setParens)(L_h, lazy(function(L_content){return resolve(L_macroSubBody)("=", L_macs, L_content)}));}, function(){"use strict";return resolve(L_macroSubLet)(L_macs, L_t);});})}}}), L_nil);
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_isTokenString)(L_h, L_char)(L_baseMacroSub)(function(){"use strict";return resolve(L_macroSubBody)(L_char);})(L_macs)(L_t);})}}}), L_nil);
})))},
  ...
  return resolve(L_isNil)(L_list)(L_false)(function(){"use strict";return L$(resolve(L_func))(function(){"use strict";return resolve(L_head)(L_list);}, L_nil, function(){"use strict";return resolve(L_$p$p)(L_ret_0, L_false)(L_false)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_list);}, L_ret_0);});});})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_isNil)(L_list)(L_nil)(function(){"use strict";return L$(resolve(L_func))(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_tail)(L_list);}, function(){"use strict";return resolve(L_dropAfter)(L_func, function(){"use strict";return resolve(L_tail)(L_list);});});});
})))},
    ...
    function(){return resolve(L_newDefine)("listifyOp", 3, "listifyOp op list last = list\r\n  \\h t D . isTokenString h '|'\r\n    cons t nil\r\n    cons (cons op (cons h (listifyOp op t last))) nil\r\n  cons last nil", lazy((function(L_op, L_list, L_last) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isTokenString)(L_h, "|")(function(){"use strict";return resolve(L_cons)(L_t, L_nil);})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)(L_op, function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_listifyOp)(L_op, L_t, L_last);});});}, L_nil);})}}}), function(){"use strict";return resolve(L_cons)(L_last, L_nil);});
})))},
  ...
  return resolve(L_and)(function(){"use strict";return resolve(L_isCons)(L_filtered_0);}, function(){"use strict";return resolve(L_isBlockStart)(function(){"use strict";return resolve(L_head)(L_filtered_0);});})(L_filtered_0)(function(){"use strict";return resolve(L_func)(L_filtered_0);})})();})(L_code);});
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_list)(lazy(function(L_h){return function(L_t){return resolve(L__foldr)(lazy(function(L_case){return function(L_result){return resolve(L_cons)(L_op, function(){"use strict";return resolve(L_cons)(L_case, function(){"use strict";return resolve(L_cons)(L_result, L_nil);});})}}), L_emptyCase, L_h)}}));
})))},
  ...
  return resolve(L_and)(function(){"use strict";return resolve(L_$z)(L_len, 2);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_isInfix)(L_nextPrec_0, L_curArg, L_nextOp, L_len);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_$z)(L_opPrec, L_nextPrec_0);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_$p$p)(L_opPrec, L_nextPrec_0);}, L_isRight);});}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_isInfixArg)(L_closes, L_nextArg);}, L_true);});});})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isNil)(L_t)(function(){"use strict";return resolve(L_cont)(function(){"use strict";return L$(resolve(L_inLet))(function(){"use strict";return resolve(L_cons)(".", function(){"use strict";return resolve(L_cons)(L_h, L_nil);});}, function(){"use strict";return resolve(L_cons)(L_h, L_nil);});});})(function(){"use strict";return (function(){"use strict";
  ...
  return resolve(L_isCons)(L_steppingClause)(function(){"use strict";return resolve(L_isTokenString)(L_h_1, "=")(function(){"use strict";return resolve(L_triple)(L_true, L_foldVar, lazy(function(L_rest){return L$(resolve(L_inLet))(function(){"use strict";return resolve(L_cons)(L_clause, L_rest);}, function(){"use strict";return resolve(L_cons)("\\\\", function(){"use strict";return resolve(L_cons)(L_clause, L_rest);});})}));})(function(){"use strict";return resolve(L_isTokenString)(L_h_1, "<-")(function(){"use strict";return resolve(L_isNil)(L_t_2)(function(){"use strict";return resolve(L_parseErr)("No value in do-clause: ", L_clause);})(function(){"use strict";return L$(resolve(L_prefix))(lazy(function(L_ph){return function(L_pt){return function(L_D){return resolve(L_isNil)(L_pt)(function(){"use strict";return resolve(L_makeBind_0)(function(){"use strict";return resolve(L_isNil)(L_prefix)("_")(function(){"use strict";return resolve(L_head)(L_prefix);});})(L_t_2);})(function(){"use strict";return resolve(L_any)(lazy(function(L_el){return resolve(L_not)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_isString)(L_el);}, function(){"use strict";return resolve(L_isToken)(L_el);});})}), L_prefix)(function(){"use strict";return resolve(L_parseErr)("Non-variable for bind in do clause: ", L_clause);})(function(){"use strict";return resolve(L_triple)(L_false, L_foldVar, lazy(function(L_rest){return L$(resolve(L_inLet))(function(){"use strict";return resolve(L_cons)(".");}, L_id, function(){"use strict";return resolve(L_cons)("bind", function(){"use strict";return resolve(L_cons)(L_t_2, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L__append)(function(){"use strict";return resolve(L_cons)("\\", L_prefix);}, function(){"use strict";return resolve(L_cons)(".", L_rest);});}, L_nil);});});})}));});})}}}), function(){"use strict";return resolve(L_makeBind_0)("_")(L_t_2);});});})(function(){"use strict";return resolve(L_doClause)(L_t_2, L_clause, function(){"use strict";return resolve(L_cons)(L_h_1, L_prefix);}, L_inLet, L_foldVar);});});})(function(){"use strict";return resolve(L_makeBind_0)("_")(L_clause);})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_isNil)(L_list)(function(){"use strict";return resolve(L_triple)(L_nil, L_nil, L_nil);})(function(){"use strict";return L$(resolve(L_func))(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_triple)(function(){"use strict";return resolve(L__reverse)(L_res);}, function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_tail)(L_list);});}, function(){"use strict";return resolve(L_partition)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_list);}, L_res);}, L_func, function(){"use strict";return resolve(L_tail)(L_list);});});});
})))},
    function(){return resolve(L_addToken)("<-")},
