define([], function(){
  ...
  return resolve(L_and)(function(){"use strict";return resolve(L_$z)(L_len, 2);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_isInfix)(L_nextPrec_0, L_curArg, L_nextOp, L_len);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_$z)(L_opPrec, L_nextPrec_0);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_$p$p)(L_opPrec, L_nextPrec_0);}, L_isRight);});}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_isInfixArg)(L_closes, L_nextArg);}, L_true);});});})})();
    ...
    function(){return resolve(L_defMacro)("do", lazy(function(L_list){return resolve(L_handleDo)(L_list, L_false, L_nil, L_id)}))},
    function(){return resolve(L_newDefine)("handleDo", 4, "handleDo list inLet foldVar cont = list\r\n \\h t D . isNil t\r\n   cont (inLet ['.' h] [h])\r\n   \\\\\r\n     next = doClause (stripParens h) h nil inLet cons\r\n     .\r\n     next \\newInLet chain . handleDo t newInLet foldVar \\rest . cont (chain rest)\r\n cont nil", lazy((function(L_list, L_inLet, L_foldVar, L_cont) {
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
  ...
  var L_next_0;
  L_next_0 = function(){"use strict";return resolve(L_doClause)(function(){"use strict";return resolve(L_stripParens)(L_h);}, L_h, L_nil, L_inLet, L_cons);};

  return resolve(L_next_0)(lazy(function(L_newInLet){return function(L_chain){return resolve(L_handleDo)(L_t, L_newInLet, L_foldVar, lazy(function(L_rest){return resolve(L_cont)(function(){"use strict";return resolve(L_chain)(L_rest);})}))}}))})();})}}}))(function(){"use strict";return resolve(L_cont)(L_nil);});
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : (function(){"use strict";
  var L_makeBind_0, L_makeBind2_1, L_h_2, L_t_3;
  L_makeBind_0 = function(){"use strict";return function(L_var){return function(L_value){return resolve(L_cont)(L_false)(lazy(function(L_rest){return resolve(L_inLet)(function(){"use strict";return resolve(L_cons)(".");})(L_id)(function(){"use strict";return resolve(L_cons)("bind", function(){"use strict";return resolve(L_cons)(L_value, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)("\\", function(){"use strict";return resolve(L_cons)(L_var, function(){"use strict";return resolve(L_cons)(".", L_rest);});});}, L_nil);});});})}))}};};
  L_makeBind2_1 = function(){"use strict";return function(L_accVar){return function(L_init){return function(L_var){return function(L_value){return resolve(L_cont)(L_false)(lazy(function(L_rest){return resolve(L_inLet)(function(){"use strict";return resolve(L_cons)(".");})(L_id)(function(){"use strict";return resolve(L_cons)("bind2", function(){"use strict";return resolve(L_cons)(L_init, function(){"use strict";return resolve(L_cons)(L_value, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)("\\", function(){"use strict";return resolve(L_cons)(L_accVar, function(){"use strict";return resolve(L_cons)(L_var, function(){"use strict";return resolve(L_cons)(".", L_rest);});});});}, L_nil);});});});})}))}}}};};
  L_h_2 = function(){"use strict";return resolve(L_head)(L_steppingClause);};
  L_t_3 = function(){"use strict";return resolve(L_tail)(L_steppingClause);};

  return resolve(L_isCons)(L_steppingClause)(function(){"use strict";return resolve(L_isTokenString)(L_h_2, "=")(function(){"use strict";return resolve(L_inLet)(function(){"use strict";return resolve(L_cont)(L_true)(lazy(function(L_rest){return resolve(L_cons)(L_clause, L_rest)}));})(function(){"use strict";return resolve(L_cont)(L_true)(lazy(function(L_rest){return resolve(L_cons)("\\\\", function(){"use strict";return resolve(L_cons)(L_clause, L_rest);})}));});})(function(){"use strict";return resolve(L_isTokenString)(L_h_2, "<-")(function(){"use strict";return resolve(L_isNil)(L_t_3)(function(){"use strict";return resolve(L_parseErr)("No monad in do-clause: ", L_clause);})(function(){"use strict";return resolve(L_prefix)(lazy(function(L_ph){return function(L_pt){return function(L_D){return resolve(L_isNil)(L_pt)(function(){"use strict";return resolve(L_makeBind_0)(function(){"use strict";return resolve(L_isNil)(L_prefix)("_")(function(){"use strict";return resolve(L_head)(L_prefix);});})(L_t_3);})(function(){"use strict";return resolve(L_parseErr)("More than one variable in do-clause: ", L_clause);})}}}))(function(){"use strict";return resolve(L_makeBind_0)("_")(L_t_3);});});})(function(){"use strict";return resolve(L_isTokenString)(L_h_2, "<-|")(function(){"use strict";return resolve(L_ifNotErr)(function(){"use strict";return resolve(L_checkFoldFormat)(L_t_3, L_clause);}, lazy(function(L_x){return resolve(L_x)(lazy(function(L_var){return function(L_init){return function(L_rest){return resolve(L_makeBind2_1)(L_var)(L_init)(function(){"use strict";return resolve(L_isNil)(L_prefix)("_")(function(){"use strict";return resolve(L_head)(L_prefix);});})(L_rest)}}}))}));})(function(){"use strict";return resolve(L_doClause)(L_t_3, L_clause, function(){"use strict";return resolve(L_cons)(L_h_2, L_prefix);}, L_inLet, L_cont);});});});})(function(){"use strict";return resolve(L_makeBind_0)("_")(L_clause);})})();
})))},
