define([], function(){
  ...
  return resolve(L_setValue)("tokenPat", L_newPat_1)})()}))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_lines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_bind)(function(){return resolve(L_parseLineM)(L_h)}, lazy(function(L_ast){return resolve(L_parseLines)(L_t, function(){return resolve(L_cons)(L_ast, L_result)})}))}}}))(function(){return resolve(L_reverse)(L_result)});
})))},
  ...
  return resolve(L_eq)(L_m_0, L_nil)(function(){return resolve(L_cons)(L_offset, L_nil)})(function(){return resolve(L_cons)(L_offset, function(){return resolve(L_findLines)(function(){return resolve(L_$o)(L_offset, L_idx_1)}, function(){return resolve(L_strSubstring)(L_line, L_idx_1, 0)})})})})();
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_bind)(function(){return resolve(L_scanLineM)(L_line)}, lazy(function(L_scanned){return resolve(L_ifNotErr)(function(){return resolve(L_createAst)(function(){return resolve(L_cons)("NEWPARSE.lsr", function(){return resolve(L_findLines)(L_offset, L_line)})}, L_scanned, L_names)}, L_id)}));
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_bind)(function(){return resolve(L_countedScanLineM)(function(){return resolve(L_head)(L_countedLine)}, function(){return resolve(L_tail)(L_countedLine)})}, lazy(function(L_scanned){return resolve(L_createAst)(function(){return resolve(L_head)(L_countedLine)}, L_scanned, L_names)}));
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_bind)(function(){return resolve(L_newParseLine)(L_offset, L_names, L_line)}, lazy(function(L_ast){return resolve(L_bind)(function(){return resolve(L_runAst)(L_line)(L_ast)}, lazy(function(L_res){return resolve(L_bind)(L_res, lazy(function(L_result){return resolve(L_cons)(L_ast, function(){return resolve(L_isErr)(L_result)(function(){return resolve(L_left)(function(){return resolve(L_errMsg)(L_result)})})(function(){return resolve(L_right)(L_result)})})}))}))}));
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_bind)(function(){return resolve(L_countedParseLine)(L_names, L_countedLine)}, lazy(function(L_ast){return (function(){
  var L_wrapped_0;
  L_wrapped_0 = function(){return resolve(L_astFileWrap)(L_file, L_ast)};

  return resolve(L_bind)(function(){return resolve(L_runAst)(function(){return resolve(L_tail)(L_countedLine)})(L_wrapped_0)}, lazy(function(L_res){return resolve(L_bind)(L_res, lazy(function(L_result){return resolve(L_resultOfRun)(L_wrapped_0, L_result)}))}))})()}));
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_lines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_bind)(function(){return resolve(L_runLine)(0, L_names, L_h)}, lazy(function(L_line){return resolve(L_bind)(function(){return resolve(L_runLines)(L_names, L_t)}, lazy(function(L_rest){return resolve(L_cons)(L_line, L_rest)}))}))}}}))(L_nil);
})))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_countedLines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_bind)(function(){return resolve(L_countedRunLine)(L_file, L_names, L_h)}, lazy(function(L_line){return resolve(L_countedRunLines)(L_file, L_names, L_t, function(){return resolve(L_cons)(L_line, L_result)})}))}}}))(function(){return resolve(L_reverse)(L_result)});
})))},
  ...
  return resolve(L_isNil)(L_errs_0)(function(){return resolve(L_right)(L_true)})(function(){return resolve(L_left)(L_errs_0)})})()}))}))},
    ...
    return arguments.callee.length != arguments.length
        ? Leisure_primCall(arguments.callee, 0, arguments)
        : resolve(L_countedLines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_bind)(function(){return resolve(L_countedScanLineM)(function(){return resolve(L_head)(L_h)}, function(){return resolve(L_tail)(L_h)})}, lazy(function(L_line){return resolve(L_bind)(function(){return resolve(L_countedScanLines)(L_file, L_names, L_t)}, lazy(function(L_rest){return resolve(L_cons)(L_line, L_rest)}))}))}}}))(L_nil);
})))},
  ...
  return resolve(L_bind)(function(){return resolve(L_setValue)("tokenList", L_newToks_1)}, lazy(function(L__){return resolve(L_bind)(function(){return resolve(L_setValue)("tokenGroups", function(){return resolve(L_appendAlist)(function(){return resolve(L_head)(function(){return resolve(L_tail)(L_pack)})}, L_groups)})}, lazy(function(L___2){return resolve(L_bind)(function(){return resolve(L_setValue)("parseFilters", function(){return resolve(L_append)(L_filters, function(){return resolve(L_head)(function(){return resolve(L_tail)(function(){return resolve(L_tail)(L_pack)})})})})}, lazy(function(L___3){return resolve(L_bind)(function(){return resolve(L_computeTokenPat)(L_newToks_1)}, lazy(function(L___4){return resolve(L_setValue)("activeTokenPacks", function(){return resolve(L_cons)(L_name, L_activePacks)})}))}))}))}))})()}))(L_nil)}))}))}))}))}))}))},
    ...
    function(){return resolve(L_newDefine)("doall", 0, "doall = foldr1 (\\el res . bind el \\_ . res)", function(){return resolve(L_foldr1)(lazy(function(L_el){return function(L_res){return resolve(L_bind)(L_el, lazy(function(L__){return resolve(L_res)}))}}))})},
