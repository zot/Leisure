define([], function(){
  ...
  var L_$_F = function(L_x, L_cont) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isMonad)(L_x)(function(){"use strict";return resolve(L_primBind)(L_x, L_cont);})(function(){"use strict";return resolve(L_cont)(L_x);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_a, L_b) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_a))(L_b, L_false);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_a, L_b) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_a))(L_true, L_b);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_a, L_b) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_someCase){return function(L_noneCase){return resolve(L_someCase)(L_a)(L_b)}}, 'some2');
  };
  return L_$_F;
})(), 'some2')))},
  ...
  var L_$_F = function(L_a, L_b) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_not)(function(){"use strict";return resolve(L_eq)(L_a, L_b);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_string, L_index) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__strAt)(function(){"use strict";return resolve(L_assertType)("strAt string", "*string", L_string);}, function(){"use strict";return resolve(L_assertType)("strAt index", "*number", L_index);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_string, L_prefix) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__strStartsWith)(function(){"use strict";return resolve(L_assertType)("strStartsWith string", "*string", L_string);}, function(){"use strict";return resolve(L_assertType)("strStartsWith prefix", "*string", L_prefix);});
  };
  return L_$_F;
})()))},
    ...
    function(){return resolve(L_newDefine)("strReverse", 1, "strReverse string = _strReverse (assertType 'strLen string' '*string' string)", lazy(function(L_string){return resolve(L__strReverse)(function(){"use strict";return resolve(L_assertType)("strLen string", "*string", L_string);})}))},
  ...
  var L_$_F = function(L_string, L_pat, L_repl) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__strReplace)(function(){"use strict";return resolve(L_assertType)("strReplace string", "*string", L_string);}, function(){"use strict";return resolve(L_assert)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_hasType)(L_pat, "*string");}, function(){"use strict";return resolve(L_hasType)(L_pat, "*RegExp");});})(function(){"use strict";return resolve(L_strCat)(function(){"use strict";return resolve(L_cons)("strStartsWith pat should be type string or RegExp but it is type ", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_getType)(L_pat);}, function(){"use strict";return resolve(L_cons)(": ", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_show)(L_pat);}, L_nil);});});});});})(L_pat);}, function(){"use strict";return resolve(L_assertType)("strReplace repl", "*string", L_repl);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str, L_start, L_end) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__strSubstring)(function(){"use strict";return resolve(L_assertType)("strSubstring str", "*string", L_str);}, function(){"use strict";return resolve(L_assertType)("strSubstring start", "*number", L_start);}, function(){"use strict";return resolve(L_assertType)("strSubstring end", "*number", L_end);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str1, L_str2) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__strAdd)(function(){"use strict";return resolve(L_assertType)("strAdd str1", "*string", L_str1);}, function(){"use strict";return resolve(L_assertType)("strAdd str2", "*string", L_str2);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str, L_flags) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__regexpFlags)(function(){"use strict";return resolve(L_assertType)("regexp str", "*string", L_str);}, function(){"use strict";return resolve(L_assertType)("regexp flags", "*string", L_flags);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str, L_failure, L_success) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__jsonParse)(function(){"use strict";return resolve(L_assertType)("jsonParse str", "*string", L_str);}, L_failure, L_success);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_x, L_y) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_eq)(L_x, L_y);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_f, L_g) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_x){return resolve(L_f)(function(){"use strict";return resolve(L_g)(L_x);})}, 'compose');
  };
  return L_$_F;
})(), 'compose')))},
  ...
  var L_$_F = function(L_l, L_nilCase, L_cont) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isCons)(L_l)(function(){"use strict";return L$(resolve(L_l))(lazy(function(L_h){return function(L_t){return function(L_D){return L$(resolve(L_cont))(L_h, L_t)}}}), L_nilCase);})(L_nilCase);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("cons", 2, "cons a b = \\f . f a b", lazy(setDataType((function(){
  var L_$_F = function(L_a, L_b) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_a)(L_b)}, 'cons');
  };
  return L_$_F;
})(), 'cons')))},
  ...
  var L_$_F = function(L_msg, L_type, L_value) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_assert)(function(){"use strict";return resolve(L_hasType)(L_value, L_type);})(function(){"use strict";return resolve(L_strCat)(function(){"use strict";return resolve(L_cons)(L_msg, function(){"use strict";return resolve(L_cons)(" should be type ", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_getDataType)(L_type);}, function(){"use strict";return resolve(L_cons)(", but its type is ", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_getType)(L_value);}, function(){"use strict";return resolve(L_cons)(": ", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_show)(L_value);}, L_nil);});});});});});});});})(L_value);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_func, L_initialValue, L_l) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_l))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_foldl)(L_func)(function(){"use strict";return L$(resolve(L_func))(L_initialValue, L_h);})(L_t)}}}), L_initialValue);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("_foldl1", 2, "_foldl1 func l = l \\h t . foldl func h t", lazy((function(){
  var L_$_F = function(L_func, L_l) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_l)(lazy(function(L_h){return function(L_t){return resolve(L_foldl)(L_func)(L_h)(L_t)}}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_func, L_finalValue, L_list) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return L$(resolve(L_func))(L_h, function(){"use strict";return resolve(L_foldr)(L_func)(L_finalValue)(L_t);})}}}), L_finalValue);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("_foldr1", 2, "_foldr1 func list = list \\h t . isNil t\r\n  h\r\n  func h (foldr1 func t)", lazy((function(){
  var L_$_F = function(L_func, L_list) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_list)(lazy(function(L_h){return function(L_t){return resolve(L_isNil)(L_t)(L_h)(function(){"use strict";return L$(resolve(L_func))(L_h, function(){"use strict";return resolve(L_foldr1)(L_func)(L_t);});})}}));
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("_append", 2, "_append a b = _foldr cons b a", lazy((function(){
  var L_$_F = function(L_a, L_b) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__foldr)(L_cons, L_b, L_a);
  };
  return L_$_F;
})()))},
    ...
    function(){return resolve(L_newDefine)("_reverse", 1, "_reverse l = rev l nil", lazy(function(L_l){return resolve(L_rev)(L_l, L_nil)}))},
  ...
  var L_$_F = function(L_l, L_result) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isNil)(L_l)(L_result)(function(){"use strict";return resolve(L_rev)(function(){"use strict";return resolve(L_tail)(L_l);}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_l);}, L_result);});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_func, L_list) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isNil)(L_list)(L_nil)(function(){"use strict";return L$(resolve(L_func))(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_list);});}, L_id, function(){"use strict";return resolve(L__filter)(L_func, function(){"use strict";return resolve(L_tail)(L_list);});});});
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("filter", 0, "filter = _filter", L__filter)},
    function(){return resolve(L_newDefine)("_find", 2, "_find predicate list = isNil list\r\n  none\r\n  predicate (head list) (some (head list)) (_find predicate (tail list))", lazy((function(){
  var L_$_F = function(L_predicate, L_list) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isNil)(L_list)(L_none)(function(){"use strict";return L$(resolve(L_predicate))(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_some)(function(){"use strict";return resolve(L_head)(L_list);});}, function(){"use strict";return resolve(L__find)(L_predicate, function(){"use strict";return resolve(L_tail)(L_list);});});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_item, L_list) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_find)(lazy(function(L_el){return resolve(L_eq)(L_el, L_item)}))(L_list)(lazy(function(L_x){return resolve(L_true)}))(L_false);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("findIndex", 2, "findIndex func list = idx list func 0", lazy((function(){
  var L_$_F = function(L_func, L_list) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_idx)(L_list, L_func, 0);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("idx", 3, "idx list func pos = list\r\n  \\h t D . func h\r\n    pos\r\n    idx t func (+ 1 pos)\r\n  -1", lazy((function(){
  var L_$_F = function(L_list, L_func, L_pos) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return L$(resolve(L_func))(L_h, L_pos, function(){"use strict";return resolve(L_idx)(L_t, L_func, function(){"use strict";return resolve(L_$o)(1, L_pos);});})}}}), -1);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("index", 2, "index list el = find (\\item . == el item) list", lazy((function(){
  var L_$_F = function(L_list, L_el) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_find)(lazy(function(L_item){return resolve(L_$p$p)(L_el, L_item)}))(L_list);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("_map", 2, "_map func l = isCons l\r\n  cons (func (head l)) (_map func (tail l))\r\n  l", lazy((function(){
  var L_$_F = function(L_func, L_l) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isCons)(L_l)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_func)(function(){"use strict";return resolve(L_head)(L_l);});}, function(){"use strict";return resolve(L__map)(L_func, function(){"use strict";return resolve(L_tail)(L_l);});});})(L_l);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_list, L_element) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isNil)(L_t)(L_list)(function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_cons)(L_element, function(){"use strict";return resolve(L_intersperse)(L_t, L_element);});});})}}}), L_nil);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("join", 2, "join list el = strCat (intersperse list el)", lazy((function(){
  var L_$_F = function(L_list, L_el) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_strCat)(function(){"use strict";return resolve(L_intersperse)(L_list, L_el);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_msg, L_value, L_result) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_assert)(function(){"use strict";return resolve(L_isAlist)(L_value);})(function(){"use strict";return resolve(L_strCat)(function(){"use strict";return resolve(L_cons)(L_msg, function(){"use strict";return resolve(L_cons)(" should be a association list, but it is not; its type is ", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_getType)(L_value);}, function(){"use strict";return resolve(L_cons)(": ", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_show)(L_value);}, L_nil);});});});});});})(L_result);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_k, L_v, L_alist) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_assertAlist)("acons alist", L_alist, lazy(setType(setLambdaProperties(function(L_f){return resolve(L_f)(function(){"use strict";return resolve(L_cons)(L_k, L_v);})(L_alist)}, {"assoc":"true"}), 'cons')));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_k, L_alist) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_find)(lazy(function(L_el){return resolve(L_eq)(L_k, function(){"use strict";return resolve(L_head)(L_el);})}))(L_alist)(lazy(function(L_cell){return resolve(L_cell)(lazy(function(L_head){return function(L_tail){return resolve(L_some)(L_tail)}}))}))(L_none);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_v, L_alist) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_find)(lazy(function(L_el){return resolve(L_eq)(L_v, function(){"use strict";return resolve(L_tail)(L_el);})}))(L_alist)(lazy(function(L_cell){return resolve(L_cell)(lazy(function(L_head){return function(L_tail){return resolve(L_some)(L_head)}}))}))(L_none);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_keyValue, L_list) {
    return L_checkPartial(L_$_F, arguments) || setType(setLambdaProperties(function(L_f){return resolve(L_f)(L_keyValue)(L_list)}, {"assoc":"true"}), 'cons');
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("appendAlist", 2, "appendAlist a b = _foldr aconsPair a b", lazy((function(){
  var L_$_F = function(L_a, L_b) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__foldr)(L_aconsPair, L_a, L_b);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("keys", 1, "keys list = _map (\\l . head l) list", lazy(function(L_list){return resolve(L__map)(lazy(function(L_l){return resolve(L_head)(L_l)}), L_list)}))},
    function(){return resolve(L_newDefine)("getProperty", 2, "getProperty func prop = assoc prop (getProperties func)", lazy((function(){
  var L_$_F = function(L_func, L_prop) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_assoc)(L_prop, function(){"use strict";return resolve(L_getProperties)(L_func);});
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("hasProperty", 2, "hasProperty func prop = getProperty func prop\r\n  \\_ . true\r\n  false", lazy((function(){
  var L_$_F = function(L_func, L_prop) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_getProperty)(L_func, L_prop)(lazy(function(L__){return resolve(L_true)}))(L_false);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_cmp, L_a, L_b) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_a))(lazy(function(L_ah){return function(L_at){return function(L_D){return L$(resolve(L_b))(lazy(function(L_bh){return function(L_bt){return function(L_D_0){return L$(resolve(L_cmp))(L_ah, L_bh, function(){"use strict";return resolve(L_cons)(L_ah, function(){"use strict";return resolve(L_merge)(L_cmp, L_at, L_b);});}, function(){"use strict";return resolve(L_cons)(L_bh, function(){"use strict";return resolve(L_merge)(L_cmp, L_a, L_bt);});})}}}), L_a)}}}), L_b);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("mergeSort", 2, "mergeSort cmp l = l\r\n  \\h t D . eq (tail l) nil\r\n    l\r\n    \\\\\r\n      cl = cleave l\r\n      e = head cl\r\n      o = tail cl\r\n      .\r\n      merge cmp (mergeSort cmp e) (mergeSort cmp o)\r\n  nil", lazy((function(){
  var L_$_F = function(L_cmp, L_l) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_l))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_eq)(function(){"use strict";return resolve(L_tail)(L_l);}, L_nil)(L_l)(function(){"use strict";return (function(){"use strict";
  ...
  var L_$_F = function(L_thing, L_cont) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isErr)(L_thing)(L_thing)(function(){"use strict";return resolve(L_cont)(L_thing);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_txt, L_pos) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_txt)(L_pos)}, 'token');
  };
  return L_$_F;
})(), 'token')))},
  ...
  var L_$_F = function(L_file, L_line, L_offset) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_file)(L_line)(L_offset)}, 'filepos');
  };
  return L_$_F;
})(), 'filepos')))},
  ...
  var L_$_F = function(L_pos, L_change) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isFilepos)(L_pos)(L_pos)(L_emptyFilePos)(lazy(function(L_file){return function(L_line){return function(L_offset){return resolve(L_filepos)(L_file, L_line, function(){"use strict";return resolve(L_$o)(L_offset, L_change);})}}}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_lineStarts, L_offset) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_countFilePos)(function(){"use strict";return resolve(L_head)(function(){"use strict";return resolve(L_tail)(L_lineStarts);});}, 0, function(){"use strict";return resolve(L_tail)(function(){"use strict";return resolve(L_tail)(L_lineStarts);});}, L_offset)(lazy(function(L_line){return function(L_offset){return resolve(L_filepos)(function(){"use strict";return resolve(L_head)(L_lineStarts);}, L_line, L_offset)}}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_start, L_end, L_content) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_start)(L_end)(L_content)}, 'parens');
  };
  return L_$_F;
})(), 'parens')))},
  ...
  var L_$_F = function(L_start, L_end, L_content) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_and)(function(){"use strict";return resolve(L_isCons)(L_content);}, function(){"use strict";return resolve(L_isNil)(function(){"use strict";return resolve(L_tail)(L_content);});})(function(){"use strict";return resolve(L_makeParens)(L_start, L_end, function(){"use strict";return resolve(L_head)(L_content);});})(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_isToken)(L_content);}, function(){"use strict";return resolve(L_isParens)(L_content);})(L_content)(function(){"use strict";return resolve(L_parens)(L_start, L_end, L_content);});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_left, L_right, L_content) {
  ...
  var L_$_F = function(L_p, L_cont) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_cont)(function(){"use strict";return resolve(L_stripParens)(L_p);});
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("parseErr", 2, "parseErr msg1 msg2 = err (strCat (cons msg1 (cons msg2 nil)))", lazy((function(){
  var L_$_F = function(L_msg1, L_msg2) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_err)(function(){"use strict";return resolve(L_strCat)(function(){"use strict";return resolve(L_cons)(L_msg1, function(){"use strict";return resolve(L_cons)(L_msg2, L_nil);});});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_lineStarts, L_strings, L_start) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__withRecur)(function(){"use strict";return resolve(L_makeMoreTokens)(L_lineStarts, L_strings, L_start, L_nil);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_lineStarts, L_txt, L_offset) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isNil)(function(){"use strict";return resolve(L_strMatch)(L_txt, L_zeroNum);})(function(){"use strict";return resolve(L_token)(L_txt, function(){"use strict";return resolve(L_filePosFor)(L_lineStarts, L_offset);});})(function(){"use strict";return resolve(L_token)(function(){"use strict";return resolve(L_strReplace)(L_txt, L_zeroPrefix, "");}, function(){"use strict";return resolve(L_filePosFor)(L_lineStarts, L_offset);});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str, L_pat) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_filter)(lazy(function(L_s){return resolve(L_not)(function(){"use strict";return resolve(L_eq)(L_s, "");})}))(function(){"use strict";return resolve(L_basicSplitTokens)(L_str, L_pat, L_true);});
  };
  return L_$_F;
})()))},
    ...
    function(){return resolve(L_newDefine)("zeroNum", 0, "zeroNum = regexp '^0+[0-9]'", function(){"use strict";return resolve(L_regexp)("^0+[0-9]");})},
    function(){return resolve(L_newDefine)("zeroPrefix", 0, "zeroPrefix = regexp '^0+'", function(){"use strict";return resolve(L_regexp)("^0+");})},
    function(){return resolve(L_newDefine)("matchOffset", 2, "matchOffset str match = isNil match\r\n  strLen str\r\n  head (tail (tail match))", lazy((function(){
  var L_$_F = function(L_str, L_match) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isNil)(L_match)(function(){"use strict";return resolve(L_strLen)(L_str);})(function(){"use strict";return resolve(L_head)(function(){"use strict";return resolve(L_tail)(function(){"use strict";return resolve(L_tail)(L_match);});});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str, L_pat, L_prevIsDel) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__reverse)(function(){"use strict";return resolve(L__withRecur)(function(){"use strict";return resolve(L__basicSplitTokens)(L_str, L_pat, L_prevIsDel, L_nil);});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str, L_pat, L_prevIsDel, L_toks) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_$p$p)(L_str, "")(L_toks)(function(){"use strict";return (function(){"use strict";
  ...
  var L_$_F = function(L_str, L_pat) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_countedTokens)(L_emptyLineStarts, L_str, L_pat);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_lineStarts, L_str, L_pat) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_makeTokens)(L_lineStarts, function(){"use strict";return resolve(L_splitTokens)(L_str, L_pat);}, 0);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_toks, L_groups) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_withCons)(L_toks, L_nil, lazy(function(L_h){return function(L_t){return resolve(L_withToken)(L_h, L_toks, lazy(function(L_txt){return function(L_pos){return resolve(L_assoc)(L_txt, L_groups)(lazy(function(L_close){return resolve(L_parseGroup)(L_h, L_t, L_nil, L_close, L_groups)}))(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_isTokenStart)(L_h, "\n");}, function(){"use strict";return resolve(L_isTokenStart)(L_h, "\r\n");})(function(){"use strict";return resolve(L_parseIndent)(L_h, L_t, L_nil, L_groups);})(L_toks);})}}))}}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_left, L_toks, L_gr, L_close, L_groups) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_withCons)(L_toks, function(){"use strict";return resolve(L_parseErr)("Unterminated group starting ", function(){"use strict";return resolve(L_loc)(L_left);});}, lazy(function(L_h){return function(L_t){return resolve(L_isTokenString)(L_h, L_close)(function(){"use strict";return resolve(L_eq)(L_close, ")")(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_parensFromToks)(L_left, L_h, function(){"use strict";return resolve(L__reverse)(L_gr);});}, L_t);})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)(L_left, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L__reverse)(L_gr);}, function(){"use strict";return resolve(L_cons)(L_h, L_nil);});});}, L_t);});})(function(){"use strict";return resolve(L_withToken)(L_h, function(){"use strict";return resolve(L_ifNotErr)(function(){"use strict";return resolve(L_parseTok)(L_toks, L_groups);}, lazy(function(L_list){return resolve(L_list)(lazy(function(L_restH){return function(L_restT){return resolve(L_parseGroup)(L_left, L_restT, function(){"use strict";return resolve(L_cons)(L_restH, L_gr);}, L_close, L_groups)}}))}));}, lazy(function(L_txt){return function(L_pos){return resolve(L_rassoc)(L_txt, L_groups)(lazy(function(L_open){return resolve(L_parseErr)(function(){"use strict";return resolve(L_strCat)(function(){"use strict";return resolve(L_cons)("Mismatched group: ", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_tokenString)(L_left);}, function(){"use strict";return resolve(L_cons)(L_txt, function(){"use strict";return resolve(L_cons)(" ", L_nil);});});});});}, function(){"use strict";return resolve(L_loc)(L_left);})}))(function(){"use strict";return resolve(L_ifNotErr)(function(){"use strict";return resolve(L_parseTok)(L_toks, L_groups);}, lazy(function(L_list){return resolve(L_list)(lazy(function(L_restH){return function(L_restT){return resolve(L_parseGroup)(L_left, L_restT, function(){"use strict";return resolve(L_cons)(L_restH, L_gr);}, L_close, L_groups)}}))}));})}}));})}}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_indent, L_toks, L_gr, L_groups) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_withCons)(L_toks, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_makeParens)(function(){"use strict";return resolve(L_tokenFilepos)(L_indent);}, function(){"use strict";return resolve(L_lexEnd)(function(){"use strict";return resolve(L_head)(L_gr);});}, function(){"use strict";return resolve(L__reverse)(L_gr);});}, L_nil);}, lazy(function(L_h){return function(L_t){return resolve(L_or)(function(){"use strict";return resolve(L_withToken)(L_h, L_false, lazy(function(L_txt){return function(L_pos){return resolve(L_rassoc)(L_txt, L_groups)(lazy(function(L_open){return resolve(L_true)}))(L_false)}}));}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_isTokenStart)(L_h, "\n");}, function(){"use strict";return resolve(L_isTokenStart)(L_h, "\r\n");});}, function(){"use strict";return resolve(L_$y$p)(function(){"use strict";return resolve(L_strLen)(function(){"use strict";return resolve(L_tokenString)(L_h);});}, function(){"use strict";return resolve(L_strLen)(function(){"use strict";return resolve(L_tokenString)(L_indent);});});});})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_makeParens)(function(){"use strict";return resolve(L_tokenFilepos)(L_indent);}, function(){"use strict";return resolve(L_tokenFilepos)(L_h);}, function(){"use strict";return resolve(L__reverse)(L_gr);});}, L_toks);})(function(){"use strict";return resolve(L_ifNotErr)(function(){"use strict";return resolve(L_parseTok)(L_toks, L_groups);}, lazy(function(L_list){return resolve(L_list)(lazy(function(L_restH){return function(L_restT){return resolve(L_parseIndent)(L_indent, L_restT, function(){"use strict";return resolve(L_cons)(L_restH, L_gr);}, L_groups)}}))}));})}}));
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("nilRange", L_true, "nilRange = cons 1 (cons 0 nil)", function(){"use strict";return resolve(L_cons)(1, function(){"use strict";return resolve(L_cons)(0, L_nil);});})},
    function(){return resolve(L_newDefine)("lit", 2, "lit value range = \\f . f value range", lazy(setDataType((function(){
  var L_$_F = function(L_value, L_range) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_value)(L_range)}, 'lit');
  };
  return L_$_F;
})(), 'lit')))},
    function(){return resolve(L_newDefine)("ref", 2, "ref name range = \\f . f name range", lazy(setDataType((function(){
  var L_$_F = function(L_name, L_range) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_name)(L_range)}, 'ref');
  };
  return L_$_F;
})(), 'ref')))},
    function(){return resolve(L_newDefine)("lambda", 3, "lambda name body range = \\f . f name body range", lazy(setDataType((function(){
  var L_$_F = function(L_name, L_body, L_range) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_name)(L_body)(L_range)}, 'lambda');
  };
  return L_$_F;
})(), 'lambda')))},
    function(){return resolve(L_newDefine)("apply", 2, "apply func arg = \\f . f func arg", lazy(setDataType((function(){
  var L_$_F = function(L_func, L_arg) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_func)(L_arg)}, 'apply');
  };
  return L_$_F;
})(), 'apply')))},
    function(){return resolve(L_newDefine)("let", 4, "let name value body range = \\f . f name value body range", lazy(setDataType((function(){
  var L_$_F = function(L_name, L_value, L_body, L_range) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_name)(L_value)(L_body)(L_range)}, 'let');
  };
  return L_$_F;
})(), 'let')))},
    function(){return resolve(L_newDefine)("anno", 3, "anno name data body = \\f . f name data body", lazy(setDataType((function(){
  var L_$_F = function(L_name, L_data, L_body) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_name)(L_data)(L_body)}, 'anno');
  };
  return L_$_F;
})(), 'anno')))},
    function(){return resolve(L_newDefine)("withParens", 3, "withParens p err cont = isParens p (p cont) err", lazy((function(){
  var L_$_F = function(L_p, L_err, L_cont) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isParens)(L_p)(function(){"use strict";return resolve(L_p)(L_cont);})(L_err);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_p, L_func) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isParens)(L_p)(function(){"use strict";return resolve(L_p)(lazy(function(L_start){return function(L_end){return function(L_content){return resolve(L_parens)(L_start, L_end, function(){"use strict";return resolve(L_func)(L_content);})}}}));})(function(){"use strict";return resolve(L_func)(L_p);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_lineStarts, L_inList, L_names) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_withStripped)(L_inList, lazy(function(L_list){return resolve(L_isToken)(L_list)(function(){"use strict";return resolve(L_createLitOrRef)(L_list, L_names);})(function(){"use strict";return resolve(L_list)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isTokenString)(L_h, "\\\\")(function(){"use strict";return resolve(L_createLet)(L_h, L_t, L_names);})(function(){"use strict";return resolve(L_isTokenString)(L_h, "\\@")(function(){"use strict";return resolve(L_createAnno)(L_h, L_t, L_names);})(function(){"use strict";return resolve(L_isTokenString)(L_h, "\\")(function(){"use strict";return resolve(L_createLambda)(L_h, L_t, L_names);})(function(){"use strict";return resolve(L_createApply)(L_list, L_names);});});})}}}))(L_nil);})}));
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("strMatches", 2, "strMatches str pat = isCons (strMatch str pat)", lazy((function(){
  var L_$_F = function(L_str, L_pat) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isCons)(function(){"use strict";return resolve(L_strMatch)(L_str, L_pat);});
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("digit", L_true, "digit = regexp '^[0-9]+$'", function(){"use strict";return resolve(L_regexp)("^[0-9]+$");})},
  ...
  var L_$_F = function(L_orig, L_str, L_cont) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  var L_res_0;
  ...
  var L_$_F = function(L_orig, L_str) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_eq)(L_str, "")(L_str)(function(){"use strict";return resolve(L_eq)(function(){"use strict";return resolve(L_strAt)(L_str, 0);}, "\\")(function(){"use strict";return resolve(L_eq)(function(){"use strict";return resolve(L_strLen)(L_str);}, 1)(function(){"use strict";return resolve(L_parseErr)("Error, backslash without character in string: ", L_orig);})(function(){"use strict";return (function(){"use strict";
  var L_rest_0;
  ...
  var L_$_F = function(L_str, L_cont) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_neq)(function(){"use strict";return resolve(L_strAt)(L_str, 0);}, function(){"use strict";return resolve(L_strAt)(L_str, -1);})(function(){"use strict";return resolve(L_parseErr)("Badly terminated string: ", L_str);})(function(){"use strict";return resolve(L_convertStringEscapes)(L_str, function(){"use strict";return resolve(L_strSubstring)(L_str, 1, -1);}, L_cont);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_token, L_names) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  ...
  return resolve(L__contains)(L_tok_0, L_names)(function(){"use strict";return resolve(L_ref)(L_tok_0, L_tokRange_1);})(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_strStartsWith)(L_tok_0, "\"");}, function(){"use strict";return resolve(L_strStartsWith)(L_tok_0, "'");})(function(){"use strict";return resolve(L_parseString)(L_tok_0, lazy(function(L_str){return resolve(L_lit)(L_str, L_tokRange_1)}));})(function(){"use strict";return resolve(L_strStartsWith)(L_tok_0, ".")(function(){"use strict";return resolve(L_jsonParse)(function(){"use strict";return resolve(L_strCat)(function(){"use strict";return resolve(L_cons)("0", function(){"use strict";return resolve(L_cons)(L_tok_0, L_nil);});});}, lazy(function(L_err){return resolve(L_ref)(L_tok_0, L_tokRange_1)}), lazy(function(L_item){return resolve(L_lit)(L_item, L_tokRange_1)}));})(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_$z$p)(function(){"use strict";return resolve(L_strAt)(L_tok_0, 0);}, "0");}, function(){"use strict";return resolve(L_$y$p)(function(){"use strict";return resolve(L_strAt)(L_tok_0, 0);}, "9");});}, function(){"use strict";return resolve(L_strStartsWith)(L_tok_0, "-");})(function(){"use strict";return resolve(L_jsonParse)(L_tok_0, lazy(function(L_err){return resolve(L_ref)(L_tok_0, L_tokRange_1)}), lazy(function(L_item){return resolve(L_lit)(L_item, L_tokRange_1)}));})(function(){"use strict";return resolve(L_ref)(L_tok_0, L_tokRange_1);});});});})})();
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_start, L_list, L_names) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  var L_err_0;
  ...
  var L_$_F = function(L_start, L_list, L_names) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_withCons)(L_list, function(){"use strict";return resolve(L_parseErr)("No annotation name or data in annotation ", function(){"use strict";return resolve(L_loc)(L_start);});}, lazy(function(L_name){return function(L_rest){return resolve(L_withCons)(L_rest, function(){"use strict";return resolve(L_parseErr)("No data for annotation ", function(){"use strict";return resolve(L_loc)(L_start);});}, lazy(function(L_data){return function(L_rest_0){return (function(){"use strict";
  var L_finish_1;
  ...
  return L_$_F;
    ...
    function(){return resolve(L_newDefine)("bodyStructPat", L_true, "bodyStructPat = regexp '\\\\|\\\\\\\\|\\\\@'", function(){"use strict";return resolve(L_regexp)("\\|\\\\|\\@");})},
  ...
  var L_$_F = function(L_inList, L_names) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_withStripped)(L_inList, lazy(function(L_list){return resolve(L_withCons)(L_list, function(){"use strict";return resolve(L_parseErr)("Funcion apply expecting a non-empty list ", function(){"use strict";return resolve(L_loc)(L_inList);});}, lazy(function(L_h){return function(L_t){return resolve(L_ifNotErr)(function(){"use strict";return resolve(L_createAst)(L_nil, L_h, L_names);}, lazy(function(L_func){return resolve(L_chainApply)(L_func, L_t, L_names)}))}}))}));
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("blockStarts", L_true, "blockStarts = cons '\\\\' (cons '\\\\\\\\' (cons '\\\\@' nil))", function(){"use strict";return resolve(L_cons)("\\", function(){"use strict";return resolve(L_cons)("\\\\", function(){"use strict";return resolve(L_cons)("\\@", L_nil);});});})},
  ...
  var L_$_F = function(L_func, L_list, L_names) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_withCons)(L_list, L_func, lazy(function(L_argItem){return function(L_rest){return resolve(L_and)(function(){"use strict";return resolve(L_isToken)(L_argItem);}, function(){"use strict";return resolve(L__contains)(function(){"use strict";return resolve(L_tokenString)(L_argItem);}, L_blockStarts);})(function(){"use strict";return resolve(L_ifNotErr)(function(){"use strict";return resolve(L_createAst)(L_nil, L_list, L_names);}, lazy(function(L_arg){return resolve(L_apply)(L_func, L_arg)}));})(function(){"use strict";return resolve(L_ifNotErr)(function(){"use strict";return resolve(L_createAst)(L_nil, L_argItem, L_names);}, lazy(function(L_arg){return resolve(L_chainApply)(function(){"use strict";return resolve(L_apply)(L_func, L_arg);}, L_rest, L_names)}));})}}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_start, L_toks, L_cont) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isToken)(L_toks)(function(){"use strict";return resolve(L_cont)(function(){"use strict";return resolve(L_tokenString)(L_toks);});})(function(){"use strict";return resolve(L_withCons)(L_toks, function(){"use strict";return resolve(L_cont)(L_toks);}, lazy(function(L_head){return function(L_tail){return resolve(L_cleanTokens)(L_start, L_head, lazy(function(L_head_0){return resolve(L_cleanTokens)(L_start, L_tail, lazy(function(L_tail_1){return resolve(L_cont)(function(){"use strict";return resolve(L_cons)(L_head_0, L_tail_1);})}))}))}}));});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_start, L_binding, L_body, L_names) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isTokenString)(L_binding, ".")(function(){"use strict";return resolve(L_createAst)(L_nil, L_body, L_names);})(function(){"use strict";return resolve(L_withCons)(L_body, function(){"use strict";return resolve(L_parseErr)("Let expected a body ", function(){"use strict";return resolve(L_loc)(L_start);});}, lazy(function(L_bodyH){return function(L_bodyT){return resolve(L_ifNotErr)(function(){"use strict";return resolve(L_getNameAndDef)(function(){"use strict";return resolve(L_parensStart)(L_binding);}, function(){"use strict";return resolve(L_parensContent)(L_binding);}, L_names);}, lazy(function(L_res){return resolve(L_res)(lazy(function(L_name){return function(L_def){return resolve(L_ifNotErr)(function(){"use strict";return resolve(L_createSublets)(L_start, L_bodyH, L_bodyT, L_names);}, lazy(function(L_bodyAst){return resolve(L_let)(function(){"use strict";return resolve(L_tokenString)(L_name);}, L_def, L_bodyAst, L_nilRange)}))}}))}))}}));});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_pos, L_def, L_args, L_names) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_withCons)(L_def, function(){"use strict";return resolve(L_parseErr)("Let expected binding at ", L_pos);}, lazy(function(L_arg){return function(L_rest){return resolve(L_not)(function(){"use strict";return resolve(L_isToken)(L_arg);})(function(){"use strict";return resolve(L_parseErr)("Let expected binding at ", L_pos);})(function(){"use strict";return resolve(L_isTokenString)(L_arg, "=")(function(){"use strict";return resolve(L_createAst)(L_nil, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_token)("\\", L_pos);}, function(){"use strict";return resolve(L__append)(function(){"use strict";return resolve(L__reverse)(L_args);}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_token)(".", function(){"use strict";return resolve(L_position)(L_arg);});}, L_rest);});});}, L_names);})(function(){"use strict";return resolve(L_getLetLambda)(L_pos, L_rest, function(){"use strict";return resolve(L_cons)(L_arg, L_args);}, L_names);});})}}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_lineStarts, L_str, L_pat, L_groups, L_props, L_onDef, L_onExpr) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  var L_toks_0, L_groupToks_1;
  L_toks_0 = function(){"use strict";return resolve(L_countedTokens)(L_lineStarts, L_str, L_pat);};
  L_groupToks_1 = function(){"use strict";return resolve(L__foldr)(lazy(function(L_el){return function(L_value){return resolve(L_el)(lazy(function(L_h){return function(L_t){return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_cons)(L_t, L_value);})}}))}}), function(){"use strict";return resolve(L_cons)("=", L_blockStarts);}, L_groups);};

  return resolve(L_find)(lazy(function(L_tok){return resolve(L_or)(function(){"use strict";return resolve(L__contains)(function(){"use strict";return resolve(L_tokenString)(L_tok);}, L_groupToks_1);}, function(){"use strict";return resolve(L_isCons)(function(){"use strict";return resolve(L_strMatch)(function(){"use strict";return resolve(L_tokenString)(L_tok);}, "^\r?\n");});})}))(L_toks_0)(lazy(function(L_item){return resolve(L_isTokenString)(L_item, "=")}))(L_false)(function(){"use strict";return resolve(L_toks_0)(lazy(function(L_name){return function(L_rest){return (function(){"use strict";
  var L_parseIt_2;
  ...
  var L_$_F = function(L_str, L_pat, L_groups, L_onDef, L_onExpr) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_countedScanLineG)(L_emptyLineStarts, L_str, L_pat, L_groups, L_nil, L_onDef, L_onExpr);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str, L_pat, L_names, L_groups, L_onDef, L_onExpr) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  var L_astCallback_0;
  ...
  var L_$_F = function(L_toks, L_name) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  var L_tok_0;
  ...
  var L_$_F = function(L_def, L_name, L_arity, L_src, L_props) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  var L_tok_0;
  ...
  var L_$_F = function(L_arity, L_props, L_ast) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_or)(function(){"use strict";return resolve(L_isNil)(L_props);}, function(){"use strict";return resolve(L_$p$p)(L_arity, 0);})(L_ast)(function(){"use strict";return resolve(L_subSpliceFuncProps)(L_props, L_ast);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_props, L_ast) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  ...
  var L_$_F = function(L_props, L_ast) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__foldr)(lazy(function(L_prop){return function(L_result){return resolve(L_cons)("\\@", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_prop);}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_tail)(L_prop);}, function(){"use strict";return resolve(L_cons)(".", L_result);});});})}}), L_ast, L_props);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_toks, L_curToks, L_name) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_withCons)(L_curToks, L_toks, lazy(function(L_h){return function(L_t){return resolve(L_isTokenString)(L_h, "=")(function(){"use strict";return resolve(L_isTokenString)(function(){"use strict";return resolve(L_head)(L_t);}, "\\")(function(){"use strict";return resolve(L_setDataTypeAnno)(L_toks, L_name);})(L_toks);})(function(){"use strict";return resolve(L_checkSetDataType)(L_toks, L_t, L_name);})}}));
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("arity", 2, "arity toks n = isTokenString (head toks) '=' n (arity (tail toks) (+ n 1))", lazy((function(){
  var L_$_F = function(L_toks, L_n) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isTokenString)(function(){"use strict";return resolve(L_head)(L_toks);}, "=")(L_n)(function(){"use strict";return resolve(L_arity)(function(){"use strict";return resolve(L_tail)(L_toks);}, function(){"use strict";return resolve(L_$o)(L_n, 1);});});
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("tokListStr", 1, "tokListStr toks = jsonStringify (_strJoin (_map (\\t . tokenString t) toks) ' ')", lazy(function(L_toks){return resolve(L_jsonStringify)(function(){"use strict";return resolve(L__strJoin)(function(){"use strict";return resolve(L__map)(lazy(function(L_t){return resolve(L_tokenString)(L_t)}), L_toks);}, " ");})}))},
    ...
    function(){return resolve(L_newDefine)("linesForFile", 1, "linesForFile text = _map tail (countedLinesForFile \"NOTHING.lsr\" text)", lazy(function(L_text){return resolve(L__map)(L_tail, function(){"use strict";return resolve(L_countedLinesForFile)("NOTHING.lsr", L_text);})}))},
  ...
  var L_$_F = function(L_name, L_text) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_filter)(lazy(function(L_line){return resolve(L_isNil)(function(){"use strict";return resolve(L_strMatch)(function(){"use strict";return resolve(L_tail)(L_line);}, L_emptyLinePat);})}))(function(){"use strict";return resolve(L_countedLines)(L_name, 1, L_text);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_filename, L_lineOffset, L_str) {
    return L_checkPartial(L_$_F, arguments) || resolve(L__reverse)(function(){"use strict";return resolve(L__withRecur)(function(){"use strict";return resolve(L__countedLines)(L_filename, L_lineOffset, L_str, L_nil);});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_filename, L_lineOffset, L_str, L_lines) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  ...
  var L_$_F = function(L_filters, L_line) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_filters))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){"use strict";return resolve(L_h)(L_line);}, lazy(function(L_filtered){return resolve(L_runParseFilters)(L_t, L_filtered)}))}}}), function(){"use strict";return resolve(L_fakereturn)(L_line);});
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("isBlockStart", 1, "isBlockStart tok = and\r\n  or (isToken tok) (isString tok)\r\n  _contains (strTokenString tok) blockStarts", lazy(function(L_tok){return resolve(L_and)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_isToken)(L_tok);}, function(){"use strict";return resolve(L_isString)(L_tok);});}, function(){"use strict";return resolve(L__contains)(function(){"use strict";return resolve(L_strTokenString)(L_tok);}, L_blockStarts);})}))},
  ...
  var L_$_F = function(L_macs, L_expr) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_postProcessMacro)(function(){"use strict";return resolve(L_emptyFor)(L_expr);}, function(){"use strict";return resolve(L_emptyFor)(L_expr);}, function(){"use strict";return resolve(L_baseMacroSub)(L_macs, L_expr);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_macs, L_expr) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isToken)(L_expr)(L_expr)(function(){"use strict";return resolve(L_isParens)(L_expr)(function(){"use strict";return resolve(L_expr)(lazy(function(L_start){return function(L_end){return function(L_content){return (function(){"use strict";
  var L_result_0;
  ...
  return resolve(L_withToken)(L_subH_0, function(){"use strict";return resolve(L_cons)(L_subH_0, function(){"use strict";return resolve(L__map)(function(){"use strict";return resolve(L_baseMacroSub)(L_macs);}, L_t);});}, lazy(function(L_tok){return function(L_pos){return resolve(L_baseMacroSub)(L_macs, function(){"use strict";return resolve(L_cons)(L_subH_0, L_t);})}}))})();}, lazy(function(L_tok){return function(L_pos){return resolve(L_assoc)(L_tok, L_macs)(lazy(function(L_def){return resolve(L_baseMacroSub)(L_macs, function(){"use strict";return resolve(L_def)(L_t);})}))(function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L__map)(function(){"use strict";return resolve(L_baseMacroSub)(L_macs);}, L_t);});})}}));})}}));});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_macs, L_list) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isTokenString)(L_h, ".")(function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_baseMacroSub)(L_macs, L_t);});})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_setParens)(L_h, lazy(function(L_content){return resolve(L_macroSubBody)("=", L_macs, L_content)}));}, function(){"use strict";return resolve(L_macroSubLet)(L_macs, L_t);});})}}}), L_nil);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_char, L_macs, L_list) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_isTokenString)(L_h, L_char)(L_baseMacroSub)(function(){"use strict";return resolve(L_macroSubBody)(L_char);})(L_macs)(L_t);})}}}), L_nil);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_before, L_after, L_expr) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isString)(L_expr)(function(){"use strict";return resolve(L_token)(L_expr, function(){"use strict";return resolve(L_isEmptyPos)(L_after)(L_before)(L_after);});})(function(){"use strict";return resolve(L_isParens)(L_expr)(function(){"use strict";return resolve(L_expr)(lazy(function(L_start){return function(L_end){return function(L_contents){return resolve(L_parens)(L_start, L_end, function(){"use strict";return resolve(L_postProcessMacro)(L_start, L_end, L_contents);})}}}));})(function(){"use strict";return resolve(L_isCons)(L_expr)(function(){"use strict";return resolve(L_expr)(lazy(function(L_h){return function(L_t){return resolve(L_isToken)(L_h)(function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_postProcessMacro)(function(){"use strict";return resolve(L_addFilepos)(function(){"use strict";return resolve(L_addFilepos)(function(){"use strict";return resolve(L_tokenFilepos)(L_h);}, function(){"use strict";return resolve(L_strLen)(function(){"use strict";return resolve(L_tokenString)(L_h);});});}, 1);}, function(){"use strict";return resolve(L_emptyFor)(L_h);}, L_t);});})(function(){"use strict";return (function(){"use strict";
  ...
  var L_$_F = function(L_name, L_def) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_primBind)(function(){"use strict";return resolve(L_getValue)("macroDefs");}, lazy(function(L_macs){return resolve(L_setValue)("macroDefs", function(){"use strict";return resolve(L_acons)(L_name, L_def, L_macs);})}));
  };
  return L_$_F;
})()))},
    ...
    function(){return resolve(L_newDefine)("addToken", 1, "addToken del = primBind (getValue 'tokenList')\r\n  \\dels . _contains del dels\r\n    false\r\n    \\\\\r\n      newDels = insertSorted (\\a b . > (strLen a) (strLen b)) del dels\r\n      .\r\n      primBind (setValue 'tokenList' newDels)\r\n        \\_ . computeTokenPat newDels", lazy(function(L_del){return resolve(L_primBind)(function(){"use strict";return resolve(L_getValue)("tokenList");}, lazy(function(L_dels){return resolve(L__contains)(L_del, L_dels)(L_false)(function(){"use strict";return (function(){"use strict";
  var L_newDels_0;
  ...
  L_delPats_0 = function(){"use strict";return resolve(L__map)(lazy(function(L_item){return resolve(L_strReplace)(L_item, L_regexpEscapePat, "\\$&")}), L_dels);};
  L_newPat_1 = function(){"use strict";return resolve(L_strCat)(function(){"use strict";return resolve(L_cons)("(", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L__strJoin)(function(){"use strict";return resolve(L_cons)(L_delimiterListPrefix, L_delPats_0);}, "|");}, function(){"use strict";return resolve(L_cons)(")", L_nil);});});});};
  ...
  var L_$_F = function(L_open, L_close) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_primBind)(function(){"use strict";return resolve(L_addToken)(L_open);}, lazy(function(L__){return resolve(L_primBind)(function(){"use strict";return resolve(L_addToken)(L_close);}, lazy(function(L___0){return resolve(L_primBind)(function(){"use strict";return resolve(L_getValue)("tokenGroups");}, lazy(function(L_gr){return resolve(L_setValue)("tokenGroups", function(){"use strict";return resolve(L_acons)(L_open, L_close, L_gr);})}))}))}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str, L_pat, L_groups) {
  ...
  var L_$_F = function(L_str, L_pat) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_createAst)(L_nil, function(){"use strict";return resolve(L_testParse)(L_str)(L_pat);}, L_nil);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str, L_pat, L_onDef, L_onExpr) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_scanLineG)(L_str, L_pat, L_parenGroups, L_onDef, L_onExpr);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_str, L_pat, L_names, L_onDef, L_onExpr) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_parseLineG)(L_str, L_pat, L_names, L_parenGroups, L_onDef, L_onExpr);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_lines, L_result) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_lines))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){"use strict";return resolve(L_parseLineM)(L_h);}, lazy(function(L_ast){return resolve(L_parseLines)(L_t, function(){"use strict";return resolve(L_cons)(L_ast, L_result);})}))}}}), function(){"use strict";return resolve(L__reverse)(L_result);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_offset, L_line) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  var L_m_0, L_idx_1;
  ...
  var L_$_F = function(L_offset, L_names, L_line) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_primBind)(function(){"use strict";return resolve(L_scanLineM)(L_line);}, lazy(function(L_scanned){return resolve(L_ifNotErr)(function(){"use strict";return resolve(L_createAst)(function(){"use strict";return resolve(L_cons)("NEWPARSE.lsr", function(){"use strict";return resolve(L_findLines)(L_offset, L_line);});}, L_scanned, L_names);}, L_id)}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_names, L_countedLine) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_primBind)(function(){"use strict";return resolve(L_countedScanLineM)(function(){"use strict";return resolve(L_head)(L_countedLine);}, function(){"use strict";return resolve(L_tail)(L_countedLine);});}, lazy(function(L_scanned){return resolve(L_createAst)(function(){"use strict";return resolve(L_head)(L_countedLine);}, L_scanned, L_names)}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_offset, L_names, L_line) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_primBind)(function(){"use strict";return resolve(L_newParseLine)(L_offset, L_names, L_line);}, lazy(function(L_ast){return resolve(L_primBind)(function(){"use strict";return resolve(L_runAst)(L_line)(L_ast);}, lazy(function(L_res){return resolve(L_primBind)(L_res, lazy(function(L_result){return resolve(L_cons)(L_ast, function(){"use strict";return resolve(L_isErr)(L_result)(function(){"use strict";return resolve(L_left)(function(){"use strict";return resolve(L_errMsg)(L_result);});})(function(){"use strict";return resolve(L_right)(L_result);});})}))}))}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_file, L_names, L_countedLine) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_primBind)(function(){"use strict";return resolve(L_countedParseLine)(L_names, L_countedLine);}, lazy(function(L_ast){return (function(){"use strict";
  var L_wrapped_0;
  ...
  var L_$_F = function(L_wrapped, L_result) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_cons)(L_wrapped, function(){"use strict";return resolve(L_isErr)(L_result)(function(){"use strict";return resolve(L_left)(function(){"use strict";return resolve(L_errMsg)(L_result);});})(function(){"use strict";return resolve(L_right)(L_result);});});
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("astFileWrap", 2, "astFileWrap file ast = anno 'filename' (basename file) ast", lazy((function(){
  var L_$_F = function(L_file, L_ast) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_anno)("filename", function(){"use strict";return resolve(L_basename)(L_file);}, L_ast);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_names, L_lines) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_lines))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){"use strict";return resolve(L_runLine)(0, L_names, L_h);}, lazy(function(L_line){return resolve(L_primBind)(function(){"use strict";return resolve(L_runLines)(L_names, L_t);}, lazy(function(L_rest){return resolve(L_cons)(L_line, L_rest)}))}))}}}), L_nil);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_file, L_names, L_countedLines, L_result) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_countedLines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){"use strict";return resolve(L_countedRunLine)(L_file, L_names, L_h);}, lazy(function(L_line){return resolve(L_countedRunLines)(L_file, L_names, L_t, function(){"use strict";return resolve(L_cons)(L_line, L_result);})}))}}}))(function(){"use strict";return resolve(L__reverse)(L_result);});
  };
  return L_$_F;
})()))},
  ...
  L_lines_1 = function(){"use strict";return resolve(L__map)(L_tail, L_counted_0);};
  ...
  var L_$_F = function(L_file, L_contents) {
  ...
  var L_errs_0;
  L_errs_0 = function(){"use strict";return resolve(L__foldr)(lazy(function(L_line){return function(L_results){return resolve(L_tail)(L_line)(lazy(function(L_er){return resolve(L_cons)(L_er, L_results)}))(lazy(function(L_x){return resolve(L_results)}))}}), L_nil, L_result);};
  ...
  return resolve(L_isNil)(L_errs_0)(function(){"use strict";return resolve(L_right)(L_true);})(function(){"use strict";return resolve(L_left)(L_errs_0);})})()}))}))},
    function(){return resolve(L_newDefine)("require", 1, "require file = primBind (getValue 'requiredFiles')\r\n  \\files . _contains file files\r\n    right false\r\n    primBind (setValue 'requiredFiles' (cons file files))\r\n      \\_. primBind (load file)\r\n        \\result . result\r\n          \\x . left x\r\n          \\_ . right true", lazy(function(L_file){return resolve(L_primBind)(function(){"use strict";return resolve(L_getValue)("requiredFiles");}, lazy(function(L_files){return resolve(L__contains)(L_file, L_files)(function(){"use strict";return resolve(L_right)(L_false);})(function(){"use strict";return resolve(L_primBind)(function(){"use strict";return resolve(L_setValue)("requiredFiles", function(){"use strict";return resolve(L_cons)(L_file, L_files);});}, lazy(function(L__){return resolve(L_primBind)(function(){"use strict";return resolve(L_load)(L_file);}, lazy(function(L_result){return resolve(L_result)(lazy(function(L_x){return resolve(L_left)(L_x)}))(lazy(function(L___0){return resolve(L_right)(L_true)}))}))}));})}))}))},
    function(){return resolve(L_newDefine)("scanFile", 1, "scanFile file = primBind (readFile file)\r\n  \\result . result\r\n    \\err . err\r\n      \\_ . primBind (runNamedFile file contents)\r\n        counted = countedLinesForFile name text\r\n        lines = _map tail counted\r\n        names = namesForLines lines\r\n        .\r\n        countedScanLines name names counted", lazy(function(L_file){return resolve(L_primBind)(function(){"use strict";return resolve(L_readFile)(L_file);}, lazy(function(L_result){return resolve(L_result)(lazy(function(L_err){return resolve(L_err)(lazy(function(L__){return resolve(L_primBind)(function(){"use strict";return resolve(L_runNamedFile)(L_file, L_contents);}, function(){"use strict";return L$(resolve(L_counted))(L_$p, L_countedLinesForFile, L_name, L_text);})(function(){"use strict";return L$(resolve(L_lines))(L_$p, L__map, L_tail, L_counted);})(function(){"use strict";return L$(resolve(L_names))(L_$p, L_namesForLines, L_lines);})(L_$B)(function(){"use strict";return resolve(L_countedScanLines)(L_name, L_names, L_counted);})}))}))}))}))},
  ...
  var L_$_F = function(L_file, L_names, L_countedLines) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_countedLines)(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_primBind)(function(){"use strict";return resolve(L_countedScanLineM)(function(){"use strict";return resolve(L_head)(L_h);}, function(){"use strict";return resolve(L_tail)(L_h);});}, lazy(function(L_line){return resolve(L_primBind)(function(){"use strict";return resolve(L_countedScanLines)(L_file, L_names, L_t);}, lazy(function(L_rest){return resolve(L_cons)(L_line, L_rest)}))}))}}}))(L_nil);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_name, L_pack) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_primBind)(function(){"use strict";return resolve(L_getValue)("tokenPacks");}, lazy(function(L_packs){return resolve(L_setValue)("tokenPacks", function(){"use strict";return resolve(L_acons)(L_name, L_pack, L_packs);})}));
  };
  return L_$_F;
})()))},
  ...
  L_groupToks_0 = function(){"use strict";return resolve(L__foldl)(lazy(function(L_value){return function(L_el){return resolve(L_el)(lazy(function(L_h){return function(L_t){return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_cons)(L_t, L_value);})}}))}}), L_nil, function(){"use strict";return resolve(L_head)(function(){"use strict";return resolve(L_tail)(L_pack);});});};
  L_newToks_1 = function(){"use strict";return resolve(L__sort)(lazy(function(L_a){return function(L_b){return resolve(L_$z)(function(){"use strict";return resolve(L_strLen)(L_a);}, function(){"use strict";return resolve(L_strLen)(L_b);})}}), function(){"use strict";return resolve(L__append)(function(){"use strict";return resolve(L_head)(L_pack);}, function(){"use strict";return resolve(L__append)(L_groupToks_0, L_tokens);});});};

  return resolve(L_primBind)(function(){"use strict";return resolve(L_setValue)("tokenList", L_newToks_1);}, lazy(function(L__){return resolve(L_primBind)(function(){"use strict";return resolve(L_setValue)("tokenGroups", function(){"use strict";return resolve(L_appendAlist)(function(){"use strict";return resolve(L_head)(function(){"use strict";return resolve(L_tail)(L_pack);});}, L_groups);});}, lazy(function(L___2){return resolve(L_primBind)(function(){"use strict";return resolve(L_setValue)("parseFilters", function(){"use strict";return resolve(L__append)(L_filters, function(){"use strict";return resolve(L_head)(function(){"use strict";return resolve(L_tail)(function(){"use strict";return resolve(L_tail)(L_pack);});});});});}, lazy(function(L___3){return resolve(L_primBind)(function(){"use strict";return resolve(L_computeTokenPat)(L_newToks_1);}, lazy(function(L___4){return resolve(L_setValue)("activeTokenPacks", function(){"use strict";return resolve(L_cons)(L_name, L_activePacks);})}))}))}))}))})()}))(L_nil)}))}))}))}))}))}))},
    function(){return resolve(L_newDefine)("resetTokenPacks", 1, "resetTokenPacks packs = primBind (setValue 'tokenGroups' nil)\r\n  \\_ . primBind (setValue 'tokenList' nil)\r\n    \\_ . primBind (setValue 'activeTokenPacks' nil)\r\n      \\_ . primBind (setValue 'parseFilters' nil)\r\n        \\_ . _foldr1\r\n          \\packCmd result . primBind packCmd \\_ . result\r\n          _map useTokenPack packs", lazy(function(L_packs){return resolve(L_primBind)(function(){"use strict";return resolve(L_setValue)("tokenGroups", L_nil);}, lazy(function(L__){return resolve(L_primBind)(function(){"use strict";return resolve(L_setValue)("tokenList", L_nil);}, lazy(function(L___0){return resolve(L_primBind)(function(){"use strict";return resolve(L_setValue)("activeTokenPacks", L_nil);}, lazy(function(L___1){return resolve(L_primBind)(function(){"use strict";return resolve(L_setValue)("parseFilters", L_nil);}, lazy(function(L___2){return resolve(L__foldr1)(lazy(function(L_packCmd){return function(L_result){return resolve(L_primBind)(L_packCmd, lazy(function(L___3){return resolve(L_result)}))}}), function(){"use strict";return resolve(L__map)(L_useTokenPack, L_packs);})}))}))}))}))}))},
    ...
    function(){return resolve(L_newDefine)("addStdTokenPacks", 1, "addStdTokenPacks morePacks = primBind (getValue 'stdTokenPacks')\r\n  \\stds . setValue 'stdTokenPacks' (_append stds morePacks)", lazy(function(L_morePacks){return resolve(L_primBind)(function(){"use strict";return resolve(L_getValue)("stdTokenPacks");}, lazy(function(L_stds){return resolve(L_setValue)("stdTokenPacks", function(){"use strict";return resolve(L__append)(L_stds, L_morePacks);})}))}))},
    function(){return resolve(L_newDefine)("addParseFilter", 1, "addParseFilter filt = primBind (getValue 'parseFilters')\r\n  \\filters . setValue 'parseFilters' (_append filters (cons filt nil))", lazy(function(L_filt){return resolve(L_primBind)(function(){"use strict";return resolve(L_getValue)("parseFilters");}, lazy(function(L_filters){return resolve(L_setValue)("parseFilters", function(){"use strict";return resolve(L__append)(L_filters, function(){"use strict";return resolve(L_cons)(L_filt, L_nil);});})}))}))},
    function(){return resolve(L_newDefine)("d", 3, "d label value expr = log (strCat (cons label (cons value nil))) expr", lazy((function(){
  var L_$_F = function(L_label, L_value, L_expr) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_log)(function(){"use strict";return resolve(L_strCat)(function(){"use strict";return resolve(L_cons)(L_label, function(){"use strict";return resolve(L_cons)(L_value, L_nil);});});}, L_expr);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("dd", 2, "dd label arg = d label arg arg", lazy((function(){
  var L_$_F = function(L_label, L_arg) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_d)(L_label, L_arg, L_arg);
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_f, L_l) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_find)(L_f)(L_l)(lazy(function(L_el){return resolve(L_true)}))(L_false);
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("all", 2, "all f l = not (any (compose not f) l)", lazy((function(){
  var L_$_F = function(L_f, L_l) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_not)(function(){"use strict";return resolve(L_any)(function(){"use strict";return resolve(L_compose)(L_not, L_f);}, L_l);});
  };
  return L_$_F;
})()))},
  ...
  return resolve(L_isNil)(L_list)(L_false)(function(){"use strict";return L$(resolve(L_func))(function(){"use strict";return resolve(L_head)(L_list);}, L_nil, function(){"use strict";return resolve(L_$p$p)(L_ret_0, L_false)(L_false)(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_head)(L_list);}, L_ret_0);});});})})();
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("dropAfter", 2, "dropAfter func list = isNil list\r\n  nil\r\n  func (head list)\r\n    tail list\r\n    dropAfter func (tail list)", lazy((function(){
  var L_$_F = function(L_func, L_list) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isNil)(L_list)(L_nil)(function(){"use strict";return L$(resolve(L_func))(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_tail)(L_list);}, function(){"use strict";return resolve(L_dropAfter)(L_func, function(){"use strict";return resolve(L_tail)(L_list);});});});
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("doall", 1, "doall x = isNil x\r\n  unit\r\n  _foldr1 (\\el res . primBind el \\_ . res) x", lazy(function(L_x){return resolve(L_isNil)(L_x)(L_unit)(function(){"use strict";return resolve(L__foldr1)(lazy(function(L_el){return function(L_res){return resolve(L_primBind)(L_el, lazy(function(L__){return resolve(L_res)}))}}), L_x);})}))},
    function(){return resolve(L_newDefine)("aconsf", 3, "aconsf key value list = acons key value (aremove key list)", lazy((function(){
  var L_$_F = function(L_key, L_value, L_list) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_acons)(L_key, L_value, function(){"use strict";return resolve(L_aremove)(L_key, L_list);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_key, L_list) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isNil)(L_list)(L_nil)(function(){"use strict";return resolve(L_eq)(function(){"use strict";return resolve(L_head)(function(){"use strict";return resolve(L_head)(L_list);});}, L_key)(function(){"use strict";return resolve(L_aremove)(L_key, function(){"use strict";return resolve(L_tail)(L_list);});})(function(){"use strict";return resolve(L_aconsPair)(function(){"use strict";return resolve(L_head)(L_list);}, function(){"use strict";return resolve(L_aremove)(L_key, function(){"use strict";return resolve(L_tail)(L_list);});});});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_op, L_list, L_last) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isTokenString)(L_h, "|")(function(){"use strict";return resolve(L_cons)(L_t, L_nil);})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)(L_op, function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_listifyOp)(L_op, L_t, L_last);});});}, L_nil);})}}}), function(){"use strict";return resolve(L_cons)(L_last, L_nil);});
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("listify", 1, "listify list = listifyOp 'cons' list 'nil'", lazy(function(L_list){return resolve(L_listifyOp)("cons", L_list, "nil")}))},
    function(){return resolve(L_newDefine)("listFilter", 1, "listFilter code = primBind (getValue 'listMacros')\r\n  \\listMacros . filterApplies code \\list . list \\h t .\r\n    and (isToken h) (_contains (tokenString h) listMacros)\r\n      listFilterTail list\r\n      list", lazy(function(L_code){return resolve(L_primBind)(function(){"use strict";return resolve(L_getValue)("listMacros");}, lazy(function(L_listMacros){return resolve(L_filterApplies)(L_code, lazy(function(L_list){return resolve(L_list)(lazy(function(L_h){return function(L_t){return resolve(L_and)(function(){"use strict";return resolve(L_isToken)(L_h);}, function(){"use strict";return resolve(L__contains)(function(){"use strict";return resolve(L_tokenString)(L_h);}, L_listMacros);})(function(){"use strict";return resolve(L_listFilterTail)(L_list);})(L_list)}}))}))}))}))},
  ...
  var L_$_F = function(L_code, L_func) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isParens)(L_code)(function(){"use strict";return resolve(L_code)(lazy(function(L_start){return function(L_end){return function(L_contents){return resolve(L_parens)(L_start, L_end, function(){"use strict";return resolve(L_filterApplies)(L_contents, L_func);})}}}));})(function(){"use strict";return resolve(L_isCons)(L_code)(function(){"use strict";return (function(){"use strict";
  var L_filtered_0;
  ...
  var L_$_F = function(L_type, L_code, L_func) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isTokenString)(L_type, "\\")(function(){"use strict";return resolve(L_filterLambda)(L_code, L_func);})(function(){"use strict";return resolve(L_filterLet)(L_code, L_func);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_code, L_func) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_code)(lazy(function(L_h){return function(L_t){return resolve(L_isTokenString)(L_h, ".")(function(){"use strict";return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_filterApplies)(L_t, L_func);});})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_filterLetBinding)(L_h, L_func);}, function(){"use strict";return resolve(L_filterLet)(L_t, L_func);});})}}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_code, L_func) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_isParens)(L_code)(function(){"use strict";return resolve(L_setParens)(L_code, lazy(function(L_contents){return resolve(L_filterLetBinding)(L_contents, L_func)}));})(function(){"use strict";return resolve(L_isCons)(L_code)(function(){"use strict";return resolve(L_code)(lazy(function(L_h){return function(L_t){return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_isTokenString)(L_h, "=")(function(){"use strict";return resolve(L_filterApplies)(L_t, L_func);})(function(){"use strict";return resolve(L_filterLetBinding)(L_t, L_func);});})}}));})(L_code);});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_code, L_func) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_code)(lazy(function(L_h){return function(L_t){return resolve(L_cons)(L_h, function(){"use strict";return resolve(L_isTokenString)(L_h, ".")(function(){"use strict";return resolve(L_filterApplies)(L_t, L_func);})(function(){"use strict";return resolve(L_filterLambda)(L_t, L_func);});})}}));
  };
  return L_$_F;
})()))},
    ...
    function(){return resolve(L_setValue)("listMacros", function(){"use strict";return resolve(L_cons)("[", function(){"use strict";return resolve(L_cons)("{", L_nil);});})},
    function(){return resolve(L_addParseFilter)(L_listFilter)},
    function(){return resolve(L_addTokenGroup)("{", "}")},
    function(){return resolve(L_defMacro)("{", lazy(function(L_list){return resolve(L_list)(lazy(function(L_h){return function(L_t){return resolve(L_listifyOp)("aconsPair", L_h, "nil")}}))}))},
    function(){return resolve(L_defTokenPack)("list", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)("|", function(){"use strict";return resolve(L_cons)("=", L_nil);});}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_aconsPair)(function(){"use strict";return resolve(L_cons)("{", "}");}, function(){"use strict";return resolve(L_aconsPair)(function(){"use strict";return resolve(L_cons)("[", "]");}, function(){"use strict";return resolve(L_aconsPair)(function(){"use strict";return resolve(L_cons)("or[", "]");}, function(){"use strict";return resolve(L_aconsPair)(function(){"use strict";return resolve(L_cons)("and[", "]");}, function(){"use strict";return resolve(L_aconsPair)(function(){"use strict";return resolve(L_cons)("concat[", "]");}, function(){"use strict";return resolve(L_aconsPair)(function(){"use strict";return resolve(L_cons)("print[", "]");}, function(){"use strict";return resolve(L_aconsPair)(function(){"use strict";return resolve(L_cons)("concatFlat[", "]");}, L_nil);});});});});});});}, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)(L_listFilter, L_nil);}, L_nil);});});})},
  ...
  var L_$_F = function(L_op, L_emptyCase, L_list) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_list)(lazy(function(L_h){return function(L_t){return resolve(L__foldr)(lazy(function(L_case){return function(L_result){return resolve(L_cons)(L_op, function(){"use strict";return resolve(L_cons)(L_case, function(){"use strict";return resolve(L_cons)(L_result, L_nil);});})}}), L_emptyCase, L_h)}}));
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_prec, L_right, L_closes, L_list) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  ...
  var L_$_F = function(L_opPrec, L_prec, L_right, L_closes, L_head1, L_head2, L_tail2, L_head3, L_len) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  ...
  return resolve(L_infixShouldEatNext)(L_opPrec, L_prec, function(){"use strict";return resolve(L__contains)(function(){"use strict";return resolve(L_strTokenString)(L_head2);}, L_right);}, L_head3, L_head4_1, L_head5_3, L_closes, L_len)(function(){"use strict";return resolve(L_cons)(L_head1, function(){"use strict";return resolve(L_cons)(L_head2, function(){"use strict";return resolve(L_absorbArgument)(function(){"use strict";return resolve(L_getPrec)(L_prec, L_head4_1);}, L_prec, L_right, L_closes, L_head3, L_head4_1, L_tail4_2, L_head5_3, function(){"use strict";return resolve(L_$_)(L_len, 2);});});});})(function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)(L_head2, function(){"use strict";return resolve(L_cons)(L_head1, function(){"use strict";return resolve(L_cons)(L_head3, L_nil);});});}, L_tail3_0);})})();
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_closes, L_item) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_or)(function(){"use strict";return resolve(L_isParens)(L_item);}, function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_isCons)(L_item);}, function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_isToken)(L_item);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_not)(function(){"use strict";return resolve(L__contains)(function(){"use strict";return resolve(L_tokenString)(L_item);}, L_closes);});}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_not)(function(){"use strict";return resolve(L_isBlockStart)(L_item);});}, L_true);});});}, L_false);});});
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("isInfix", 4, "isInfix opPrec head1 head2 len = and[\r\n  > len 1\r\n  > opPrec -1\r\n  isInfixArg nil head1]", lazy((function(){
  var L_$_F = function(L_opPrec, L_head1, L_head2, L_len) {
    return L_checkPartial(L_$_F, arguments) || resolve(L_and)(function(){"use strict";return resolve(L_$z)(L_len, 1);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_$z)(L_opPrec, -1);}, function(){"use strict";return resolve(L_and)(function(){"use strict";return resolve(L_isInfixArg)(L_nil, L_head1);}, L_true);});});
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_prec, L_token) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  var L_str_0;
  L_str_0 = function(){"use strict";return resolve(L_tokenString)(L_token);};

  return resolve(L_isToken)(L_token)(function(){"use strict";return resolve(L_findIndex)(lazy(function(L_level){return resolve(L__contains)(L_str_0, L_level)}), L_prec);})(-1)})();
  };
  return L_$_F;
})()))},
  ...
  var L_$_F = function(L_opPrec, L_prec, L_isRight, L_curArg, L_nextOp, L_nextArg, L_closes, L_len) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  var L_nextPrec_0;
  ...
  var L_$_F = function(L_list, L_inLet, L_foldVar, L_cont) {
    return L_checkPartial(L_$_F, arguments) || L$(resolve(L_list))(lazy(function(L_h){return function(L_t){return function(L_D){return resolve(L_isNil)(L_t)(function(){"use strict";return resolve(L_cont)(function(){"use strict";return L$(resolve(L_inLet))(function(){"use strict";return resolve(L_cons)(".", function(){"use strict";return resolve(L_cons)(L_h, L_nil);});}, function(){"use strict";return resolve(L_cons)(L_h, L_nil);});});})(function(){"use strict";return (function(){"use strict";
  ...
  var L_$_F = function(L_steppingClause, L_clause, L_prefix, L_inLet, L_foldVar) {
    return L_checkPartial(L_$_F, arguments) || (function(){"use strict";
  var L_makeBind_0, L_h_1, L_t_2;
  L_makeBind_0 = function(){"use strict";return function(L_var){return function(L_value){return resolve(L_triple)(L_false, L_foldVar, lazy(function(L_rest){return L$(resolve(L_inLet))(function(){"use strict";return resolve(L_cons)(".");}, L_id, function(){"use strict";return resolve(L_cons)("bind", function(){"use strict";return resolve(L_cons)(L_value, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)("\\", function(){"use strict";return resolve(L_cons)(L_var, function(){"use strict";return resolve(L_cons)(".", L_rest);});});}, L_nil);});});})}))}};};
  ...
  return resolve(L_isCons)(L_steppingClause)(function(){"use strict";return resolve(L_isTokenString)(L_h_1, "=")(function(){"use strict";return resolve(L_triple)(L_true, L_foldVar, lazy(function(L_rest){return L$(resolve(L_inLet))(function(){"use strict";return resolve(L_cons)(L_clause, L_rest);}, function(){"use strict";return resolve(L_cons)("\\\\", function(){"use strict";return resolve(L_cons)(L_clause, L_rest);});})}));})(function(){"use strict";return resolve(L_isTokenString)(L_h_1, "<-")(function(){"use strict";return resolve(L_isNil)(L_t_2)(function(){"use strict";return resolve(L_parseErr)("No value in do-clause: ", L_clause);})(function(){"use strict";return L$(resolve(L_prefix))(lazy(function(L_ph){return function(L_pt){return function(L_D){return resolve(L_isNil)(L_pt)(function(){"use strict";return resolve(L_makeBind_0)(function(){"use strict";return resolve(L_isNil)(L_prefix)("_")(function(){"use strict";return resolve(L_head)(L_prefix);});})(L_t_2);})(function(){"use strict";return resolve(L_any)(lazy(function(L_el){return resolve(L_not)(function(){"use strict";return resolve(L_or)(function(){"use strict";return resolve(L_isString)(L_el);}, function(){"use strict";return resolve(L_isToken)(L_el);});})}), L_prefix)(function(){"use strict";return resolve(L_parseErr)("Non-variable for bind in do clause: ", L_clause);})(function(){"use strict";return resolve(L_triple)(L_false, L_foldVar, lazy(function(L_rest){return L$(resolve(L_inLet))(function(){"use strict";return resolve(L_cons)(".");}, L_id, function(){"use strict";return resolve(L_cons)("bind", function(){"use strict";return resolve(L_cons)(L_t_2, function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L__append)(function(){"use strict";return resolve(L_cons)("\\", L_prefix);}, function(){"use strict";return resolve(L_cons)(".", L_rest);});}, L_nil);});});})}));});})}}}), function(){"use strict";return resolve(L_makeBind_0)("_")(L_t_2);});});})(function(){"use strict";return resolve(L_doClause)(L_t_2, L_clause, function(){"use strict";return resolve(L_cons)(L_h_1, L_prefix);}, L_inLet, L_foldVar);});});})(function(){"use strict";return resolve(L_makeBind_0)("_")(L_clause);})})();
  };
  return L_$_F;
})()))},
    function(){return resolve(L_newDefine)("triple", 3, "triple a b c = \\f . f a b c", lazy(setDataType((function(){
  var L_$_F = function(L_a, L_b, L_c) {
    return L_checkPartial(L_$_F, arguments) || setType(function(L_f){return resolve(L_f)(L_a)(L_b)(L_c)}, 'triple');
  };
  return L_$_F;
})(), 'triple')))},
    ...
    function(){return resolve(L_addToken)("<-")},
    function(){return resolve(L_defTokenPack)("do", function(){"use strict";return resolve(L_cons)(function(){"use strict";return resolve(L_cons)("<-", L_nil);}, function(){"use strict";return resolve(L_cons)(L_nil, function(){"use strict";return resolve(L_cons)(L_nil, L_nil);});});})},
