...
define([], function(){
  ...
  var L_$F = function(L_left, L_right, L_content) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_start_0, L_end_1;
  ...
  var L_$F = function(L_str, L_pat, L_prevIsDel, L_toks) {
    return L_checkPartial(L_$F, arguments) || resolve(L_$p$p)(L_str, "")(L_toks)(function(){return (function(){  var L_num_0, L_del_1, L_numOffset_2, L_delOffset_3, L_select_4, L_first_5;
  ...
  L_select_4 = function(){return resolve(L_and)(function(){return resolve(L_$p$p)(L_numOffset_2, 0);}, L_prevIsDel)(lazy((function(){
  ...
  var L_$F = (function(L_thing){return resolve(L_isToken)(L_thing)(function(){return resolve(L_tokenFilepos)(L_thing);})(function(){return resolve(L_isParens)(L_thing)(function(){return resolve(L_parensStart)(L_thing);})(function(){return resolve(L_isCons)(L_thing)(function(){return (function(){  var L_pos_0;
  ...
  var L_$F = function(L_start, L_list, L_names) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_err_0;
  ...
  return resolve(L_withCons)(L_list, L_err_0, lazy((function(){
  ...
  var L_$F = (function(L_p){return resolve(L_withCons)(L_rest, L_err_0, lazy((function(){
  ...
  return resolve(L_isTokenString)(L_data, ".")(function(){return resolve(L_finish_1)(L_nil)(L_rest_0);})(function(){return resolve(L_withStripped)(L_data, lazy((function(){
  ...
  var L_$F = (function(L_binding){return (function(){
  var L_$F = (function(L_body){return resolve(L_isTokenString)(L_binding, ".")(L_names)(function(){return resolve(L_withParens)(L_binding, L_err_0, lazy((function(){
  var L_$F = (function(L_start){return (function(){
  var L_$F = (function(L_end){return (function(){
  var L_$F = (function(L_def){return resolve(L_withCons)(L_def, L_err_0, lazy((function(){
  var L_$F = (function(L_name){return (function(){
  var L_$F = (function(L_rest){return resolve(L_withToken)(L_name, L_err_0, lazy((function(){
  var L_$F = (function(L_str){return (function(){
  ...
  L_groupToks_1 = function(){return resolve(L__foldr)(lazy((function(){
  ...
  var L_$F = function(L_str, L_pat, L_names, L_groups, L_onDef, L_onExpr) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_astCallback_0;
  ...
  var L_$F = function(L_props, L_ast) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_slash_0, L_var_1, L_afterVar_2, L_dot_3, L_body_4;
  ...
  var L_$F = function(L_filename, L_lineOffset, L_str, L_lines) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_m_0, L_idx_1, L_chunk_2, L_next_3, L_chunkLines_4;
  ...
  var L_$F = (function(L_h){return (function(){
  var L_$F = (function(L_t){return resolve(L_isBlockStart)(L_h)(function(){return resolve(L_cons)(L_h, function(){return resolve(L_isTokenString)(L_h, "\\\\")(function(){return resolve(L_macroSubLet)(L_macs, L_t);})(function(){return resolve(L_macroSubBody)(".", L_macs, L_t);});});})(function(){return resolve(L_withToken)(L_h, function(){return (function(){  var L_subH_0;
  ...
  var L_$F = (function(L_h){return (function(){
  var L_$F = (function(L_t){return resolve(L_isToken)(L_h)(function(){return resolve(L_cons)(L_h, function(){return resolve(L_postProcessMacro)(function(){return resolve(L_addFilepos)(function(){return resolve(L_addFilepos)(function(){return resolve(L_tokenFilepos)(L_h);}, function(){return resolve(L_strLen)(function(){return resolve(L_tokenString)(L_h);});});}, 1);}, function(){return resolve(L_emptyFor)(L_h);}, L_t);});})(function(){return (function(){  var L_posStart_0, L_posEnd_1, L_t2_2, L_h2_3;
  ...
  var L_$F = function(L_offset, L_line) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_m_0, L_idx_1;
  ...
  var L_$F = function(L_name, L_text) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_counted_0, L_lines_1, L_names_2;
  L_counted_0 = function(){return resolve(L_countedLinesForFile)(L_name, L_text);};
  L_lines_1 = function(){return resolve(L__map)(L_tail, L_counted_0);};
  ...
  L_errs_0 = function(){return resolve(L__foldr)(lazy((function(){
  var L_$F = (function(L_line){return (function(){
  ...
  L_groupToks_0 = function(){return resolve(L__foldl)(lazy((function(){
  ...
  var L_$F = function(L_func, L_list) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_ret_0;
  L_ret_0 = function(){return resolve(L_subtakeUpto)(L_func, L_list);};
  ...
  var L_$F = function(L_func, L_list) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_ret_0;
  L_ret_0 = function(){return resolve(L_subtakeUpto)(L_func, function(){return resolve(L_tail)(L_list);});};
  ...
  var L_$F = function(L_prec, L_right, L_closes, L_list) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_len_0, L_head1_1, L_tail1_2, L_head2_3, L_tail2_4, L_head3_5, L_opPrec_6;
  ...
  var L_$F = function(L_opPrec, L_prec, L_isRight, L_curArg, L_nextOp, L_nextArg, L_closes, L_len) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_nextPrec_0;
  ...
  L_next_0 = function(){return resolve(L_doClause)(function(){return resolve(L_stripParens)(L_h);}, L_h, L_nil, L_inLet);};
  L_newInLet_1 = function(){return resolve(L_head)(L_next_0);};
  L_chain_2 = function(){return resolve(L_tail)(L_next_0);};
  ...
  var L_$F = function(L_steppingClause, L_clause, L_prefix, L_inLet) {
    return L_checkPartial(L_$F, arguments) || (function(){  var L_makeBind_0, L_h_1, L_t_2;
  L_makeBind_0 = function(){return (function(){
