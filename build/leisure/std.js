define([], function(){
  ...
  return resolve(L_strCat)(function(){return resolve(L_cons)("(", function(){return resolve(L_cons)(function(){return resolve(L_join)(L_guts_1, " ")}, function(){return resolve(L_cons)(")", L_nil)})})})})()}))},
    ...
    function(){return resolve(L_newDefine)("wrappedIf", 1, "wrappedIf x = \\f . f x", lazy(setDataType(function(L_x){return setType(function(L_f){return resolve(L_f)(L_x)}, 'wrappedIf')}, 'wrappedIf')))},
    function(){return resolve(L_advise)("bind", "wrappedIf", 2, lazy(function(L_wif){return function(L_cont){return resolve(L_hasType)(L_wif, L_wrappedIf)(function(){return resolve(L_some)(function(){return resolve(L_bind)(function(){return resolve(L_wif)(L_id)}, lazy(function(L_optValue){return resolve(L_optValue)(L_cont)(L_unit)}))})})(L_none)}}))},
    function(){return resolve(L_defMacro)("if", lazy(function(L_list){return resolve(L_cons)("wrappedIf", function(){return resolve(L_cons)(L_list, L_nil)})}))},
