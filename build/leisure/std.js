...
define([], function(){
  ...
  return resolve(L_not)(function(){return resolve(L_isList)(L_list);})(function(){return resolve(L_parseErr)("Extends needs 1 or 2 arguments but there were none");})(function(){return resolve(L_isCons)(L_t1_1)(function(){return resolve(L_cons)("_declareType", function(){return resolve(L_cons)(function(){return resolve(L_jsonStringify)(L_type1_0, L_id, L_id);}, function(){return resolve(L_cons)(function(){return resolve(L_jsonStringify)(L_type2_2, L_id, L_id);}, L_nil);});});})(function(){return resolve(L_cons)("_declareType", function(){return resolve(L_cons)(function(){return resolve(L_jsonStringify)(L_type1_0, L_id, L_id);}, function(){return resolve(L_cons)("0", L_nil);});});});})})()});
  ...
  return L_$F;
    ...
    function(){return resolve(L__defTypeCase)("showBase", "some2", lazy((function(){
  var L_$F = function(L_obj, L_func) {
    return L_checkPartial(L_$F, arguments) || resolve(L_obj)(lazy((function(){
  var L_$F = (function(L_a){return (function(){
  var L_$F = (function(L_b){return resolve(L_strCat)(function(){return resolve(L_cons)("(some2 ", function(){return resolve(L_cons)(function(){return resolve(L_showBase)(L_a, L_func);}, function(){return resolve(L_cons)(" ", function(){return resolve(L_cons)(function(){return resolve(L_showBase)(L_b, L_func);}, function(){return resolve(L_cons)(")", L_nil);});});});});})});
