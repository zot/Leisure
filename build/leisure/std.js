define([], function(){
  ...
  return resolve(L_strCat)(function(){return resolve(L_cons)("(", function(){return resolve(L_cons)(function(){return resolve(L_join)(L_guts_1, " ")}, function(){return resolve(L_cons)(")", L_nil)})})})})()}))},
    ...
    function(){return resolve(L_newDefine)("doubleBind", 1, "doubleBind x = \\f . f x", lazy(setDataType(function(L_x){return setType(function(L_f){return resolve(L_f)(L_x)}, 'doubleBind')}, 'doubleBind')))},
    function(){return resolve(L_advise)("bind", "doubleBind", 2, lazy(function(L_fe){return function(L_cont){return resolve(L_hasType)(L_fe, L_doubleBind)(function(){return resolve(L_some)(function(){return resolve(L_bind)(function(){return resolve(L_fe)(L_id)}, lazy(function(L_x){return resolve(L_bind)(L_x, L_cont)}))})})(L_none)}}))},
    function(){return resolve(L_defMacro)("if", lazy(function(L_list){return resolve(L_cons)("doubleBind", function(){return resolve(L_cons)(L_list, L_nil)})}))},
    function(){return resolve(L_defMacro)("foreach", lazy(function(L_list){return resolve(L_cons)("doubleBind", function(){return resolve(L_cons)(L_list, L_nil)})}))},
