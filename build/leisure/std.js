L_runMonads([
 ...
 function(){return resolve(L_advise)("bind2", "range", 2, lazy(function(L_r){return function(L_cont){return resolve(L_hasType)(L_r, L_range)(function(){return resolve(L_some)(function(){return resolve(L_map)(L_cont, L_r)})})(L_none)}}))},
 function(){return resolve(L_advise)("bind2", "repeat", 2, lazy(function(L_r){return function(L_cont){return resolve(L_hasType)(L_r, L_repeat)(function(){return resolve(L_some)(function(){return resolve(L_map)(function(){return resolve(L_cont)(L_nil)}, L_r)})})(L_none)}}))},
 ...
 function(){return resolve(L_advise)("bind2", "wrappedForeachRep", 2, lazy(function(L_rep){return function(L_cont){return resolve(L_testWrappedForeach)(L_rep, L_isRepeat)(function(){return resolve(L_some)(function(){return resolve(L_doall)(function(){return resolve(L_map)(function(){return resolve(L_cont)(L_nil)}, function(){return resolve(L_rep)(L_id)})})})})(L_none)}}))},
 function(){return resolve(L_advise)("bind2", "wrappedForeachRange", 2, lazy(function(L_r){return function(L_cont){return resolve(L_testWrappedForeach)(L_r, L_isRange)(function(){return resolve(L_some)(function(){return resolve(L_doall)(function(){return resolve(L_map)(L_cont, function(){return resolve(L_r)(L_id)})})})})(L_none)}}))},
