define([], function(){
  ...
  return resolve(L_strCat)(function(){return resolve(L_cons)("(", function(){return resolve(L_cons)(function(){return resolve(L_join)(L_guts_1, " ")}, function(){return resolve(L_cons)(")", L_nil)})})})})()}))},
    ...
    function(){return resolve(L_advise)("bind", "wrappedForEach", 2, lazy(function(L_fe){return function(L_cont){return resolve(L_hasType)(L_fe, L_wrappedForEach)(function(){return resolve(L_some)(function(){return resolve(L_bind)(function(){return resolve(L_fe)(L_id)}, lazy(function(L_x){return resolve(L_bind)(L_x, L_cont)}))})})(L_none)}}))},
    function(){return resolve(L_defMacro)("if", lazy(function(L_list){return resolve(L_cons)("wrappedForEach", function(){return resolve(L_cons)(L_list, L_nil)})}))},
