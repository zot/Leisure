define([], function(){
  ...
  return resolve(L_isCons)(L_result_0)(function(){return resolve(L_result_0)(lazy(function(L_h){return function(L_t){return resolve(L_cons)(function(){return resolve(L_visit)(L_func, L_h);}, function(){return resolve(L_visit)(L_func, L_t);})}}));})(L_result_0)})();
    ...
    function(){return resolve(L_newDefine)("stripNesting", 1, "stripNesting l = isCons l\r\n  l \\h t . (isCons h) && (isNil t)\r\n    stripNesting h\r\n    map stripNesting l\r\n  l\r\n  ", lazy(function(L_l){return resolve(L_isCons)(L_l)(function(){return resolve(L_l)(lazy(function(L_h){return function(L_t){return resolve(L_$h$h)(function(){return resolve(L_isCons)(L_h);})(function(){return resolve(L_isNil)(L_t);})(function(){return resolve(L_stripNesting)(L_h);})(function(){return resolve(L_map)(L_stripNesting, L_l);})}}));})(L_l)}))},
    function(){return resolve(L_newDefine)("simplify", 1, "simplify exprString = do\r\n  list <- scanLineM exprString\r\n  stripNesting (visit (\\func x . isToken x (tokenString x) ((isParens x) (visit func (parensContent x)) x)) list)", lazy(function(L_exprString){return resolve(L_bind)(function(){return resolve(L_scanLineM)(L_exprString);}, lazy(function(L_list){return resolve(L_stripNesting)(function(){return resolve(L_visit)(lazy(function(L_func){return function(L_x){return resolve(L_isToken)(L_x)(function(){return resolve(L_tokenString)(L_x);})(function(){return resolve(L_isParens)(L_x)(function(){return resolve(L_visit)(L_func, function(){return resolve(L_parensContent)(L_x);});})(L_x);})}}), L_list);})}))}))},
  ...
  return resolve(L_isNil)(L_list)(L_none)(function(){return resolve(L_isNone)(L_result_0)(function(){return resolve(L_findOption)(L_func, function(){return resolve(L_tail)(L_list);});})(L_result_0);})})();
    ...
    function(){return resolve(L_newDefine)("toJson", 1, "toJson obj = (isAlist obj) && (not (isNil obj))\r\n  toJsonObject (map (\\pair . cons (head pair) (toJson (tail pair))) obj)\r\n  (isCons obj) || (isNil obj)\r\n    toJsonArray (map (\\item . toJson item) obj)\r\n    obj", lazy(function(L_obj){return resolve(L_$h$h)(function(){return resolve(L_isAlist)(L_obj);})(function(){return resolve(L_not)(function(){return resolve(L_isNil)(L_obj);});})(function(){return resolve(L_toJsonObject)(function(){return resolve(L_map)(lazy(function(L_pair){return resolve(L_cons)(function(){return resolve(L_head)(L_pair);}, function(){return resolve(L_toJson)(function(){return resolve(L_tail)(L_pair);});})}), L_obj);});})(function(){return resolve(L_$q$q)(function(){return resolve(L_isCons)(L_obj);})(function(){return resolve(L_isNil)(L_obj);})(function(){return resolve(L_toJsonArray)(function(){return resolve(L_map)(lazy(function(L_item){return resolve(L_toJson)(L_item)}), L_obj);});})(L_obj);})}))},
  ...
  return resolve(L_and)(function(){return resolve(L_isCons)(L_list);}, function(){return resolve(L_and)(function(){return resolve(L_isCons)(L_t1_1);}, function(){return resolve(L_and)(function(){return resolve(L_isCons)(L_t2_3);}, function(){return resolve(L_and)(function(){return resolve(L_isTokenString)(L_h2_2, ".");}, L_true);});});})(function(){return resolve(L_makeCaseArgs)(L_list, function(){return resolve(L_mkStr)(L_h1_0);}, function(){return resolve(L_mkStr)(L_h3_4);}, L_t3_5, L_id);})(function(){return resolve(L_parseErr)("Error in case definition -- expected func.name args | condition -> action, but got ", L_list);})})()}))},
    ...
    function(){return resolve(L_advise)("map", "repeat", 2, lazy(function(L_func){return function(L_r){return resolve(L_isRepeat)(L_r)(function(){return resolve(L_some)(function(){return resolve(L_r)(lazy(function(L_n){return resolve(L_runRepeat)(0, L_n, L_func)}));});})(L_none)}}))},
    function(){return resolve(L_advise)("map", "option", 2, lazy(function(L_func){return function(L_opt){return resolve(L_isOption)(L_opt)(function(){return resolve(L_some)(function(){return resolve(L_opt)(lazy(function(L_x){return resolve(L_cons)(L_x, L_nil)}))(L_nil);});})(L_none)}}))},
  ...
  return resolve(L_strCat)(function(){return resolve(L_cons)("(", function(){return resolve(L_cons)(function(){return resolve(L_join)(L_guts_1, " ");}, function(){return resolve(L_cons)(")", L_nil);});});})})()}))},
    ...
    function(){return resolve(L_advise)("bind", "option", 2, lazy(function(L_opt){return function(L_cont){return resolve(L_isOption)(L_opt)(function(){return resolve(L_some)(function(){return resolve(L_opt)(lazy(function(L_value){return resolve(L_some)(function(){return resolve(L_cont)(L_value);})}))(L_none);});})(L_none)}}))},
    ...
    function(){return resolve(L_advise)("bind", "repeat", 2, lazy(function(L_r){return function(L_cont){return resolve(L_hasType)(L_r, L_repeat)(function(){return resolve(L_some)(function(){return resolve(L_map)(L_cont, L_r);});})(L_none)}}))},
    ...
    function(){return resolve(L_advise)("bind", "wrappedForeach", 2, lazy(function(L_fe){return function(L_cont){return resolve(L_hasType)(L_fe, L_wrappedForeach)(function(){return resolve(L_some)(function(){return resolve(L_primBind)(function(){return resolve(L_fe)(L_id);}, lazy(function(L_x){return resolve(L_doall)(function(){return resolve(L_map)(L_id, function(){return resolve(L_bind)(L_x, L_cont);});})}));});})(L_none)}}))},
    ...
    function(){return resolve(L_newDefine)("definitionList", 0, "definitionList = do\r\n  f <- funcList\r\n  m <- getValue 'macroDefs'\r\n  sort (append f (map head m))", function(){return resolve(L_bind)(L_funcList, lazy(function(L_f){return resolve(L_bind)(function(){return resolve(L_getValue)("macroDefs");}, lazy(function(L_m){return resolve(L_sort)(function(){return resolve(L_append)(L_f, function(){return resolve(L_map)(L_head, L_m);});})}))}));})},
    function(){return resolve(L_newDefine)("eval", 1, "eval str = do\r\n  ast <- newParseLine 0 nil str\r\n  ifNotErr ast (runAst ast)", lazy(function(L_str){return resolve(L_bind)(function(){return resolve(L_newParseLine)(0, L_nil, L_str);}, lazy(function(L_ast){return resolve(L_ifNotErr)(L_ast, function(){return resolve(L_runAst)(L_ast);})}))}))}
  ]);
});
