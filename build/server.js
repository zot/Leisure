...
(function() {
  var MasterHandler, MessageHandler, SlaveHandler, _, badMasterIdError, badMsgTypeError, badVersionError, crypto, diag, disapprovedError, guid, http, isTextMsg, masters, ref, requirejs, runReplacements, s4, slaves, socketPrefix, sockjs, sockjsUtil, startServer, validateBatch,
    slice = [].slice,
