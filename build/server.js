...
(function() {
  var MasterHandler, MessageHandler, SlaveHandler, _, badMasterIdError, badMsgTypeError, badVersionError, crypto, diag, disapprovedError, finalhandler, guid, http, isTextMsg, masters, path, ref, requirejs, runReplacements, s4, serveStatic, slaves, socketPrefix, sockjs, sockjsUtil, startServer, validateBatch,
    slice = [].slice,
  ...
  ref = requirejs('./common'), badMasterIdError = ref.badMasterIdError, badMsgTypeError = ref.badMsgTypeError, disapprovedError = ref.disapprovedError, badVersionError = ref.badVersionError;
  ...
  MessageHandler = (function() {
    ...
    MessageHandler.prototype.handler = {
      ...
      replace: function(msg) {
        this.lastVersionAck = msg.knownVersion;
