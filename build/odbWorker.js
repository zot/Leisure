...
(function() {
  var OdbWorker, TraceDumper, addRecord, defKey, dump, newTraceRecords, pad, processTrace, shared, traceRecords, verbose, worker;
  ...
  OdbWorker = (function() {
    ...
    OdbWorker.prototype.getEntry = function(e, arg) {
      ...
      return this.port.postMessage({
        "return": (records = traceRecords[logName]) && ((ref = records[type]) != null ? ref[key] : void 0),
        msgId: msgId
      });
    };

    OdbWorker.prototype.clearEntries = function(e, logName) {
      return newTraceRecords(logName);
    };

    OdbWorker.prototype.deleteEntries = function(e, logName) {
      return traceRecords[logName] = {};
    };

    OdbWorker.prototype.lazyValue = function(records, pos, values) {
      var context, id, instance, type;
      type = values[pos++];
      instance = values[pos++];
      context = values[pos++];
      id = values[pos++];
    ...
    OdbWorker.prototype["return"] = function(records, pos, values) {
      var caller, context, id, instance, result, type;
      type = values[pos++];
      instance = values[pos++];
      context = values[pos++];
      id = values[pos++];
