...
(function() {
  var OdbWorker, TraceDumper, addCallGraphEntry, addRecord, defKey, dump, newTraceRecords, pad, processTrace, shared, traceRecords, verbose, worker,
    slice = [].slice;
  ...
  OdbWorker = (function() {
    ...
    OdbWorker.prototype.getCallGraph = function(e, arg) {
  ...
  addCallGraphEntry = function(records, delta) {
    var entry;
