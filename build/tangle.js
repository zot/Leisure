...
(function() {
  define(['./base', './org', './docOrg', './gen', './eval', 'lodash', 'handlebars', './export', './advice', 'lib/js-yaml', 'lib/bluebird.min', 'immutable', 'lib/fingertree', 'lib/sha1'], function(Base, Org, DocOrg, Gen, Eval, _, Handlebars, BrowserExports, Advice, Yaml, Bluebird, Immutable, FingerTree, SHA1) {
    var Promise, SourceMapConsumer, SourceMapGenerator, SourceNode, blockSource, codeBlocksFor, codeForBlock, defaultEnv, extractCode, getLeisurePromise, jsCodeFor, languageEnvMaker, mergeExports, nextGeneratedFileName, orgDoc, parseBlocks, parseOrgMode, parseYaml, shouldTangle, tangle, tangleBlock, tangleType, viewSource;
