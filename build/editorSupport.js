  ...
  define(['./base', './org', './docOrg', './ast', './utilities', './eval', './leisure-support', './editor', 'lodash', 'jquery', './ui', './db', 'handlebars', './lib/prism', './advice', 'lib/js-yaml', 'bluebird', 'immutable', 'fingertree', './tangle', 'lib/sha1'], function(Base, Org, DocOrg, Ast, Utilities, Eval, LeisureSupport, Editor, _, $, UI, DB, Handlebars, Prism, Advice, Yaml, Bluebird, Immutable, FingerTree, Tangle, SHA1) {
    ...
    OrgData = (function(superClass) {
      ...
      OrgData.prototype.createObserver = function(block) {
        ...
        return block.observer.observe = (function(_this) {
          return function() {
            var channelArgs, err, ref, ref1, res;
    ...
    OrgEditing = (function(superClass) {
      ...
      OrgEditing.prototype.checkCodeChange = function(changes, change, oldBlock, oldBlocks, newBlocks) {
        var block, envM, err, hasChange, i, j, len, newBlock, newResults, newSource, oldSource, opts, ref, ref1, ref2, repl, replaceBlock, result, start, state, values;
        try {
