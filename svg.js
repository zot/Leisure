...
var _svg, _svg$nfile, _field, _insert$nfields, _default$ncircle$nmap, _default$nrect$nmap, _default$nline$nmap, _default$nellipse$nmap, _default$ntext$nmap, _default$npolygon$nmap, _svg$nelement, _circle, _rect, _ellipse, _line, _text, _polygon, _group, _translate, _rotate;
...
;
//svg-file = AST(\f map . html (concat ([ <object xmlns="http://www.w3.org/2000/svg" version="1.1" id="scene" data=" , f , " style="width:  , (get-value-default width 100 map) , ; height:  , (get-value-default height 100 map) , "> , </object> ])))
root.defs._svg$nfile = _svg$nfile = define('svg-file', function(_f){return function(_map){return _html()((function(){var $m; return function(){return $m || ($m = (_concat()((function(){var $m; return function(){return $m || ($m = (_$r()((function(){return "<object xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" id=\"scene\" data=\""}))(_$b)(_f)(_$b)((function(){return "\" style=\"width: "}))(_$b)((function(){var $m; return function(){return $m || ($m = (_get$nvalue$ndefault()((function(){return "width"}))((function(){return 100}))(_map)))}})())(_$b)((function(){return "; height: "}))(_$b)((function(){var $m; return function(){return $m || ($m = (_get$nvalue$ndefault()((function(){return "height"}))((function(){return 100}))(_map)))}})())(_$b)((function(){return "\">"}))(_$b)((function(){return "</object>"}))(_$s)))}})())))}})())}});
;
