...
versa.  If you hit C-C C-C or click an elisp link in Leisure, it will
delegate it to Emacs and Leisure will also attempt to fetch "file:"
image data from Emacs so that it can display the results of your
