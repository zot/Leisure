...
- It's *NOT HARDENED*
  ...
  - Leisure won't destroy Emacs' undo history, so it *should* be realtively safe
...
#+END_SRC
* View definitions
Leisure has a presentation system that can automitically determine
which "view" to use to display a piece of data according to its "type"
field.  You can nest views and even define alternate views for the
same types of data.  At this point, Leisure uses YAML data for its
views.
...
you do this.  So a lot of Leisure's document display is defined in
Leisure.  It's so meta.

#+NAME: rotator
This YAML item controls the rotating square and line below.
...
#+BEGIN_SRC html :defview rotator2/two
...
#+RESULTS[a32b48b60992ab19ad85b497c58efe74919bb9b6]:
