...
var _make$nsubtree, _subtree$nsvg, _subtree$nwidth, _subtree$nheight, _subtree$nroot$nx, _subtree$nroot$ny, _treeFor, _subtreeFor, _createLitSubtree, _typeof;
...
;
//treeFor = AST(\ast . subtree-svg (subtreeFor ast))
root.defs._treeFor = _treeFor = define('treeFor', function(_ast){return _subtree$nsvg()((function(){var $m; return function(){return $m || ($m = (_subtreeFor()(_ast)))}})())});
;
