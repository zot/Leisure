...
(function() {
  ...
  _ref = root = module.exports = requirejs('./ast'), cons = _ref.cons, Nil = _ref.Nil, consFrom = _ref.consFrom, head = _ref.head, tail = _ref.tail, define = _ref.define, setDataType = _ref.setDataType, setType = _ref.setType, ensureLeisureClass = _ref.ensureLeisureClass, ref = _ref.ref, lit = _ref.lit, apply = _ref.apply, lambda = _ref.lambda, llet = _ref.llet, anno = _ref.anno, ast2Json = _ref.ast2Json, resolve = _ref.resolve, lazy = _ref.lazy, dummyPosition = _ref.dummyPosition;
