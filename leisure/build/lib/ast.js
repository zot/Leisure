...
(function() {
  ...
  define = function(name, func, arity, src, method, namespace, isNew) {
    ...
    return nakedDefine(name, lz(func), arity, src, method, namespace, isNew);
  };
