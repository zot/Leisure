...
(function() {
  ...
  _ref = root = module.exports = requirejs('./base'), newCall = _ref.newCall, resolve = _ref.resolve, lazy = _ref.lazy, defaultEnv = _ref.defaultEnv;
  ...
  _ref2 = requirejs('./gen'), gen = _ref2.gen, genMap = _ref2.genMap, genSource = _ref2.genSource, withFile = _ref2.withFile, sourceNode = _ref2.sourceNode, SourceNode = _ref2.SourceNode, setMegaArity = _ref2.setMegaArity;
  ...
  updateCompleter = function(rl) {
    ...
    if (root.functionCount !== oldFunctionCount) {
      ...
      return leisureFunctions = global.leisureFuncNames.toArray().concat((_ref5 = (_ref6 = getValue('macroDefs')) != null ? _ref6.map(function(x) {
        return x.head();
      }).toArray() : void 0) != null ? _ref5 : []);
    }
  };
  ...
  compile = function(file, cont) {
    var ext, _ref5;
    if ((_ref5 = defaultEnv.errorHandlers) != null) {
      _ref5.push(function(e) {
    ...
    return runMonad2(rz(L_baseLoad)(lz(file)), defaultEnv, function(result) {
      ...
      if (createJsFile) {
        ...
        try {
          ...
          err = _error;
          inspect = (_ref6 = typeof require === "function" ? require('util').inspect : void 0) != null ? _ref6 : function(x) {
            return x;
          };
  ...
  intersperse = function(array, element) {
    var i, result, _i, _ref5;
    if (array.length < 2) {
      return array;
    } else {
      result = [array[0]];
      for (i = _i = 1, _ref5 = array.length; 1 <= _ref5 ? _i < _ref5 : _i > _ref5; i = 1 <= _ref5 ? ++_i : --_i) {
...
//# sourceMappingURL=leisureRepl.map
